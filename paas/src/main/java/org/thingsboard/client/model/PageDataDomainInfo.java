 ...
 */
@JsonPropertyOrder({
  PageDataDomainInfo.JSON_PROPERTY_DATA,
  PageDataDomainInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataDomainInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataDomainInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:18:03.556877+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataDomainInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<DomainInfo> data = new ArrayList<>();
  ...
  public PageDataDomainInfo data(@javax.annotation.Nullable List<DomainInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataDomainInfo addDataItem(DomainInfo dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<DomainInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataDomainInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataDomainInfo pageDataDomainInfo = (PageDataDomainInfo) o;
    return Objects.equals(this.data, pageDataDomainInfo.data) &&
        Objects.equals(this.totalPages, pageDataDomainInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataDomainInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataDomainInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataDomainInfo {\n");
