 ...
 */
@JsonPropertyOrder({
  PageDataUser.JSON_PROPERTY_DATA,
  PageDataUser.JSON_PROPERTY_TOTAL_PAGES,
  PageDataUser.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataUser.JSON_PROPERTY_HAS_NEXT
})
...
public class PageDataUser {
  ...
  public PageDataUser data(@Nullable List<User> data) {
    this.data = data;
    return this;
  }

  public PageDataUser addDataItem(User dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<User> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataUser object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataUser pageDataUser = (PageDataUser) o;
    return Objects.equals(this.data, pageDataUser.data) &&
        Objects.equals(this.totalPages, pageDataUser.totalPages) &&
        Objects.equals(this.totalElements, pageDataUser.totalElements) &&
        Objects.equals(this.hasNext, pageDataUser.hasNext);
  }
