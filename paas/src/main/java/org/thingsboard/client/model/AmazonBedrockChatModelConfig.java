...
public class AmazonBedrockChatModelConfig extends AiModelConfig {
  ...
  @JsonProperty(value = JSON_PROPERTY_PROVIDER_CONFIG, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProviderConfig(@Nonnull AmazonBedrockProviderConfig providerConfig) {
    this.providerConfig = providerConfig;
  }


  public AmazonBedrockChatModelConfig modelId(@Nonnull String modelId) {
  ...
  public AmazonBedrockChatModelConfig temperature(@Nullable Double temperature) {
  ...
  public AmazonBedrockChatModelConfig topP(@Nullable Double topP) {
    this.topP = topP;
    return this;
  }
  ...
  public AmazonBedrockChatModelConfig maxOutputTokens(@Nullable Integer maxOutputTokens) {
  ...
  public AmazonBedrockChatModelConfig timeoutSeconds(@Nullable Integer timeoutSeconds) {
  ...
  public AmazonBedrockChatModelConfig maxRetries(@Nullable Integer maxRetries) {
