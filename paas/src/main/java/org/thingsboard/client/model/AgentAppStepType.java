...
public enum AgentAppStepType {
  ...
  @JsonCreator
  public static AgentAppStepType fromValue(String value) {
    for (AgentAppStepType b : AgentAppStepType.values()) {
