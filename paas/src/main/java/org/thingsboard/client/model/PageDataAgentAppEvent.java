 ...
 */
@JsonPropertyOrder({
  PageDataAgentAppEvent.JSON_PROPERTY_DATA,
  PageDataAgentAppEvent.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAgentAppEvent.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAgentAppEvent.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAgentAppEvent {
  public static final String JSON_PROPERTY_DATA = "data";
  @Nullable
  private List<AgentAppEvent> data = new ArrayList<>();
  ...
  public PageDataAgentAppEvent data(@Nullable List<AgentAppEvent> data) {
    this.data = data;
    return this;
  }

  public PageDataAgentAppEvent addDataItem(AgentAppEvent dataItem) {
    if (this.data == null) {
  ...
  public List<AgentAppEvent> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<AgentAppEvent> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAgentAppEvent object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAgentAppEvent pageDataAgentAppEvent = (PageDataAgentAppEvent) o;
    return Objects.equals(this.data, pageDataAgentAppEvent.data) &&
        Objects.equals(this.totalPages, pageDataAgentAppEvent.totalPages) &&
        Objects.equals(this.totalElements, pageDataAgentAppEvent.totalElements) &&
        Objects.equals(this.hasNext, pageDataAgentAppEvent.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAgentAppEvent {\n");
