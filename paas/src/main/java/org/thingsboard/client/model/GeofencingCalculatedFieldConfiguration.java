...
public class GeofencingCalculatedFieldConfiguration extends CalculatedFieldConfiguration {
  ...
  public GeofencingCalculatedFieldConfiguration entityCoordinates(@Nonnull EntityCoordinates entityCoordinates) {
  ...
  public GeofencingCalculatedFieldConfiguration scheduledUpdateEnabled(@Nullable Boolean scheduledUpdateEnabled) {
  ...
  public GeofencingCalculatedFieldConfiguration scheduledUpdateInterval(@Nullable Integer scheduledUpdateInterval) {
  ...
  @Override
  public GeofencingCalculatedFieldConfiguration aiGenerated(@Nullable Boolean aiGenerated) {
