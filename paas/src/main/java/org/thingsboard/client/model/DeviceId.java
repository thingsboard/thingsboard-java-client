 ...
 */
@JsonPropertyOrder({
  DeviceId.JSON_PROPERTY_ID,
  DeviceId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class DeviceId {
  ...
  public DeviceId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public DeviceId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this DeviceId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, deviceId.id) &&
        Objects.equals(this.entityType, deviceId.entityType);
  }
