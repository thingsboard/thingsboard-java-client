 ...
 */
@JsonPropertyOrder({
  PageDataTenantProfile.JSON_PROPERTY_DATA,
  PageDataTenantProfile.JSON_PROPERTY_TOTAL_PAGES,
  PageDataTenantProfile.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataTenantProfile.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:18:03.556877+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataTenantProfile {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<TenantProfile> data = new ArrayList<>();
  ...
  public PageDataTenantProfile data(@javax.annotation.Nullable List<TenantProfile> data) {
    this.data = data;
    return this;
  }

  public PageDataTenantProfile addDataItem(TenantProfile dataItem) {
    if (this.data == null) {
  ...
  public List<TenantProfile> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<TenantProfile> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataTenantProfile object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataTenantProfile pageDataTenantProfile = (PageDataTenantProfile) o;
    return Objects.equals(this.data, pageDataTenantProfile.data) &&
        Objects.equals(this.totalPages, pageDataTenantProfile.totalPages) &&
        Objects.equals(this.totalElements, pageDataTenantProfile.totalElements) &&
        Objects.equals(this.hasNext, pageDataTenantProfile.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataTenantProfile {\n");
