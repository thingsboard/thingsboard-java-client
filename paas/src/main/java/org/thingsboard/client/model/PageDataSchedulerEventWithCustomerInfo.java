...
public class PageDataSchedulerEventWithCustomerInfo {
  ...
  public PageDataSchedulerEventWithCustomerInfo data(@Nullable List<SchedulerEventWithCustomerInfo> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<SchedulerEventWithCustomerInfo> data) {
    this.data = data;
  }
