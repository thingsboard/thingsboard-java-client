...
public class SchedulerEventId extends EntityId {
...
static {
  ...
  mappings.put("SchedulerEventId", SchedulerEventId.class);
  JSON.registerDiscriminator(SchedulerEventId.class, "entityType", mappings);
}
}
