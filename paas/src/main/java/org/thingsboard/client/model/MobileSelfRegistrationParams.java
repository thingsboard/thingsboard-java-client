...
public class MobileSelfRegistrationParams extends SelfRegistrationParams {
  ...
  public MobileSelfRegistrationParams privacyPolicy(@Nullable String privacyPolicy) {
  ...
  public MobileSelfRegistrationParams redirect(@Nonnull MobileRedirectParams redirect) {
  ...
  @JsonProperty(value = JSON_PROPERTY_REDIRECT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRedirect(@Nonnull MobileRedirectParams redirect) {
    this.redirect = redirect;
  }


  public MobileSelfRegistrationParams termsOfUse(@Nullable String termsOfUse) {
  ...
  @Override
  public MobileSelfRegistrationParams captcha(@Nullable CaptchaParams captcha) {
  ...
  @Override
  public MobileSelfRegistrationParams signUpFields(@Nullable List<SignUpField> signUpFields) {
    this.setSignUpFields(signUpFields);
    return this;
  }

  @Override
  public MobileSelfRegistrationParams customerTitlePrefix(@Nullable String customerTitlePrefix) {
    this.setCustomerTitlePrefix(customerTitlePrefix);
    return this;
  }

  @Override
  public MobileSelfRegistrationParams showPrivacyPolicy(@Nullable Boolean showPrivacyPolicy) {
    this.setShowPrivacyPolicy(showPrivacyPolicy);
    return this;
  }

  @Override
  public MobileSelfRegistrationParams showTermsOfUse(@Nullable Boolean showTermsOfUse) {
    this.setShowTermsOfUse(showTermsOfUse);
    return this;
  }

  @Override
  public MobileSelfRegistrationParams defaultDashboard(@Nullable DefaultDashboardParams defaultDashboard) {
    this.setDefaultDashboard(defaultDashboard);
    return this;
  }

  @Override
  public MobileSelfRegistrationParams homeDashboard(@Nullable HomeDashboardParams homeDashboard) {
    this.setHomeDashboard(homeDashboard);
    return this;
  }

  @Override
  public MobileSelfRegistrationParams customerGroupId(@Nullable EntityGroupId customerGroupId) {
    this.setCustomerGroupId(customerGroupId);
    return this;
  }

  @Override
  public MobileSelfRegistrationParams customMenuId(@Nullable CustomMenuId customMenuId) {
