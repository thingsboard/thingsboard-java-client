 ...
 */
@JsonPropertyOrder({
  PageDataRuleChain.JSON_PROPERTY_DATA,
  PageDataRuleChain.JSON_PROPERTY_TOTAL_PAGES,
  PageDataRuleChain.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataRuleChain.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataRuleChain {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<RuleChain> data = new ArrayList<>();
  ...
  public PageDataRuleChain data(@javax.annotation.Nullable List<RuleChain> data) {
    this.data = data;
    return this;
  }

  public PageDataRuleChain addDataItem(RuleChain dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<RuleChain> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataRuleChain object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataRuleChain pageDataRuleChain = (PageDataRuleChain) o;
    return Objects.equals(this.data, pageDataRuleChain.data) &&
        Objects.equals(this.totalPages, pageDataRuleChain.totalPages) &&
        Objects.equals(this.totalElements, pageDataRuleChain.totalElements) &&
        Objects.equals(this.hasNext, pageDataRuleChain.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataRuleChain {\n");
