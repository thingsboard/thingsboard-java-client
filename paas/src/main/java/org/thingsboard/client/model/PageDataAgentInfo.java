 ...
 */
@JsonPropertyOrder({
  PageDataAgentInfo.JSON_PROPERTY_DATA,
  PageDataAgentInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAgentInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAgentInfo.JSON_PROPERTY_HAS_NEXT
})
...
public class PageDataAgentInfo {
  ...
  public PageDataAgentInfo data(@Nullable List<AgentInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataAgentInfo addDataItem(AgentInfo dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<AgentInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAgentInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAgentInfo pageDataAgentInfo = (PageDataAgentInfo) o;
    return Objects.equals(this.data, pageDataAgentInfo.data) &&
        Objects.equals(this.totalPages, pageDataAgentInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataAgentInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataAgentInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAgentInfo {\n");
