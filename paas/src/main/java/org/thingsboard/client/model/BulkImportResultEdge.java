...
public class BulkImportResultEdge {
  ...
  public BulkImportResultEdge created(@javax.annotation.Nullable Object created) {
  ...
  public BulkImportResultEdge updated(@javax.annotation.Nullable Object updated) {
  ...
  public BulkImportResultEdge errors(@javax.annotation.Nullable Object errors) {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.created, bulkImportResultEdge.created) &&
        equalsNullable(this.updated, bulkImportResultEdge.updated) &&
        equalsNullable(this.errors, bulkImportResultEdge.errors) &&
