...
import org.thingsboard.client.model.EdgeEvent;
 ...
 */
@JsonPropertyOrder({
  PageDataEdgeEvent.JSON_PROPERTY_DATA,
  PageDataEdgeEvent.JSON_PROPERTY_TOTAL_PAGES,
  PageDataEdgeEvent.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataEdgeEvent.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:18:03.556877+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataEdgeEvent {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<EdgeEvent> data = new ArrayList<>();
  ...
  public PageDataEdgeEvent data(@javax.annotation.Nullable List<EdgeEvent> data) {
    this.data = data;
    return this;
  }

  public PageDataEdgeEvent addDataItem(EdgeEvent dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<EdgeEvent> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataEdgeEvent object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataEdgeEvent pageDataEdgeEvent = (PageDataEdgeEvent) o;
    return Objects.equals(this.data, pageDataEdgeEvent.data) &&
        Objects.equals(this.totalPages, pageDataEdgeEvent.totalPages) &&
        Objects.equals(this.totalElements, pageDataEdgeEvent.totalElements) &&
        Objects.equals(this.hasNext, pageDataEdgeEvent.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataEdgeEvent {\n");
