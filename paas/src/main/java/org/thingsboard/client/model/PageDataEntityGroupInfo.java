 ...
 */
@JsonPropertyOrder({
  PageDataEntityGroupInfo.JSON_PROPERTY_DATA,
  PageDataEntityGroupInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataEntityGroupInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataEntityGroupInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataEntityGroupInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<EntityGroupInfo> data = new ArrayList<>();
  ...
  public PageDataEntityGroupInfo() { 
  }
  ...
  public PageDataEntityGroupInfo data(@javax.annotation.Nullable List<EntityGroupInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataEntityGroupInfo addDataItem(EntityGroupInfo dataItem) {
    if (this.data == null) {
  ...
  public List<EntityGroupInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<EntityGroupInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataEntityGroupInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataEntityGroupInfo pageDataEntityGroupInfo = (PageDataEntityGroupInfo) o;
    return Objects.equals(this.data, pageDataEntityGroupInfo.data) &&
        Objects.equals(this.totalPages, pageDataEntityGroupInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataEntityGroupInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataEntityGroupInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataEntityGroupInfo {\n");
