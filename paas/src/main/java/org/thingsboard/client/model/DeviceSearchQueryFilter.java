...
public class DeviceSearchQueryFilter extends EntityFilter {
  ...
  public DeviceSearchQueryFilter rootEntity(@javax.annotation.Nullable AliasEntityId rootEntity) {
  ...
  public DeviceSearchQueryFilter relationType(@javax.annotation.Nullable String relationType) {
  ...
  public DeviceSearchQueryFilter direction(@javax.annotation.Nullable EntitySearchDirection direction) {
  ...
  public DeviceSearchQueryFilter maxLevel(@javax.annotation.Nullable Integer maxLevel) {
  ...
  public DeviceSearchQueryFilter fetchLastLevelOnly(@javax.annotation.Nullable Boolean fetchLastLevelOnly) {
  ...
  public DeviceSearchQueryFilter rootStateEntity(@javax.annotation.Nullable Boolean rootStateEntity) {
  ...
  public DeviceSearchQueryFilter defaultStateEntity(@javax.annotation.Nullable AliasEntityId defaultStateEntity) {
  ...
  public DeviceSearchQueryFilter deviceTypes(@javax.annotation.Nullable List<String> deviceTypes) {
  ...
  @Override
  public DeviceSearchQueryFilter type(@javax.annotation.Nonnull String type) {
    this.setType(type);
    return this;
  }
