...
public class AgentBulkActionId extends EntityId {
  public AgentBulkActionId() { 
  }

  @Override
  public AgentBulkActionId id(@Nonnull UUID id) {
    this.setId(id);
    return this;
  }

  /**
   * Return true if this AgentBulkActionId object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class AgentBulkActionId {\n");
...
static {
  ...
  mappings.put("AgentBulkActionId", AgentBulkActionId.class);
  JSON.registerDiscriminator(AgentBulkActionId.class, "entityType", mappings);
}
}
