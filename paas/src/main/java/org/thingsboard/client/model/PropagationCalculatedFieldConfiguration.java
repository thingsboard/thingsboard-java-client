...
public class PropagationCalculatedFieldConfiguration extends CalculatedFieldConfiguration {
  ...
  public PropagationCalculatedFieldConfiguration expression(@javax.annotation.Nullable String expression) {
  ...
  public PropagationCalculatedFieldConfiguration relation(@javax.annotation.Nonnull RelationPathLevel relation) {
  ...
  @Override
  public PropagationCalculatedFieldConfiguration type(@javax.annotation.Nonnull String type) {
    this.setType(type);
    return this;
  }
