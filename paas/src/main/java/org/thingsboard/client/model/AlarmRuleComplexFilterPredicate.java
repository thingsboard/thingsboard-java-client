...
public class AlarmRuleComplexFilterPredicate extends AlarmRuleKeyFilterPredicate {
  ...
  public AlarmRuleComplexFilterPredicate predicates(@Nullable List<AlarmRuleKeyFilterPredicate> predicates) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PREDICATES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPredicates(@Nullable List<AlarmRuleKeyFilterPredicate> predicates) {
    this.predicates = predicates;
  }
