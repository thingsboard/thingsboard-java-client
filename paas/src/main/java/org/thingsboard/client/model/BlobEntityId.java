...
public class BlobEntityId extends EntityId {
  public BlobEntityId() { 
  }
...
static {
  ...
  mappings.put("BlobEntityId", BlobEntityId.class);
  JSON.registerDiscriminator(BlobEntityId.class, "entityType", mappings);
}
}
