 ...
 */
@JsonPropertyOrder({
  PageDataSecretInfo.JSON_PROPERTY_DATA,
  PageDataSecretInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataSecretInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataSecretInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataSecretInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<SecretInfo> data = new ArrayList<>();
  ...
  public PageDataSecretInfo data(@javax.annotation.Nullable List<SecretInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataSecretInfo addDataItem(SecretInfo dataItem) {
    if (this.data == null) {
  ...
  public List<SecretInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<SecretInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataSecretInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataSecretInfo pageDataSecretInfo = (PageDataSecretInfo) o;
    return Objects.equals(this.data, pageDataSecretInfo.data) &&
        Objects.equals(this.totalPages, pageDataSecretInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataSecretInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataSecretInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataSecretInfo {\n");
