...
public class ApiKey {
  ...
  public ApiKey id(@javax.annotation.Nullable ApiKeyId id) {
    this.id = id;
    return this;
  }
  ...
  public ApiKey userId(@javax.annotation.Nullable UserId userId) {
    this.userId = userId;
    return this;
  }
  ...
  public ApiKey expirationTime(@javax.annotation.Nullable Long expirationTime) {
  ...
  public ApiKey description(@javax.annotation.Nonnull String description) {
