...
public class ReportTaskResult extends TaskResult {
  ...
  public ReportTaskResult report(@javax.annotation.Nullable Report report) {
    this.report = report;
    return this;
  }
  ...
  @Override
  public ReportTaskResult success(@javax.annotation.Nullable Boolean success) {
    this.setSuccess(success);
    return this;
  }

  @Override
  public ReportTaskResult discarded(@javax.annotation.Nullable Boolean discarded) {
    this.setDiscarded(discarded);
    return this;
  }

  @Override
  public ReportTaskResult finishTs(@javax.annotation.Nullable Long finishTs) {
    this.setFinishTs(finishTs);
    return this;
  }

  @Override
  public ReportTaskResult jobType(@javax.annotation.Nonnull String jobType) {
...
static {
  ...
  JSON.registerDiscriminator(ReportTaskResult.class, "jobType", mappings);
}
}
