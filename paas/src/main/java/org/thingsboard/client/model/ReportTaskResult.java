...
public class ReportTaskResult extends TaskResult {
  ...
  public ReportTaskResult report(@Nullable Report report) {
    this.report = report;
    return this;
  }
  ...
  @Override
  public ReportTaskResult success(@Nullable Boolean success) {
    this.setSuccess(success);
    return this;
  }

  @Override
  public ReportTaskResult discarded(@Nullable Boolean discarded) {
    this.setDiscarded(discarded);
    return this;
  }

  @Override
  public ReportTaskResult finishTs(@Nullable Long finishTs) {
    this.setFinishTs(finishTs);
    return this;
  }

  @Override
  public ReportTaskResult jobType(@Nonnull String jobType) {
