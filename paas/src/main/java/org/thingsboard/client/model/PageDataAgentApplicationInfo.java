 ...
 */
@JsonPropertyOrder({
  PageDataAgentApplicationInfo.JSON_PROPERTY_DATA,
  PageDataAgentApplicationInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAgentApplicationInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAgentApplicationInfo.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAgentApplicationInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @Nullable
  private List<AgentApplicationInfo> data = new ArrayList<>();
  ...
  public PageDataAgentApplicationInfo() { 
  }
  ...
  public PageDataAgentApplicationInfo data(@Nullable List<AgentApplicationInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataAgentApplicationInfo addDataItem(AgentApplicationInfo dataItem) {
    if (this.data == null) {
  ...
  public List<AgentApplicationInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<AgentApplicationInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAgentApplicationInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAgentApplicationInfo pageDataAgentApplicationInfo = (PageDataAgentApplicationInfo) o;
    return Objects.equals(this.data, pageDataAgentApplicationInfo.data) &&
        Objects.equals(this.totalPages, pageDataAgentApplicationInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataAgentApplicationInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataAgentApplicationInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAgentApplicationInfo {\n");
