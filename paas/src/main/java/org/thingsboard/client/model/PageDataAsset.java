 ...
 */
@JsonPropertyOrder({
  PageDataAsset.JSON_PROPERTY_DATA,
  PageDataAsset.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAsset.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAsset.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAsset {
  ...
  public PageDataAsset data(@javax.annotation.Nullable List<Asset> data) {
    this.data = data;
    return this;
  }

  public PageDataAsset addDataItem(Asset dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<Asset> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAsset object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAsset pageDataAsset = (PageDataAsset) o;
    return Objects.equals(this.data, pageDataAsset.data) &&
        Objects.equals(this.totalPages, pageDataAsset.totalPages) &&
        Objects.equals(this.totalElements, pageDataAsset.totalElements) &&
        Objects.equals(this.hasNext, pageDataAsset.hasNext);
  }
