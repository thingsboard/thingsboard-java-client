 ...
 */
@JsonPropertyOrder({
  PageDataConverter.JSON_PROPERTY_DATA,
  PageDataConverter.JSON_PROPERTY_HAS_NEXT,
  PageDataConverter.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataConverter.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataConverter {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<Converter> data = new ArrayList<>();
  ...
  public PageDataConverter data(@javax.annotation.Nullable List<Converter> data) {
    this.data = data;
    return this;
  }

  public PageDataConverter addDataItem(Converter dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<Converter> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataConverter object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataConverter pageDataConverter = (PageDataConverter) o;
    return Objects.equals(this.data, pageDataConverter.data) &&
        Objects.equals(this.hasNext, pageDataConverter.hasNext) &&
        Objects.equals(this.totalElements, pageDataConverter.totalElements) &&
        Objects.equals(this.totalPages, pageDataConverter.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataConverter {\n");
