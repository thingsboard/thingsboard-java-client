...
import org.thingsboard.client.model.QueueStats;
 ...
 */
@JsonPropertyOrder({
  PageDataQueueStats.JSON_PROPERTY_DATA,
  PageDataQueueStats.JSON_PROPERTY_TOTAL_PAGES,
  PageDataQueueStats.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataQueueStats.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataQueueStats {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<QueueStats> data = new ArrayList<>();
  ...
  public PageDataQueueStats data(@javax.annotation.Nullable List<QueueStats> data) {
    this.data = data;
    return this;
  }

  public PageDataQueueStats addDataItem(QueueStats dataItem) {
    if (this.data == null) {
  ...
  public List<QueueStats> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<QueueStats> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataQueueStats object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataQueueStats pageDataQueueStats = (PageDataQueueStats) o;
    return Objects.equals(this.data, pageDataQueueStats.data) &&
        Objects.equals(this.totalPages, pageDataQueueStats.totalPages) &&
        Objects.equals(this.totalElements, pageDataQueueStats.totalElements) &&
        Objects.equals(this.hasNext, pageDataQueueStats.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataQueueStats {\n");
