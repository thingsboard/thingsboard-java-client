...
public class DefaultTenantProfileConfiguration extends TenantProfileConfiguration {
  ...
  public DefaultTenantProfileConfiguration whiteLabelingEnabled(@Nullable Boolean whiteLabelingEnabled) {
  ...
  public DefaultTenantProfileConfiguration trendzEnabled(@Nullable Boolean trendzEnabled) {
  ...
  public DefaultTenantProfileConfiguration edgeEnabled(@Nullable Boolean edgeEnabled) {
