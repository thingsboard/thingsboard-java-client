 ...
 */
@JsonPropertyOrder({
  PageDataNotificationRequestInfo.JSON_PROPERTY_DATA,
  PageDataNotificationRequestInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataNotificationRequestInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataNotificationRequestInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataNotificationRequestInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<NotificationRequestInfo> data = new ArrayList<>();
  ...
  public PageDataNotificationRequestInfo() { 
  }
  ...
  public PageDataNotificationRequestInfo data(@javax.annotation.Nullable List<NotificationRequestInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataNotificationRequestInfo addDataItem(NotificationRequestInfo dataItem) {
    if (this.data == null) {
  ...
  public List<NotificationRequestInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<NotificationRequestInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataNotificationRequestInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataNotificationRequestInfo pageDataNotificationRequestInfo = (PageDataNotificationRequestInfo) o;
    return Objects.equals(this.data, pageDataNotificationRequestInfo.data) &&
        Objects.equals(this.totalPages, pageDataNotificationRequestInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataNotificationRequestInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataNotificationRequestInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataNotificationRequestInfo {\n");
