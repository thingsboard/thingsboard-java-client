...
public class AlarmCalculatedFieldConfiguration extends CalculatedFieldConfiguration {
  ...
  public AlarmCalculatedFieldConfiguration arguments(@Nonnull Map<String, Argument> arguments) {
  ...
  public AlarmCalculatedFieldConfiguration propagate(@Nullable Boolean propagate) {
  ...
  public AlarmCalculatedFieldConfiguration propagateRelationTypes(@Nullable List<String> propagateRelationTypes) {
  ...
  public AlarmCalculatedFieldConfiguration propagateToOwner(@Nullable Boolean propagateToOwner) {
  ...
  @Override
  public AlarmCalculatedFieldConfiguration aiGenerated(@Nullable Boolean aiGenerated) {
