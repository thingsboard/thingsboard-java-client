...
import org.thingsboard.client.model.AlarmData;
 ...
 */
@JsonPropertyOrder({
  PageDataAlarmData.JSON_PROPERTY_DATA,
  PageDataAlarmData.JSON_PROPERTY_HAS_NEXT,
  PageDataAlarmData.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAlarmData.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAlarmData {
  ...
  public PageDataAlarmData data(@javax.annotation.Nullable List<AlarmData> data) {
    this.data = data;
    return this;
  }

  public PageDataAlarmData addDataItem(AlarmData dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<AlarmData> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAlarmData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAlarmData pageDataAlarmData = (PageDataAlarmData) o;
    return Objects.equals(this.data, pageDataAlarmData.data) &&
        Objects.equals(this.hasNext, pageDataAlarmData.hasNext) &&
        Objects.equals(this.totalElements, pageDataAlarmData.totalElements) &&
        Objects.equals(this.totalPages, pageDataAlarmData.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAlarmData {\n");
