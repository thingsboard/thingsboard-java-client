...
public class CustomMobilePage extends MobilePage {
  ...
  public CustomMobilePage label(@Nullable String label) {
    this.label = label;
    return this;
  }
  ...
  public CustomMobilePage icon(@Nullable String icon) {
    this.icon = icon;
    return this;
  }
  ...
  public CustomMobilePage path(@Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  @Override
  public CustomMobilePage type(@Nonnull MobilePageType type) {
    this.setType(type);
    return this;
  }

  @Override
  public CustomMobilePage visible(@Nullable Boolean visible) {
