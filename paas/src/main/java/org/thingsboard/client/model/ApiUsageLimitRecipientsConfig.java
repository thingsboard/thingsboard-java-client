...
public class ApiUsageLimitRecipientsConfig extends NotificationRuleRecipientsConfig {
  ...
  public ApiUsageLimitRecipientsConfig targets(@Nonnull List<UUID> targets) {
  ...
  @Override
  public ApiUsageLimitRecipientsConfig triggerType(@Nullable NotificationRuleTriggerType triggerType) {
