...
public class AgentAppEventId extends EntityId {
  public AgentAppEventId() { 
  }

  @Override
  public AgentAppEventId id(@Nonnull UUID id) {
    this.setId(id);
    return this;
  }

  /**
   * Return true if this AgentAppEventId object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class AgentAppEventId {\n");
...
static {
  ...
  mappings.put("AgentAppEventId", AgentAppEventId.class);
  JSON.registerDiscriminator(AgentAppEventId.class, "entityType", mappings);
}
}
