...
public class ConverterExportData extends EntityExportData {
  public ConverterExportData() { 
  }

  @Override
  public ConverterExportData entityType(@javax.annotation.Nonnull EntityType entityType) {
    this.setEntityType(entityType);
    return this;
  }

  @Override
  public ConverterExportData entity(@javax.annotation.Nullable ExportableEntity entity) {
    this.setEntity(entity);
    return this;
  }

  @Override
  public ConverterExportData relations(@javax.annotation.Nullable List<EntityRelation> relations) {
    this.setRelations(relations);
    return this;
  }

  @Override
  public ConverterExportData attributes(@javax.annotation.Nullable Map<String, List<AttributeExportData>> attributes) {
    this.setAttributes(attributes);
    return this;
  }

  @Override
  public ConverterExportData calculatedFields(@javax.annotation.Nullable List<CalculatedField> calculatedFields) {
    this.setCalculatedFields(calculatedFields);
    return this;
  }

  /**
   * Return true if this ConverterExportData object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class ConverterExportData {\n");
...
static {
  ...
  mappings.put("ConverterExportData", ConverterExportData.class);
  JSON.registerDiscriminator(ConverterExportData.class, "entityType", mappings);
}
}
