...
public class CfReprocessingTaskResult extends TaskResult {
  ...
  public CfReprocessingTaskResult failure(@Nullable CfReprocessingTaskFailure failure) {
  ...
  @JsonProperty(value = JSON_PROPERTY_FAILURE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFailure(@Nullable CfReprocessingTaskFailure failure) {
    this.failure = failure;
  }


  @Override
  public CfReprocessingTaskResult success(@Nullable Boolean success) {
    this.setSuccess(success);
    return this;
  }

  @Override
  public CfReprocessingTaskResult discarded(@Nullable Boolean discarded) {
