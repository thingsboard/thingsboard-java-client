...
import org.thingsboard.client.model.CfReprocessingTaskFailure;
 ...
 */
@JsonPropertyOrder({
  CfReprocessingTaskResult.JSON_PROPERTY_FAILURE
})
...
public class CfReprocessingTaskResult extends TaskResult {
  ...
  public CfReprocessingTaskResult() { 
  }

  public CfReprocessingTaskResult failure(@javax.annotation.Nullable CfReprocessingTaskFailure failure) {
  ...
  public CfReprocessingTaskFailure getFailure() {
    return failure;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_FAILURE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFailure(@javax.annotation.Nullable CfReprocessingTaskFailure failure) {
    this.failure = failure;
  }


  @Override
  public CfReprocessingTaskResult success(@javax.annotation.Nullable Boolean success) {
    this.setSuccess(success);
    return this;
  }

  @Override
  public CfReprocessingTaskResult discarded(@javax.annotation.Nullable Boolean discarded) {
    this.setDiscarded(discarded);
    return this;
  }

  @Override
  public CfReprocessingTaskResult finishTs(@javax.annotation.Nullable Long finishTs) {
    this.setFinishTs(finishTs);
    return this;
  }

  @Override
  public CfReprocessingTaskResult jobType(@javax.annotation.Nonnull String jobType) {
  ...
  public boolean equals(Object o) {
    ...
    CfReprocessingTaskResult cfReprocessingTaskResult = (CfReprocessingTaskResult) o;
    return Objects.equals(this.failure, cfReprocessingTaskResult.failure) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(failure, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CfReprocessingTaskResult {\n");
...
static {
  ...
  JSON.registerDiscriminator(CfReprocessingTaskResult.class, "jobType", mappings);
}
}
