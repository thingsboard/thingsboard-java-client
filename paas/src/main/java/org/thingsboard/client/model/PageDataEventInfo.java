...
import org.thingsboard.client.model.EventInfo;
 ...
 */
@JsonPropertyOrder({
  PageDataEventInfo.JSON_PROPERTY_DATA,
  PageDataEventInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataEventInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataEventInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:18:03.556877+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataEventInfo {
  ...
  public PageDataEventInfo data(@javax.annotation.Nullable List<EventInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataEventInfo addDataItem(EventInfo dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<EventInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataEventInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataEventInfo pageDataEventInfo = (PageDataEventInfo) o;
    return Objects.equals(this.data, pageDataEventInfo.data) &&
        Objects.equals(this.totalPages, pageDataEventInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataEventInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataEventInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataEventInfo {\n");
