 ...
 */
@JsonPropertyOrder({
  PageDataAgent.JSON_PROPERTY_DATA,
  PageDataAgent.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAgent.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAgent.JSON_PROPERTY_HAS_NEXT
})
...
public class PageDataAgent {
  ...
  public PageDataAgent data(@Nullable List<Agent> data) {
    this.data = data;
    return this;
  }

  public PageDataAgent addDataItem(Agent dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<Agent> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAgent object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAgent pageDataAgent = (PageDataAgent) o;
    return Objects.equals(this.data, pageDataAgent.data) &&
        Objects.equals(this.totalPages, pageDataAgent.totalPages) &&
        Objects.equals(this.totalElements, pageDataAgent.totalElements) &&
        Objects.equals(this.hasNext, pageDataAgent.hasNext);
  }
