 ...
 */
@JsonPropertyOrder({
  PageDataDeviceProfile.JSON_PROPERTY_DATA,
  PageDataDeviceProfile.JSON_PROPERTY_TOTAL_PAGES,
  PageDataDeviceProfile.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataDeviceProfile.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:18:03.556877+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataDeviceProfile {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<DeviceProfile> data = new ArrayList<>();
  ...
  public PageDataDeviceProfile data(@javax.annotation.Nullable List<DeviceProfile> data) {
    this.data = data;
    return this;
  }

  public PageDataDeviceProfile addDataItem(DeviceProfile dataItem) {
    if (this.data == null) {
  ...
  public List<DeviceProfile> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<DeviceProfile> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataDeviceProfile object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataDeviceProfile pageDataDeviceProfile = (PageDataDeviceProfile) o;
    return Objects.equals(this.data, pageDataDeviceProfile.data) &&
        Objects.equals(this.totalPages, pageDataDeviceProfile.totalPages) &&
        Objects.equals(this.totalElements, pageDataDeviceProfile.totalElements) &&
        Objects.equals(this.hasNext, pageDataDeviceProfile.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataDeviceProfile {\n");
