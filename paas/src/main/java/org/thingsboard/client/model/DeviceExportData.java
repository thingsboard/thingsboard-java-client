...
public class DeviceExportData extends EntityExportData {
  ...
  public DeviceExportData credentials(@javax.annotation.Nullable DeviceCredentials credentials) {
  ...
  @JsonProperty(value = JSON_PROPERTY_CREDENTIALS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCredentials(@javax.annotation.Nullable DeviceCredentials credentials) {
    this.credentials = credentials;
  }
  ...
  @Override
  public DeviceExportData relations(@javax.annotation.Nullable List<EntityRelation> relations) {
    this.setRelations(relations);
    return this;
  }

  @Override
  public DeviceExportData attributes(@javax.annotation.Nullable Map<String, List<AttributeExportData>> attributes) {
