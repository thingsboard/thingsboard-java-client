...
public class AssetTypeFilter extends EntityFilter {
  ...
  public AssetTypeFilter assetNameFilter(@javax.annotation.Nullable String assetNameFilter) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ASSET_NAME_FILTER, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAssetNameFilter(@javax.annotation.Nullable String assetNameFilter) {
    this.assetNameFilter = assetNameFilter;
  }
