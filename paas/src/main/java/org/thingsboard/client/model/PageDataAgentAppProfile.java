 ...
 */
@JsonPropertyOrder({
  PageDataAgentAppProfile.JSON_PROPERTY_DATA,
  PageDataAgentAppProfile.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAgentAppProfile.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAgentAppProfile.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAgentAppProfile {
  public static final String JSON_PROPERTY_DATA = "data";
  @Nullable
  private List<AgentAppProfile> data = new ArrayList<>();
  ...
  public PageDataAgentAppProfile() { 
  }
  ...
  public PageDataAgentAppProfile data(@Nullable List<AgentAppProfile> data) {
    this.data = data;
    return this;
  }

  public PageDataAgentAppProfile addDataItem(AgentAppProfile dataItem) {
    if (this.data == null) {
  ...
  public List<AgentAppProfile> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<AgentAppProfile> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAgentAppProfile object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAgentAppProfile pageDataAgentAppProfile = (PageDataAgentAppProfile) o;
    return Objects.equals(this.data, pageDataAgentAppProfile.data) &&
        Objects.equals(this.totalPages, pageDataAgentAppProfile.totalPages) &&
        Objects.equals(this.totalElements, pageDataAgentAppProfile.totalElements) &&
        Objects.equals(this.hasNext, pageDataAgentAppProfile.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAgentAppProfile {\n");
