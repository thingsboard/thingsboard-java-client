...
public class WhiteLabeling {
  ...
  @JsonCreator
  public WhiteLabeling(
    @JsonProperty(JSON_PROPERTY_LEGACY_DOMAIN) String legacyDomain
  ) {
  this();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, whiteLabeling.tenantId) &&
        ...
        Objects.equals(this.legacyDomain, whiteLabeling.legacyDomain) &&
        Objects.equals(this.domainId, whiteLabeling.domainId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, customerId, type, settings, legacyDomain, domainId);
  }
  ...
  public String toString() {
    ...
    sb.append("    legacyDomain: ").append(toIndentedString(legacyDomain)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `legacyDomain` to the URL query string
    if (getLegacyDomain() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%slegacyDomain%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLegacyDomain()))));
    }
