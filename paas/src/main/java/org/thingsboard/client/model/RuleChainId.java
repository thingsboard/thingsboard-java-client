 ...
 */
@JsonPropertyOrder({
  RuleChainId.JSON_PROPERTY_ID,
  RuleChainId.JSON_PROPERTY_ENTITY_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:18:03.556877+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class RuleChainId {
  ...
  public RuleChainId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public RuleChainId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this RuleChainId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RuleChainId ruleChainId = (RuleChainId) o;
    return Objects.equals(this.id, ruleChainId.id) &&
