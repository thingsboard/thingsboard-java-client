...
public class MobileAppId extends EntityId {
  ...
  @Override
  public MobileAppId entityType(@Nonnull EntityType entityType) {
    this.setEntityType(entityType);
    return this;
  }

  @Override
  public MobileAppId id(@Nonnull UUID id) {
    this.setId(id);
    return this;
  }
...
static {
  ...
  mappings.put("MobileAppId", MobileAppId.class);
  JSON.registerDiscriminator(MobileAppId.class, "entityType", mappings);
}
}
