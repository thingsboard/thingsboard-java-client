...
public class ReportInfo {
  ...
  public ReportInfo id(@Nullable ReportId id) {
    this.id = id;
    return this;
  }
  ...
  public ReportInfo tenantId(@Nonnull TenantId tenantId) {
  ...
  public ReportInfo customerId(@Nullable CustomerId customerId) {
  ...
  public ReportInfo templateId(@Nonnull ReportTemplateId templateId) {
  ...
  public ReportInfo format(@Nonnull TbReportFormat format) {
    this.format = format;
    return this;
  }
  ...
  public ReportInfo name(@Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ReportInfo userId(@Nonnull UserId userId) {
    this.userId = userId;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_TEMPLATE_INFO, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTemplateInfo(@Nullable EntityInfo templateInfo) {
    this.templateInfo = templateInfo;
  }


  public ReportInfo customerTitle(@Nullable String customerTitle) {
  ...
  public ReportInfo userName(@Nullable String userName) {
