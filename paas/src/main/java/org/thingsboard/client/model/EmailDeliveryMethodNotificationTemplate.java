 ...
 */
@JsonPropertyOrder({
  EmailDeliveryMethodNotificationTemplate.JSON_PROPERTY_SUBJECT
})
...
public class EmailDeliveryMethodNotificationTemplate extends DeliveryMethodNotificationTemplate {
  ...
  public EmailDeliveryMethodNotificationTemplate subject(@javax.annotation.Nonnull String subject) {
  ...
  @Override
  public EmailDeliveryMethodNotificationTemplate enabled(@javax.annotation.Nullable Boolean enabled) {
    this.setEnabled(enabled);
    return this;
  }

  @Override
  public EmailDeliveryMethodNotificationTemplate body(@javax.annotation.Nonnull String body) {
    this.setBody(body);
    return this;
  }

  @Override
  public EmailDeliveryMethodNotificationTemplate method(@javax.annotation.Nonnull String method) {
  ...
  public boolean equals(Object o) {
    ...
    EmailDeliveryMethodNotificationTemplate emailDeliveryMethodNotificationTemplate = (EmailDeliveryMethodNotificationTemplate) o;
    return Objects.equals(this.subject, emailDeliveryMethodNotificationTemplate.subject) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subject, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmailDeliveryMethodNotificationTemplate {\n");
...
static {
  ...
  mappings.put("EmailDeliveryMethodNotificationTemplate", EmailDeliveryMethodNotificationTemplate.class);
  JSON.registerDiscriminator(EmailDeliveryMethodNotificationTemplate.class, "method", mappings);
}
}
