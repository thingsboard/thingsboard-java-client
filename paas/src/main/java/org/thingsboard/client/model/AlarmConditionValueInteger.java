...
public class AlarmConditionValueInteger {
  ...
  public AlarmConditionValueInteger staticValue(@Nullable Integer staticValue) {
  ...
  @JsonProperty(value = JSON_PROPERTY_STATIC_VALUE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStaticValue(@Nullable Integer staticValue) {
    this.staticValue = staticValue;
  }


  public AlarmConditionValueInteger dynamicValueArgument(@Nullable String dynamicValueArgument) {
