 ...
 */
@JsonPropertyOrder({
  CustomMenu.JSON_PROPERTY_ID,
  CustomMenu.JSON_PROPERTY_CREATED_TIME,
  CustomMenu.JSON_PROPERTY_TENANT_ID,
  CustomMenu.JSON_PROPERTY_CUSTOMER_ID,
  CustomMenu.JSON_PROPERTY_NAME,
  CustomMenu.JSON_PROPERTY_SCOPE,
  CustomMenu.JSON_PROPERTY_ASSIGNEE_TYPE,
  CustomMenu.JSON_PROPERTY_USER_GROUP_NAMES,
  CustomMenu.JSON_PROPERTY_CONFIG
})
...
public class CustomMenu {
  ...
  public CustomMenu id(@javax.annotation.Nullable CustomMenuId id) {
    this.id = id;
    return this;
  }
  ...
  public CustomMenu name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CustomMenu scope(@javax.annotation.Nonnull CMScope scope) {
    this.scope = scope;
    return this;
  }
  ...
  public CustomMenu assigneeType(@javax.annotation.Nonnull CMAssigneeType assigneeType) {
  ...
  public CustomMenu userGroupNames(@javax.annotation.Nullable List<String> userGroupNames) {
    this.userGroupNames = userGroupNames;
    return this;
  }

  public CustomMenu addUserGroupNamesItem(String userGroupNamesItem) {
  ...
  public CustomMenu config(@javax.annotation.Nullable CustomMenuConfig config) {
    this.config = config;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CONFIG, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConfig(@javax.annotation.Nullable CustomMenuConfig config) {
    this.config = config;
  }


  /**
   * Return true if this CustomMenu object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CustomMenu customMenu = (CustomMenu) o;
    return Objects.equals(this.id, customMenu.id) &&
        Objects.equals(this.createdTime, customMenu.createdTime) &&
        Objects.equals(this.tenantId, customMenu.tenantId) &&
        Objects.equals(this.customerId, customMenu.customerId) &&
        Objects.equals(this.name, customMenu.name) &&
        Objects.equals(this.scope, customMenu.scope) &&
        Objects.equals(this.assigneeType, customMenu.assigneeType) &&
        Objects.equals(this.userGroupNames, customMenu.userGroupNames) &&
        Objects.equals(this.config, customMenu.config);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createdTime, tenantId, customerId, name, scope, assigneeType, userGroupNames, config);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CustomMenu {\n");
