...
public class PdfReportTemplateConfig extends ReportTemplateConfig {
  ...
  public PdfReportTemplateConfig header(@javax.annotation.Nullable HeaderFooter header) {
    this.header = header;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_HEADER, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHeader(@javax.annotation.Nullable HeaderFooter header) {
    this.header = header;
  }
