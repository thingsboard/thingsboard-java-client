...
public class ReportPieChartSettings extends ReportLatestChartSettings {
  ...
  public ReportPieChartSettings showLabel(@javax.annotation.Nullable Boolean showLabel) {
  ...
  public ReportPieChartSettings labelPosition(@javax.annotation.Nullable PieChartLabelPosition labelPosition) {
  ...
  @JsonProperty(value = JSON_PROPERTY_LABEL_POSITION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLabelPosition(@javax.annotation.Nullable PieChartLabelPosition labelPosition) {
    this.labelPosition = labelPosition;
  }


  public ReportPieChartSettings labelFont(@javax.annotation.Nullable Font labelFont) {
  ...
  public ReportPieChartSettings labelColor(@javax.annotation.Nullable String labelColor) {
  ...
  public ReportPieChartSettings borderWidth(@javax.annotation.Nullable Float borderWidth) {
  ...
  public ReportPieChartSettings borderColor(@javax.annotation.Nullable String borderColor) {
  ...
  public ReportPieChartSettings radius(@javax.annotation.Nullable Double radius) {
    this.radius = radius;
    return this;
  }
  ...
  public ReportPieChartSettings clockwise(@javax.annotation.Nullable Boolean clockwise) {
  ...
  @JsonProperty(value = JSON_PROPERTY_CLOCKWISE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setClockwise(@javax.annotation.Nullable Boolean clockwise) {
    this.clockwise = clockwise;
  }


  @Override
  public ReportPieChartSettings showTitle(@javax.annotation.Nullable Boolean showTitle) {
    this.setShowTitle(showTitle);
    return this;
  }

  @Override
  public ReportPieChartSettings titleFont(@javax.annotation.Nullable Font titleFont) {
    this.setTitleFont(titleFont);
    return this;
  }

  @Override
  public ReportPieChartSettings titleColor(@javax.annotation.Nullable String titleColor) {
    this.setTitleColor(titleColor);
    return this;
  }

  @Override
  public ReportPieChartSettings titleAlignment(@javax.annotation.Nullable TextAlignment titleAlignment) {
    this.setTitleAlignment(titleAlignment);
    return this;
  }

  @Override
  public ReportPieChartSettings units(@javax.annotation.Nullable String units) {
    this.setUnits(units);
    return this;
  }

  @Override
  public ReportPieChartSettings decimals(@javax.annotation.Nullable Integer decimals) {
    this.setDecimals(decimals);
    return this;
  }

  @Override
  public ReportPieChartSettings autoScale(@javax.annotation.Nullable Boolean autoScale) {
    this.setAutoScale(autoScale);
    return this;
  }

  @Override
  public ReportPieChartSettings sortSeries(@javax.annotation.Nullable Boolean sortSeries) {
    this.setSortSeries(sortSeries);
    return this;
  }

  @Override
  public ReportPieChartSettings showTotal(@javax.annotation.Nullable Boolean showTotal) {
    this.setShowTotal(showTotal);
    return this;
  }

  @Override
  public ReportPieChartSettings showLegend(@javax.annotation.Nullable Boolean showLegend) {
    this.setShowLegend(showLegend);
    return this;
  }

  @Override
  public ReportPieChartSettings legendPosition(@javax.annotation.Nullable LegendPosition legendPosition) {
    this.setLegendPosition(legendPosition);
    return this;
  }

  @Override
  public ReportPieChartSettings legendLabelFont(@javax.annotation.Nullable Font legendLabelFont) {
    this.setLegendLabelFont(legendLabelFont);
    return this;
  }

  @Override
  public ReportPieChartSettings legendLabelColor(@javax.annotation.Nullable String legendLabelColor) {
    this.setLegendLabelColor(legendLabelColor);
    return this;
  }

  @Override
  public ReportPieChartSettings legendValueFont(@javax.annotation.Nullable Font legendValueFont) {
    this.setLegendValueFont(legendValueFont);
    return this;
  }

  @Override
  public ReportPieChartSettings legendValueColor(@javax.annotation.Nullable String legendValueColor) {
    this.setLegendValueColor(legendValueColor);
    return this;
  }

  @Override
  public ReportPieChartSettings legendShowTotal(@javax.annotation.Nullable Boolean legendShowTotal) {
