...
public class BulkImportResultDevice {
  ...
  public BulkImportResultDevice created(@Nullable Integer created) {
  ...
  public BulkImportResultDevice updated(@Nullable Integer updated) {
  ...
  public BulkImportResultDevice errors(@Nullable Integer errors) {
    this.errors = errors;
    return this;
  }
  ...
  public BulkImportResultDevice errorsList(@Nullable List<String> errorsList) {
