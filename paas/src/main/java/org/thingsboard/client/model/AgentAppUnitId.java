...
public class AgentAppUnitId extends EntityId {
  public AgentAppUnitId() { 
  }

  @Override
  public AgentAppUnitId id(@Nonnull UUID id) {
    this.setId(id);
    return this;
  }

  /**
   * Return true if this AgentAppUnitId object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class AgentAppUnitId {\n");
...
static {
  ...
  mappings.put("AgentAppUnitId", AgentAppUnitId.class);
  JSON.registerDiscriminator(AgentAppUnitId.class, "entityType", mappings);
}
}
