 ...
 */
@JsonPropertyOrder({
  StepFieldBoolean.JSON_PROPERTY_VALUE,
  StepFieldBoolean.JSON_PROPERTY_USER_CHOICE
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class StepFieldBoolean {
  ...
  public StepFieldBoolean value(@Nullable Boolean value) {
    this.value = value;
    return this;
  }
  ...
  public StepFieldBoolean userChoice(@Nullable Boolean userChoice) {
  ...
  /**
   * Return true if this StepFieldBoolean object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StepFieldBoolean stepFieldBoolean = (StepFieldBoolean) o;
    return Objects.equals(this.value, stepFieldBoolean.value) &&
        Objects.equals(this.userChoice, stepFieldBoolean.userChoice);
  }
  ...
  public String toString() {
    ...
    sb.append("class StepFieldBoolean {\n");
