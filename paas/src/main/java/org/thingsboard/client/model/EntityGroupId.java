...
public class EntityGroupId extends EntityId {
...
static {
  ...
  mappings.put("EntityGroupId", EntityGroupId.class);
  JSON.registerDiscriminator(EntityGroupId.class, "entityType", mappings);
}
}
