...
import org.thingsboard.client.model.ScheduledReportInfo;
 ...
 */
@JsonPropertyOrder({
  PageDataScheduledReportInfo.JSON_PROPERTY_DATA,
  PageDataScheduledReportInfo.JSON_PROPERTY_HAS_NEXT,
  PageDataScheduledReportInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataScheduledReportInfo.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataScheduledReportInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<ScheduledReportInfo> data = new ArrayList<>();
  ...
  public PageDataScheduledReportInfo() { 
  }
  ...
  public PageDataScheduledReportInfo data(@javax.annotation.Nullable List<ScheduledReportInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataScheduledReportInfo addDataItem(ScheduledReportInfo dataItem) {
    if (this.data == null) {
  ...
  public List<ScheduledReportInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<ScheduledReportInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataScheduledReportInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataScheduledReportInfo pageDataScheduledReportInfo = (PageDataScheduledReportInfo) o;
    return Objects.equals(this.data, pageDataScheduledReportInfo.data) &&
        Objects.equals(this.hasNext, pageDataScheduledReportInfo.hasNext) &&
        Objects.equals(this.totalElements, pageDataScheduledReportInfo.totalElements) &&
        Objects.equals(this.totalPages, pageDataScheduledReportInfo.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataScheduledReportInfo {\n");
