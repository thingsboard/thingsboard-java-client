...
public class ActivateUserRequest {
  ...
  /**
   * Return true if this ActivateUserRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activateToken, activateUserRequest.activateToken) &&
        Objects.equals(this.password, activateUserRequest.password);
  }

  @Override
  public int hashCode() {
    return Objects.hash(activateToken, password);
  }
  ...
  public String toString() {
    ...
    sb.append("    activateToken: ").append(toIndentedString(activateToken)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `activateToken` to the URL query string
    if (getActivateToken() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sactivateToken%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getActivateToken()))));
    }
