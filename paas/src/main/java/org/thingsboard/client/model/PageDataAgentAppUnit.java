...
import org.thingsboard.client.model.AgentAppUnit;
 ...
 */
@JsonPropertyOrder({
  PageDataAgentAppUnit.JSON_PROPERTY_DATA,
  PageDataAgentAppUnit.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAgentAppUnit.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAgentAppUnit.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAgentAppUnit {
  public static final String JSON_PROPERTY_DATA = "data";
  @Nullable
  private List<AgentAppUnit> data = new ArrayList<>();
  ...
  public PageDataAgentAppUnit data(@Nullable List<AgentAppUnit> data) {
    this.data = data;
    return this;
  }

  public PageDataAgentAppUnit addDataItem(AgentAppUnit dataItem) {
    if (this.data == null) {
  ...
  public List<AgentAppUnit> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<AgentAppUnit> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAgentAppUnit object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAgentAppUnit pageDataAgentAppUnit = (PageDataAgentAppUnit) o;
    return Objects.equals(this.data, pageDataAgentAppUnit.data) &&
        Objects.equals(this.totalPages, pageDataAgentAppUnit.totalPages) &&
        Objects.equals(this.totalElements, pageDataAgentAppUnit.totalElements) &&
        Objects.equals(this.hasNext, pageDataAgentAppUnit.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAgentAppUnit {\n");
