...
public class AgentProfileId extends EntityId {
  public AgentProfileId() { 
  }

  @Override
  public AgentProfileId id(@Nonnull UUID id) {
    this.setId(id);
    return this;
  }

  /**
   * Return true if this AgentProfileId object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class AgentProfileId {\n");
...
static {
  ...
  mappings.put("AgentProfileId", AgentProfileId.class);
  JSON.registerDiscriminator(AgentProfileId.class, "entityType", mappings);
}
}
