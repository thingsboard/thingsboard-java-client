 ...
 */
@JsonPropertyOrder({
  PageDataAlarmRuleDefinition.JSON_PROPERTY_DATA,
  PageDataAlarmRuleDefinition.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAlarmRuleDefinition.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAlarmRuleDefinition.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAlarmRuleDefinition {
  public static final String JSON_PROPERTY_DATA = "data";
  @Nullable
  private List<AlarmRuleDefinition> data = new ArrayList<>();
  ...
  public PageDataAlarmRuleDefinition() { 
  }
  ...
  public PageDataAlarmRuleDefinition data(@Nullable List<AlarmRuleDefinition> data) {
    this.data = data;
    return this;
  }

  public PageDataAlarmRuleDefinition addDataItem(AlarmRuleDefinition dataItem) {
    if (this.data == null) {
  ...
  public List<AlarmRuleDefinition> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<AlarmRuleDefinition> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAlarmRuleDefinition object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAlarmRuleDefinition pageDataAlarmRuleDefinition = (PageDataAlarmRuleDefinition) o;
    return Objects.equals(this.data, pageDataAlarmRuleDefinition.data) &&
        Objects.equals(this.totalPages, pageDataAlarmRuleDefinition.totalPages) &&
        Objects.equals(this.totalElements, pageDataAlarmRuleDefinition.totalElements) &&
        Objects.equals(this.hasNext, pageDataAlarmRuleDefinition.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAlarmRuleDefinition {\n");
