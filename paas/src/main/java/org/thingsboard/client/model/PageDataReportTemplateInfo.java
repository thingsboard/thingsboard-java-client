 ...
 */
@JsonPropertyOrder({
  PageDataReportTemplateInfo.JSON_PROPERTY_DATA,
  PageDataReportTemplateInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataReportTemplateInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataReportTemplateInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:18:03.556877+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataReportTemplateInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<ReportTemplateInfo> data = new ArrayList<>();
  ...
  public PageDataReportTemplateInfo() { 
  }
  ...
  public PageDataReportTemplateInfo data(@javax.annotation.Nullable List<ReportTemplateInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataReportTemplateInfo addDataItem(ReportTemplateInfo dataItem) {
    if (this.data == null) {
  ...
  public List<ReportTemplateInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<ReportTemplateInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataReportTemplateInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataReportTemplateInfo pageDataReportTemplateInfo = (PageDataReportTemplateInfo) o;
    return Objects.equals(this.data, pageDataReportTemplateInfo.data) &&
        Objects.equals(this.totalPages, pageDataReportTemplateInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataReportTemplateInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataReportTemplateInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataReportTemplateInfo {\n");
