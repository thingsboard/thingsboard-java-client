 ...
 */
@JsonPropertyOrder({
  SecretId.JSON_PROPERTY_ID,
  SecretId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class SecretId {
  ...
  public SecretId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public SecretId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this SecretId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, secretId.id) &&
        Objects.equals(this.entityType, secretId.entityType);
  }
