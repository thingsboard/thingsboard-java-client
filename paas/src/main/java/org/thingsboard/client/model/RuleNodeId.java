 ...
 */
@JsonPropertyOrder({
  RuleNodeId.JSON_PROPERTY_ID,
  RuleNodeId.JSON_PROPERTY_ENTITY_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class RuleNodeId {
  ...
  public RuleNodeId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public RuleNodeId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this RuleNodeId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RuleNodeId ruleNodeId = (RuleNodeId) o;
    return Objects.equals(this.id, ruleNodeId.id) &&
