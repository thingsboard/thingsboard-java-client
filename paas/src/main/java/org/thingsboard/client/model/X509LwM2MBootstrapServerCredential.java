 ...
 */
@JsonPropertyOrder({
  X509LwM2MBootstrapServerCredential.JSON_PROPERTY_SHORT_SERVER_ID,
  X509LwM2MBootstrapServerCredential.JSON_PROPERTY_BOOTSTRAP_SERVER_IS,
  X509LwM2MBootstrapServerCredential.JSON_PROPERTY_HOST,
  X509LwM2MBootstrapServerCredential.JSON_PROPERTY_PORT,
  X509LwM2MBootstrapServerCredential.JSON_PROPERTY_CLIENT_HOLD_OFF_TIME,
  X509LwM2MBootstrapServerCredential.JSON_PROPERTY_SERVER_PUBLIC_KEY,
  X509LwM2MBootstrapServerCredential.JSON_PROPERTY_SERVER_CERTIFICATE,
  X509LwM2MBootstrapServerCredential.JSON_PROPERTY_BOOTSTRAP_SERVER_ACCOUNT_TIMEOUT,
  X509LwM2MBootstrapServerCredential.JSON_PROPERTY_LIFETIME,
  X509LwM2MBootstrapServerCredential.JSON_PROPERTY_DEFAULT_MIN_PERIOD,
  X509LwM2MBootstrapServerCredential.JSON_PROPERTY_NOTIF_IF_DISABLED,
  X509LwM2MBootstrapServerCredential.JSON_PROPERTY_BINDING
})
...
public class X509LwM2MBootstrapServerCredential extends LwM2MBootstrapServerCredential {
  ...
  public X509LwM2MBootstrapServerCredential() { 
  }
  ...
  @Override
  public X509LwM2MBootstrapServerCredential securityMode(@javax.annotation.Nonnull String securityMode) {
    this.setSecurityMode(securityMode);
    return this;
  }

  /**
   * Return true if this X509LwM2MBootstrapServerCredential object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    X509LwM2MBootstrapServerCredential x509LwM2MBootstrapServerCredential = (X509LwM2MBootstrapServerCredential) o;
    return Objects.equals(this.shortServerId, x509LwM2MBootstrapServerCredential.shortServerId) &&
        Objects.equals(this.bootstrapServerIs, x509LwM2MBootstrapServerCredential.bootstrapServerIs) &&
        Objects.equals(this.host, x509LwM2MBootstrapServerCredential.host) &&
        Objects.equals(this.port, x509LwM2MBootstrapServerCredential.port) &&
        Objects.equals(this.clientHoldOffTime, x509LwM2MBootstrapServerCredential.clientHoldOffTime) &&
        Objects.equals(this.serverPublicKey, x509LwM2MBootstrapServerCredential.serverPublicKey) &&
        Objects.equals(this.serverCertificate, x509LwM2MBootstrapServerCredential.serverCertificate) &&
        Objects.equals(this.bootstrapServerAccountTimeout, x509LwM2MBootstrapServerCredential.bootstrapServerAccountTimeout) &&
        Objects.equals(this.lifetime, x509LwM2MBootstrapServerCredential.lifetime) &&
        Objects.equals(this.defaultMinPeriod, x509LwM2MBootstrapServerCredential.defaultMinPeriod) &&
        Objects.equals(this.notifIfDisabled, x509LwM2MBootstrapServerCredential.notifIfDisabled) &&
        Objects.equals(this.binding, x509LwM2MBootstrapServerCredential.binding) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class X509LwM2MBootstrapServerCredential {\n");
...
static {
  ...
  JSON.registerDiscriminator(X509LwM2MBootstrapServerCredential.class, "securityMode", mappings);
}
}
