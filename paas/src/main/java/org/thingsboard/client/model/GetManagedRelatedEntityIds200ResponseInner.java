...
@JsonDeserialize(using = GetManagedRelatedEntityIds200ResponseInner.GetManagedRelatedEntityIds200ResponseInnerDeserializer.class)
@JsonSerialize(using = GetManagedRelatedEntityIds200ResponseInner.GetManagedRelatedEntityIds200ResponseInnerSerializer.class)
public class GetManagedRelatedEntityIds200ResponseInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetManagedRelatedEntityIds200ResponseInner.class.getName());

    public static class GetManagedRelatedEntityIds200ResponseInnerSerializer extends StdSerializer<GetManagedRelatedEntityIds200ResponseInner> {
        public GetManagedRelatedEntityIds200ResponseInnerSerializer(Class<GetManagedRelatedEntityIds200ResponseInner> t) {
            super(t);
        }

        public GetManagedRelatedEntityIds200ResponseInnerSerializer() {
            this(null);
        }

        @Override
        public void serialize(GetManagedRelatedEntityIds200ResponseInner value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class GetManagedRelatedEntityIds200ResponseInnerDeserializer extends StdDeserializer<GetManagedRelatedEntityIds200ResponseInner> {
        public GetManagedRelatedEntityIds200ResponseInnerDeserializer() {
            this(GetManagedRelatedEntityIds200ResponseInner.class);
        }

        public GetManagedRelatedEntityIds200ResponseInnerDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public GetManagedRelatedEntityIds200ResponseInner deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            // deserialize AgentAppEventId
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (AgentAppEventId.class.equals(Integer.class) || AgentAppEventId.class.equals(Long.class) || AgentAppEventId.class.equals(Float.class) || AgentAppEventId.class.equals(Double.class) || AgentAppEventId.class.equals(Boolean.class) || AgentAppEventId.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AgentAppEventId.class.equals(Integer.class) || AgentAppEventId.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AgentAppEventId.class.equals(Float.class) || AgentAppEventId.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (AgentAppEventId.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AgentAppEventId.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(AgentAppEventId.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'AgentAppEventId'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'AgentAppEventId'", e);
            }

            // deserialize AgentAppProfileId
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (AgentAppProfileId.class.equals(Integer.class) || AgentAppProfileId.class.equals(Long.class) || AgentAppProfileId.class.equals(Float.class) || AgentAppProfileId.class.equals(Double.class) || AgentAppProfileId.class.equals(Boolean.class) || AgentAppProfileId.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AgentAppProfileId.class.equals(Integer.class) || AgentAppProfileId.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AgentAppProfileId.class.equals(Float.class) || AgentAppProfileId.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (AgentAppProfileId.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AgentAppProfileId.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(AgentAppProfileId.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'AgentAppProfileId'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'AgentAppProfileId'", e);
            }

            // deserialize AgentAppUnitId
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (AgentAppUnitId.class.equals(Integer.class) || AgentAppUnitId.class.equals(Long.class) || AgentAppUnitId.class.equals(Float.class) || AgentAppUnitId.class.equals(Double.class) || AgentAppUnitId.class.equals(Boolean.class) || AgentAppUnitId.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AgentAppUnitId.class.equals(Integer.class) || AgentAppUnitId.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AgentAppUnitId.class.equals(Float.class) || AgentAppUnitId.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (AgentAppUnitId.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AgentAppUnitId.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(AgentAppUnitId.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'AgentAppUnitId'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'AgentAppUnitId'", e);
            }

            // deserialize AgentApplicationId
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (AgentApplicationId.class.equals(Integer.class) || AgentApplicationId.class.equals(Long.class) || AgentApplicationId.class.equals(Float.class) || AgentApplicationId.class.equals(Double.class) || AgentApplicationId.class.equals(Boolean.class) || AgentApplicationId.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AgentApplicationId.class.equals(Integer.class) || AgentApplicationId.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AgentApplicationId.class.equals(Float.class) || AgentApplicationId.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (AgentApplicationId.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AgentApplicationId.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(AgentApplicationId.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'AgentApplicationId'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'AgentApplicationId'", e);
            }

            // deserialize AgentBulkActionId
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (AgentBulkActionId.class.equals(Integer.class) || AgentBulkActionId.class.equals(Long.class) || AgentBulkActionId.class.equals(Float.class) || AgentBulkActionId.class.equals(Double.class) || AgentBulkActionId.class.equals(Boolean.class) || AgentBulkActionId.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AgentBulkActionId.class.equals(Integer.class) || AgentBulkActionId.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AgentBulkActionId.class.equals(Float.class) || AgentBulkActionId.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (AgentBulkActionId.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AgentBulkActionId.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(AgentBulkActionId.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'AgentBulkActionId'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'AgentBulkActionId'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (AgentId.class.equals(Integer.class) || AgentId.class.equals(Long.class) || AgentId.class.equals(Float.class) || AgentId.class.equals(Double.class) || AgentId.class.equals(Boolean.class) || AgentId.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AgentId.class.equals(Integer.class) || AgentId.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AgentId.class.equals(Float.class) || AgentId.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (AgentId.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AgentId.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(AgentId.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'AgentId'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'AgentId'", e);
            }

            // deserialize AgentProfileId
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (AgentProfileId.class.equals(Integer.class) || AgentProfileId.class.equals(Long.class) || AgentProfileId.class.equals(Float.class) || AgentProfileId.class.equals(Double.class) || AgentProfileId.class.equals(Boolean.class) || AgentProfileId.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AgentProfileId.class.equals(Integer.class) || AgentProfileId.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AgentProfileId.class.equals(Float.class) || AgentProfileId.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (AgentProfileId.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AgentProfileId.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    deserialized = tree.traverse(jp.getCodec()).readValueAs(AgentProfileId.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    match++;
                    log.log(Level.FINER, "Input data matches schema 'AgentProfileId'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'AgentProfileId'", e);
            }
            ...
            if (match == 1) {
                GetManagedRelatedEntityIds200ResponseInner ret = new GetManagedRelatedEntityIds200ResponseInner();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for GetManagedRelatedEntityIds200ResponseInner: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public GetManagedRelatedEntityIds200ResponseInner getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "GetManagedRelatedEntityIds200ResponseInner cannot be null");
        }
    }
    ...
    public GetManagedRelatedEntityIds200ResponseInner() {
        super("oneOf", Boolean.FALSE);
    }

    public GetManagedRelatedEntityIds200ResponseInner(AdminSettingsId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(AgentAppEventId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(AgentAppProfileId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(AgentAppUnitId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(AgentApplicationId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(AgentBulkActionId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(AgentId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(AgentProfileId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(AiModelId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(AlarmId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(ApiKeyId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(ApiUsageStateId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(AssetId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(AssetProfileId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(BillingCustomerId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(BlobEntityId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(CalculatedFieldId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(ConverterId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(CouponId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(CustomerId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(DashboardId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(DeviceId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(DeviceProfileId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(DomainId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(EdgeId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(EntityGroupId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(EntityViewId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(GroupPermissionId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(IntegrationId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(JobId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(MobileAppBundleId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(MobileAppId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(NotificationId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(NotificationRequestId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(NotificationRuleId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(NotificationTargetId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(NotificationTemplateId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(OAuth2ClientId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(OtaPackageId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(ProductId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(QueueId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(QueueStatsId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(ReportId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(ReportTemplateId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(RoleId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(RpcId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(RuleChainId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(RuleNodeId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(SchedulerEventId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(SecretId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(SubscriptionAddonId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(SubscriptionId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(SubscriptionPlanId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(TbResourceId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(TenantId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(TenantProfileId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(UserId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(WidgetTypeId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetManagedRelatedEntityIds200ResponseInner(WidgetsBundleId o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("AgentAppEventId", AgentAppEventId.class);
        schemas.put("AgentAppProfileId", AgentAppProfileId.class);
        schemas.put("AgentAppUnitId", AgentAppUnitId.class);
        schemas.put("AgentApplicationId", AgentApplicationId.class);
        schemas.put("AgentBulkActionId", AgentBulkActionId.class);
        schemas.put("AgentId", AgentId.class);
        schemas.put("AgentProfileId", AgentProfileId.class);
        ...
        JSON.registerDescendants(GetManagedRelatedEntityIds200ResponseInner.class, Collections.unmodifiableMap(schemas));
        ...
        mappings.put("getManagedRelatedEntityIds_200_response_inner", GetManagedRelatedEntityIds200ResponseInner.class);
        JSON.registerDiscriminator(GetManagedRelatedEntityIds200ResponseInner.class, "entityType", mappings);
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return GetManagedRelatedEntityIds200ResponseInner.schemas;
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(AgentAppEventId.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(AgentAppProfileId.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(AgentAppUnitId.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(AgentApplicationId.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(AgentBulkActionId.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(AgentId.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(AgentProfileId.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
     ...
     * AdminSettingsId, AgentAppEventId, AgentAppProfileId, AgentAppUnitId, AgentApplicationId, AgentBulkActionId, AgentId, AgentProfileId, AiModelId, AlarmId, ApiKeyId, ApiUsageStateId, AssetId, AssetProfileId, BillingCustomerId, BlobEntityId, CalculatedFieldId, ConverterId, CouponId, CustomerId, DashboardId, DeviceId, DeviceProfileId, DomainId, EdgeId, EntityGroupId, EntityViewId, GroupPermissionId, IntegrationId, JobId, MobileAppBundleId, MobileAppId, NotificationId, NotificationRequestId, NotificationRuleId, NotificationTargetId, NotificationTemplateId, OAuth2ClientId, OtaPackageId, ProductId, QueueId, QueueStatsId, ReportId, ReportTemplateId, RoleId, RpcId, RuleChainId, RuleNodeId, SchedulerEventId, SecretId, SubscriptionAddonId, SubscriptionId, SubscriptionPlanId, TbResourceId, TenantId, TenantProfileId, UserId, WidgetTypeId, WidgetsBundleId
     *
     * @return The actual instance (AdminSettingsId, AgentAppEventId, AgentAppProfileId, AgentAppUnitId, AgentApplicationId, AgentBulkActionId, AgentId, AgentProfileId, AiModelId, AlarmId, ApiKeyId, ApiUsageStateId, AssetId, AssetProfileId, BillingCustomerId, BlobEntityId, CalculatedFieldId, ConverterId, CouponId, CustomerId, DashboardId, DeviceId, DeviceProfileId, DomainId, EdgeId, EntityGroupId, EntityViewId, GroupPermissionId, IntegrationId, JobId, MobileAppBundleId, MobileAppId, NotificationId, NotificationRequestId, NotificationRuleId, NotificationTargetId, NotificationTemplateId, OAuth2ClientId, OtaPackageId, ProductId, QueueId, QueueStatsId, ReportId, ReportTemplateId, RoleId, RpcId, RuleChainId, RuleNodeId, SchedulerEventId, SecretId, SubscriptionAddonId, SubscriptionId, SubscriptionPlanId, TbResourceId, TenantId, TenantProfileId, UserId, WidgetTypeId, WidgetsBundleId)
     */
    @Override
    ...
    /**
     * Get the actual instance of `AgentAppEventId`. If the actual instance is not `AgentAppEventId`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AgentAppEventId`
     * @throws ClassCastException if the instance is not `AgentAppEventId`
     */
    public AgentAppEventId getAgentAppEventId() throws ClassCastException {
        return (AgentAppEventId)super.getActualInstance();
    }

    /**
     * Get the actual instance of `AgentAppProfileId`. If the actual instance is not `AgentAppProfileId`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AgentAppProfileId`
     * @throws ClassCastException if the instance is not `AgentAppProfileId`
     */
    public AgentAppProfileId getAgentAppProfileId() throws ClassCastException {
        return (AgentAppProfileId)super.getActualInstance();
    }

    /**
     * Get the actual instance of `AgentAppUnitId`. If the actual instance is not `AgentAppUnitId`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AgentAppUnitId`
     * @throws ClassCastException if the instance is not `AgentAppUnitId`
     */
    public AgentAppUnitId getAgentAppUnitId() throws ClassCastException {
        return (AgentAppUnitId)super.getActualInstance();
    }

    /**
     * Get the actual instance of `AgentApplicationId`. If the actual instance is not `AgentApplicationId`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AgentApplicationId`
     * @throws ClassCastException if the instance is not `AgentApplicationId`
     */
    public AgentApplicationId getAgentApplicationId() throws ClassCastException {
        return (AgentApplicationId)super.getActualInstance();
    }

    /**
     * Get the actual instance of `AgentBulkActionId`. If the actual instance is not `AgentBulkActionId`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AgentBulkActionId`
     * @throws ClassCastException if the instance is not `AgentBulkActionId`
     */
    public AgentBulkActionId getAgentBulkActionId() throws ClassCastException {
        return (AgentBulkActionId)super.getActualInstance();
    }

    /**
     * Get the actual instance of `AgentId`. If the actual instance is not `AgentId`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AgentId`
     * @throws ClassCastException if the instance is not `AgentId`
     */
    public AgentId getAgentId() throws ClassCastException {
        return (AgentId)super.getActualInstance();
    }

    /**
     * Get the actual instance of `AgentProfileId`. If the actual instance is not `AgentProfileId`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AgentProfileId`
     * @throws ClassCastException if the instance is not `AgentProfileId`
     */
    public AgentProfileId getAgentProfileId() throws ClassCastException {
        return (AgentProfileId)super.getActualInstance();
    }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getActualInstance() instanceof AgentAppEventId) {
        if (getActualInstance() != null) {
          joiner.add(((AgentAppEventId)getActualInstance()).toUrlQueryString(prefix + "one_of_1" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof AgentAppProfileId) {
        if (getActualInstance() != null) {
          joiner.add(((AgentAppProfileId)getActualInstance()).toUrlQueryString(prefix + "one_of_2" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof AgentAppUnitId) {
        if (getActualInstance() != null) {
          joiner.add(((AgentAppUnitId)getActualInstance()).toUrlQueryString(prefix + "one_of_3" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof AgentApplicationId) {
        if (getActualInstance() != null) {
          joiner.add(((AgentApplicationId)getActualInstance()).toUrlQueryString(prefix + "one_of_4" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof AgentBulkActionId) {
        if (getActualInstance() != null) {
          joiner.add(((AgentBulkActionId)getActualInstance()).toUrlQueryString(prefix + "one_of_5" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof AgentId) {
        if (getActualInstance() != null) {
          joiner.add(((AgentId)getActualInstance()).toUrlQueryString(prefix + "one_of_6" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof AgentProfileId) {
        if (getActualInstance() != null) {
          joiner.add(((AgentProfileId)getActualInstance()).toUrlQueryString(prefix + "one_of_7" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof AiModelId) {
        if (getActualInstance() != null) {
          joiner.add(((AiModelId)getActualInstance()).toUrlQueryString(prefix + "one_of_8" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof AlarmId) {
        if (getActualInstance() != null) {
          joiner.add(((AlarmId)getActualInstance()).toUrlQueryString(prefix + "one_of_9" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof ApiKeyId) {
        if (getActualInstance() != null) {
          joiner.add(((ApiKeyId)getActualInstance()).toUrlQueryString(prefix + "one_of_10" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof ApiUsageStateId) {
        if (getActualInstance() != null) {
          joiner.add(((ApiUsageStateId)getActualInstance()).toUrlQueryString(prefix + "one_of_11" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof AssetId) {
        if (getActualInstance() != null) {
          joiner.add(((AssetId)getActualInstance()).toUrlQueryString(prefix + "one_of_12" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof AssetProfileId) {
        if (getActualInstance() != null) {
          joiner.add(((AssetProfileId)getActualInstance()).toUrlQueryString(prefix + "one_of_13" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof BillingCustomerId) {
        if (getActualInstance() != null) {
          joiner.add(((BillingCustomerId)getActualInstance()).toUrlQueryString(prefix + "one_of_14" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof BlobEntityId) {
        if (getActualInstance() != null) {
          joiner.add(((BlobEntityId)getActualInstance()).toUrlQueryString(prefix + "one_of_15" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof CalculatedFieldId) {
        if (getActualInstance() != null) {
          joiner.add(((CalculatedFieldId)getActualInstance()).toUrlQueryString(prefix + "one_of_16" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof ConverterId) {
        if (getActualInstance() != null) {
          joiner.add(((ConverterId)getActualInstance()).toUrlQueryString(prefix + "one_of_17" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof CouponId) {
        if (getActualInstance() != null) {
          joiner.add(((CouponId)getActualInstance()).toUrlQueryString(prefix + "one_of_18" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof CustomerId) {
        if (getActualInstance() != null) {
          joiner.add(((CustomerId)getActualInstance()).toUrlQueryString(prefix + "one_of_19" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof DashboardId) {
        if (getActualInstance() != null) {
          joiner.add(((DashboardId)getActualInstance()).toUrlQueryString(prefix + "one_of_20" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof DeviceId) {
        if (getActualInstance() != null) {
          joiner.add(((DeviceId)getActualInstance()).toUrlQueryString(prefix + "one_of_21" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof DeviceProfileId) {
        if (getActualInstance() != null) {
          joiner.add(((DeviceProfileId)getActualInstance()).toUrlQueryString(prefix + "one_of_22" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof DomainId) {
        if (getActualInstance() != null) {
          joiner.add(((DomainId)getActualInstance()).toUrlQueryString(prefix + "one_of_23" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof EdgeId) {
        if (getActualInstance() != null) {
          joiner.add(((EdgeId)getActualInstance()).toUrlQueryString(prefix + "one_of_24" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof EntityGroupId) {
        if (getActualInstance() != null) {
          joiner.add(((EntityGroupId)getActualInstance()).toUrlQueryString(prefix + "one_of_25" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof EntityViewId) {
        if (getActualInstance() != null) {
          joiner.add(((EntityViewId)getActualInstance()).toUrlQueryString(prefix + "one_of_26" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof GroupPermissionId) {
        if (getActualInstance() != null) {
          joiner.add(((GroupPermissionId)getActualInstance()).toUrlQueryString(prefix + "one_of_27" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof IntegrationId) {
        if (getActualInstance() != null) {
          joiner.add(((IntegrationId)getActualInstance()).toUrlQueryString(prefix + "one_of_28" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof JobId) {
        if (getActualInstance() != null) {
          joiner.add(((JobId)getActualInstance()).toUrlQueryString(prefix + "one_of_29" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof MobileAppBundleId) {
        if (getActualInstance() != null) {
          joiner.add(((MobileAppBundleId)getActualInstance()).toUrlQueryString(prefix + "one_of_30" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof MobileAppId) {
        if (getActualInstance() != null) {
          joiner.add(((MobileAppId)getActualInstance()).toUrlQueryString(prefix + "one_of_31" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof NotificationId) {
        if (getActualInstance() != null) {
          joiner.add(((NotificationId)getActualInstance()).toUrlQueryString(prefix + "one_of_32" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof NotificationRequestId) {
        if (getActualInstance() != null) {
          joiner.add(((NotificationRequestId)getActualInstance()).toUrlQueryString(prefix + "one_of_33" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof NotificationRuleId) {
        if (getActualInstance() != null) {
          joiner.add(((NotificationRuleId)getActualInstance()).toUrlQueryString(prefix + "one_of_34" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof NotificationTargetId) {
        if (getActualInstance() != null) {
          joiner.add(((NotificationTargetId)getActualInstance()).toUrlQueryString(prefix + "one_of_35" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof NotificationTemplateId) {
        if (getActualInstance() != null) {
          joiner.add(((NotificationTemplateId)getActualInstance()).toUrlQueryString(prefix + "one_of_36" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof OAuth2ClientId) {
        if (getActualInstance() != null) {
          joiner.add(((OAuth2ClientId)getActualInstance()).toUrlQueryString(prefix + "one_of_37" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof OtaPackageId) {
        if (getActualInstance() != null) {
          joiner.add(((OtaPackageId)getActualInstance()).toUrlQueryString(prefix + "one_of_38" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof ProductId) {
        if (getActualInstance() != null) {
          joiner.add(((ProductId)getActualInstance()).toUrlQueryString(prefix + "one_of_39" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof QueueId) {
        if (getActualInstance() != null) {
          joiner.add(((QueueId)getActualInstance()).toUrlQueryString(prefix + "one_of_40" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof QueueStatsId) {
        if (getActualInstance() != null) {
          joiner.add(((QueueStatsId)getActualInstance()).toUrlQueryString(prefix + "one_of_41" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof ReportId) {
        if (getActualInstance() != null) {
          joiner.add(((ReportId)getActualInstance()).toUrlQueryString(prefix + "one_of_42" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof ReportTemplateId) {
        if (getActualInstance() != null) {
          joiner.add(((ReportTemplateId)getActualInstance()).toUrlQueryString(prefix + "one_of_43" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof RoleId) {
        if (getActualInstance() != null) {
          joiner.add(((RoleId)getActualInstance()).toUrlQueryString(prefix + "one_of_44" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof RpcId) {
        if (getActualInstance() != null) {
          joiner.add(((RpcId)getActualInstance()).toUrlQueryString(prefix + "one_of_45" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof RuleChainId) {
        if (getActualInstance() != null) {
          joiner.add(((RuleChainId)getActualInstance()).toUrlQueryString(prefix + "one_of_46" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof RuleNodeId) {
        if (getActualInstance() != null) {
          joiner.add(((RuleNodeId)getActualInstance()).toUrlQueryString(prefix + "one_of_47" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof SchedulerEventId) {
        if (getActualInstance() != null) {
          joiner.add(((SchedulerEventId)getActualInstance()).toUrlQueryString(prefix + "one_of_48" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof SecretId) {
        if (getActualInstance() != null) {
          joiner.add(((SecretId)getActualInstance()).toUrlQueryString(prefix + "one_of_49" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof SubscriptionAddonId) {
        if (getActualInstance() != null) {
          joiner.add(((SubscriptionAddonId)getActualInstance()).toUrlQueryString(prefix + "one_of_50" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof SubscriptionId) {
        if (getActualInstance() != null) {
          joiner.add(((SubscriptionId)getActualInstance()).toUrlQueryString(prefix + "one_of_51" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof SubscriptionPlanId) {
        if (getActualInstance() != null) {
          joiner.add(((SubscriptionPlanId)getActualInstance()).toUrlQueryString(prefix + "one_of_52" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof TbResourceId) {
        if (getActualInstance() != null) {
          joiner.add(((TbResourceId)getActualInstance()).toUrlQueryString(prefix + "one_of_53" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof TenantId) {
        if (getActualInstance() != null) {
          joiner.add(((TenantId)getActualInstance()).toUrlQueryString(prefix + "one_of_54" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof TenantProfileId) {
        if (getActualInstance() != null) {
          joiner.add(((TenantProfileId)getActualInstance()).toUrlQueryString(prefix + "one_of_55" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof UserId) {
        if (getActualInstance() != null) {
          joiner.add(((UserId)getActualInstance()).toUrlQueryString(prefix + "one_of_56" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof WidgetTypeId) {
        if (getActualInstance() != null) {
          joiner.add(((WidgetTypeId)getActualInstance()).toUrlQueryString(prefix + "one_of_57" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof WidgetsBundleId) {
        if (getActualInstance() != null) {
          joiner.add(((WidgetsBundleId)getActualInstance()).toUrlQueryString(prefix + "one_of_58" + suffix));
        }
        return joiner.toString();
    }
    return null;
