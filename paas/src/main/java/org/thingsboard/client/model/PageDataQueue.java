...
import org.thingsboard.client.model.Queue;
 ...
 */
@JsonPropertyOrder({
  PageDataQueue.JSON_PROPERTY_DATA,
  PageDataQueue.JSON_PROPERTY_TOTAL_PAGES,
  PageDataQueue.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataQueue.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:18:03.556877+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataQueue {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<Queue> data = new ArrayList<>();
  ...
  public PageDataQueue data(@javax.annotation.Nullable List<Queue> data) {
    this.data = data;
    return this;
  }

  public PageDataQueue addDataItem(Queue dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<Queue> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataQueue object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataQueue pageDataQueue = (PageDataQueue) o;
    return Objects.equals(this.data, pageDataQueue.data) &&
        Objects.equals(this.totalPages, pageDataQueue.totalPages) &&
        Objects.equals(this.totalElements, pageDataQueue.totalElements) &&
        Objects.equals(this.hasNext, pageDataQueue.hasNext);
  }
