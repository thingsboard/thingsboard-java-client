 ...
 */
@JsonPropertyOrder({
  PageDataTenant.JSON_PROPERTY_DATA,
  PageDataTenant.JSON_PROPERTY_TOTAL_PAGES,
  PageDataTenant.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataTenant.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:18:03.556877+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataTenant {
  ...
  public PageDataTenant data(@javax.annotation.Nullable List<Tenant> data) {
    this.data = data;
    return this;
  }

  public PageDataTenant addDataItem(Tenant dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<Tenant> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataTenant object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataTenant pageDataTenant = (PageDataTenant) o;
    return Objects.equals(this.data, pageDataTenant.data) &&
        Objects.equals(this.totalPages, pageDataTenant.totalPages) &&
        Objects.equals(this.totalElements, pageDataTenant.totalElements) &&
        Objects.equals(this.hasNext, pageDataTenant.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataTenant {\n");
