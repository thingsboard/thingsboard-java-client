...
public class DefaultMobilePage extends MobilePage {
  ...
  public DefaultMobilePage label(@Nullable String label) {
    this.label = label;
    return this;
  }
  ...
  public DefaultMobilePage icon(@Nullable String icon) {
    this.icon = icon;
    return this;
  }
  ...
  public DefaultMobilePage id(@Nullable DefaultPageId id) {
    this.id = id;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setId(@Nullable DefaultPageId id) {
    this.id = id;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(label, icon, id, super.hashCode());
  }
