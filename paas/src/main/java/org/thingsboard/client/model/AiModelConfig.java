 ...
 */
@JsonPropertyOrder({
  AiModelConfig.JSON_PROPERTY_PROVIDER
})
...
public class AiModelConfig {
  ...
  public AiModelConfig provider(@javax.annotation.Nonnull String provider) {
  ...
  /**
   * Return true if this AiModelConfig object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.provider, aiModelConfig.provider);
  }
...
static {
  ...
  mappings.put("AMAZON_BEDROCK", AmazonBedrockChatModelConfig.class);
  mappings.put("ANTHROPIC", AnthropicChatModelConfig.class);
  mappings.put("AZURE_OPENAI", AzureOpenAiChatModelConfig.class);
  mappings.put("GITHUB_MODELS", GitHubModelsChatModelConfig.class);
  mappings.put("GOOGLE_AI_GEMINI", GoogleAiGeminiChatModelConfig.class);
  mappings.put("GOOGLE_VERTEX_AI_GEMINI", GoogleVertexAiGeminiChatModelConfig.class);
  mappings.put("MISTRAL_AI", MistralAiChatModelConfig.class);
  mappings.put("OLLAMA", OllamaChatModelConfig.class);
  mappings.put("OPENAI", OpenAiChatModelConfig.class);
  mappings.put("AiModelConfig", AiModelConfig.class);
  JSON.registerDiscriminator(AiModelConfig.class, "provider", mappings);
}
}
