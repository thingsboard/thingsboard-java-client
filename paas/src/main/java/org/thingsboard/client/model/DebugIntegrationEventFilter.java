...
public class DebugIntegrationEventFilter extends EventFilter {
  ...
  public DebugIntegrationEventFilter server(@Nullable String server) {
    this.server = server;
    return this;
  }
  ...
  public DebugIntegrationEventFilter isError(@Nullable IsErrorEnum isError) {
  ...
  public DebugIntegrationEventFilter errorStr(@Nullable String errorStr) {
  ...
  public DebugIntegrationEventFilter type(@Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public DebugIntegrationEventFilter message(@Nullable String message) {
  ...
  public DebugIntegrationEventFilter statusIntegration(@Nullable String statusIntegration) {
  ...
  @JsonProperty(value = JSON_PROPERTY_STATUS_INTEGRATION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStatusIntegration(@Nullable String statusIntegration) {
    this.statusIntegration = statusIntegration;
  }
