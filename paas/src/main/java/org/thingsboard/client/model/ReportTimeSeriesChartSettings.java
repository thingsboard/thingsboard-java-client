...
public class ReportTimeSeriesChartSettings {
  ...
  public ReportTimeSeriesChartSettings showTitle(@Nullable Boolean showTitle) {
  ...
  public ReportTimeSeriesChartSettings title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ReportTimeSeriesChartSettings titleFont(@Nullable Font titleFont) {
  ...
  public ReportTimeSeriesChartSettings titleColor(@Nullable String titleColor) {
  ...
  public ReportTimeSeriesChartSettings titleAlignment(@Nullable TextAlignment titleAlignment) {
  ...
  public ReportTimeSeriesChartSettings thresholds(@Nullable List<TimeSeriesChartThreshold> thresholds) {
  ...
  public ReportTimeSeriesChartSettings stack(@Nullable Boolean stack) {
    this.stack = stack;
    return this;
  }
  ...
  public ReportTimeSeriesChartSettings grid(@Nullable TimeSeriesChartGridSettings grid) {
    this.grid = grid;
    return this;
  }
  ...
  public ReportTimeSeriesChartSettings yAxes(@Nullable Map<String, TimeSeriesChartYAxisSettings> yAxes) {
    this.yAxes = yAxes;
    return this;
  }
  ...
  public ReportTimeSeriesChartSettings xAxis(@Nullable TimeSeriesChartXAxisSettings xAxis) {
    this.xAxis = xAxis;
    return this;
  }
  ...
  public ReportTimeSeriesChartSettings barWidthSettings(@Nullable TimeSeriesChartBarWidthSettings barWidthSettings) {
  ...
  public ReportTimeSeriesChartSettings noAggregationBarWidthSettings(@Nullable TimeSeriesChartNoAggregationBarWidthSettings noAggregationBarWidthSettings) {
  ...
  public ReportTimeSeriesChartSettings states(@Nullable List<TimeSeriesChartStateSettings> states) {
    this.states = states;
    return this;
  }
  ...
  public ReportTimeSeriesChartSettings comparisonEnabled(@Nullable Boolean comparisonEnabled) {
  ...
  public ReportTimeSeriesChartSettings timeForComparison(@Nullable ComparisonDuration timeForComparison) {
  ...
  public ReportTimeSeriesChartSettings comparisonCustomIntervalValue(@Nullable Long comparisonCustomIntervalValue) {
  ...
  public ReportTimeSeriesChartSettings comparisonXAxis(@Nullable TimeSeriesChartXAxisSettings comparisonXAxis) {
  ...
  public ReportTimeSeriesChartSettings showLegend(@Nullable Boolean showLegend) {
  ...
  public ReportTimeSeriesChartSettings legendColumnTitleFont(@Nullable Font legendColumnTitleFont) {
  ...
  public ReportTimeSeriesChartSettings legendColumnTitleColor(@Nullable String legendColumnTitleColor) {
  ...
  public ReportTimeSeriesChartSettings legendLabelFont(@Nullable Font legendLabelFont) {
  ...
  public ReportTimeSeriesChartSettings legendLabelColor(@Nullable String legendLabelColor) {
  ...
  public ReportTimeSeriesChartSettings legendValueFont(@Nullable Font legendValueFont) {
  ...
  public ReportTimeSeriesChartSettings legendValueColor(@Nullable String legendValueColor) {
  ...
  public ReportTimeSeriesChartSettings legendConfig(@Nullable LegendConfig legendConfig) {
