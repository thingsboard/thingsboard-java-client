 ...
 */
@JsonPropertyOrder({
  AgentInstructions.JSON_PROPERTY_INSTRUCTIONS
})
...
public class AgentInstructions {
  ...
  public AgentInstructions instructions(@Nullable String instructions) {
    this.instructions = instructions;
    return this;
  }

  /**
   * Resolved install/provision instructions for the selected method
   * @return instructions
   */
  @Nullable
  ...
  /**
   * Return true if this AgentInstructions object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instructions, agentInstructions.instructions);
  }
