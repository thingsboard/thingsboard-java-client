 ...
 */
@JsonPropertyOrder({
  PageDataCustomer.JSON_PROPERTY_DATA,
  PageDataCustomer.JSON_PROPERTY_TOTAL_PAGES,
  PageDataCustomer.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataCustomer.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataCustomer {
  ...
  public PageDataCustomer data(@Nullable List<Customer> data) {
    this.data = data;
    return this;
  }

  public PageDataCustomer addDataItem(Customer dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<Customer> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataCustomer object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataCustomer pageDataCustomer = (PageDataCustomer) o;
    return Objects.equals(this.data, pageDataCustomer.data) &&
        Objects.equals(this.totalPages, pageDataCustomer.totalPages) &&
        Objects.equals(this.totalElements, pageDataCustomer.totalElements) &&
        Objects.equals(this.hasNext, pageDataCustomer.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataCustomer {\n");
