...
public class EntitiesLimitNotificationRuleTriggerConfig extends NotificationRuleTriggerConfig {
  ...
  public EntitiesLimitNotificationRuleTriggerConfig entityTypes(@Nullable Set<EntityType> entityTypes) {
  ...
  public EntitiesLimitNotificationRuleTriggerConfig threshold(@Nullable Float threshold) {
