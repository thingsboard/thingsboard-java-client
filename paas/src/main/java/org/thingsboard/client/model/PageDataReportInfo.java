...
import org.thingsboard.client.model.ReportInfo;
 ...
 */
@JsonPropertyOrder({
  PageDataReportInfo.JSON_PROPERTY_DATA,
  PageDataReportInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataReportInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataReportInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:18:03.556877+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataReportInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<ReportInfo> data = new ArrayList<>();
  ...
  public PageDataReportInfo data(@javax.annotation.Nullable List<ReportInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataReportInfo addDataItem(ReportInfo dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<ReportInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataReportInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataReportInfo pageDataReportInfo = (PageDataReportInfo) o;
    return Objects.equals(this.data, pageDataReportInfo.data) &&
        Objects.equals(this.totalPages, pageDataReportInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataReportInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataReportInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataReportInfo {\n");
