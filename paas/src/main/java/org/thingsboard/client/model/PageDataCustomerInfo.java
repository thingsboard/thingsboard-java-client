...
import org.thingsboard.client.model.CustomerInfo;
 ...
 */
@JsonPropertyOrder({
  PageDataCustomerInfo.JSON_PROPERTY_DATA,
  PageDataCustomerInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataCustomerInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataCustomerInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:18:03.556877+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataCustomerInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<CustomerInfo> data = new ArrayList<>();
  ...
  public PageDataCustomerInfo data(@javax.annotation.Nullable List<CustomerInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataCustomerInfo addDataItem(CustomerInfo dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<CustomerInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataCustomerInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataCustomerInfo pageDataCustomerInfo = (PageDataCustomerInfo) o;
    return Objects.equals(this.data, pageDataCustomerInfo.data) &&
        Objects.equals(this.totalPages, pageDataCustomerInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataCustomerInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataCustomerInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataCustomerInfo {\n");
