...
public class EdgeSearchQueryFilter extends EntityFilter {
  ...
  public EdgeSearchQueryFilter rootEntity(@Nullable AliasEntityId rootEntity) {
  ...
  public EdgeSearchQueryFilter relationType(@Nullable String relationType) {
  ...
  public EdgeSearchQueryFilter direction(@Nullable EntitySearchDirection direction) {
  ...
  public EdgeSearchQueryFilter maxLevel(@Nullable Integer maxLevel) {
  ...
  public EdgeSearchQueryFilter fetchLastLevelOnly(@Nullable Boolean fetchLastLevelOnly) {
  ...
  public EdgeSearchQueryFilter rootStateEntity(@Nullable Boolean rootStateEntity) {
  ...
  public EdgeSearchQueryFilter defaultStateEntity(@Nullable AliasEntityId defaultStateEntity) {
  ...
  public EdgeSearchQueryFilter edgeTypes(@Nullable List<String> edgeTypes) {
  ...
  @Override
  public EdgeSearchQueryFilter type(@Nonnull String type) {
    this.setType(type);
    return this;
  }
