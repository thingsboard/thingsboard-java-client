...
/**
 * Gets or Sets AgentProvisionType
 */
public enum AgentProvisionType {
  ...
  AgentProvisionType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static AgentProvisionType fromValue(String value) {
    for (AgentProvisionType b : AgentProvisionType.values()) {
