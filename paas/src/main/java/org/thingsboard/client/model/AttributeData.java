 ...
 */
@JsonPropertyOrder({
  AttributeData.JSON_PROPERTY_LAST_UPDATE_TS,
...
public class AttributeData {
  ...
  @JsonCreator
  public AttributeData(
    @JsonProperty(JSON_PROPERTY_LAST_UPDATE_TS) Long lastUpdateTs, 
  ...
  /**
   * Return true if this AttributeData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.lastUpdateTs, attributeData.lastUpdateTs) &&
        Objects.equals(this.key, attributeData.key) &&
        equalsNullable(this.value, attributeData.value);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lastUpdateTs, key, hashCodeNullable(value));
  }
