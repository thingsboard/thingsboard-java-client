...
public class Failure extends TbChatResponse {
  ...
  public Failure errorDetails(@javax.annotation.Nullable String errorDetails) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_ERROR_DETAILS, required = false)
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getErrorDetails() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%serrorDetails%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getErrorDetails()))));
    }
...
static {
  ...
  JSON.registerDiscriminator(Failure.class, "status", mappings);
}
}
