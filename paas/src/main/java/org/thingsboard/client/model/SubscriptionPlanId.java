...
public class SubscriptionPlanId extends EntityId {
  public SubscriptionPlanId() { 
  }

  @Override
  public SubscriptionPlanId entityType(@javax.annotation.Nonnull EntityType entityType) {
...
static {
  ...
  mappings.put("SubscriptionPlanId", SubscriptionPlanId.class);
  JSON.registerDiscriminator(SubscriptionPlanId.class, "entityType", mappings);
}
}
