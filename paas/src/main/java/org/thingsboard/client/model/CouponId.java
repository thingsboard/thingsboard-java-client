...
public class CouponId extends EntityId {
  ...
  @Override
  public CouponId entityType(@javax.annotation.Nonnull EntityType entityType) {
...
static {
  ...
  mappings.put("CouponId", CouponId.class);
  JSON.registerDiscriminator(CouponId.class, "entityType", mappings);
}
}
