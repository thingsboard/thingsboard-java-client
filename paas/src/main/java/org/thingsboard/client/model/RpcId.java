 ...
 */
@JsonPropertyOrder({
  RpcId.JSON_PROPERTY_ID,
  RpcId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class RpcId {
  ...
  public RpcId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public RpcId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this RpcId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RpcId rpcId = (RpcId) o;
    return Objects.equals(this.id, rpcId.id) &&
        Objects.equals(this.entityType, rpcId.entityType);
  }
