 ...
 */
@JsonPropertyOrder({
  EdgeId.JSON_PROPERTY_ID,
  EdgeId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class EdgeId {
  ...
  public EdgeId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public EdgeId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this EdgeId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, edgeId.id) &&
        Objects.equals(this.entityType, edgeId.entityType);
  }
