...
import org.thingsboard.client.model.AgentAppEventInfo;
 ...
 */
@JsonPropertyOrder({
  PageDataAgentAppEventInfo.JSON_PROPERTY_DATA,
  PageDataAgentAppEventInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAgentAppEventInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAgentAppEventInfo.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAgentAppEventInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @Nullable
  private List<AgentAppEventInfo> data = new ArrayList<>();
  ...
  public PageDataAgentAppEventInfo data(@Nullable List<AgentAppEventInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataAgentAppEventInfo addDataItem(AgentAppEventInfo dataItem) {
    if (this.data == null) {
  ...
  public List<AgentAppEventInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<AgentAppEventInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAgentAppEventInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAgentAppEventInfo pageDataAgentAppEventInfo = (PageDataAgentAppEventInfo) o;
    return Objects.equals(this.data, pageDataAgentAppEventInfo.data) &&
        Objects.equals(this.totalPages, pageDataAgentAppEventInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataAgentAppEventInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataAgentAppEventInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAgentAppEventInfo {\n");
