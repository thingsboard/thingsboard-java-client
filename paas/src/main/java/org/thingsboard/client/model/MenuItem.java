 ...
 */
@JsonPropertyOrder({
  MenuItem.JSON_PROPERTY_TYPE,
  MenuItem.JSON_PROPERTY_VISIBLE
})
...
public class MenuItem {
  ...
  public MenuItem type(@javax.annotation.Nonnull MenuItemType type) {
    this.type = type;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_TYPE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setType(@javax.annotation.Nonnull MenuItemType type) {
    this.type = type;
  }


  public MenuItem visible(@javax.annotation.Nullable Boolean visible) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, menuItem.type) &&
        Objects.equals(this.visible, menuItem.visible);
  }
...
static {
  ...
  mappings.put("CUSTOM", CustomMenuItem.class);
  mappings.put("DEFAULT", DefaultMenuItem.class);
  mappings.put("HOME", HomeMenuItem.class);
  mappings.put("MenuItem", MenuItem.class);
  JSON.registerDiscriminator(MenuItem.class, "type", mappings);
}
}
