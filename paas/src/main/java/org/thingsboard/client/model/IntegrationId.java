...
public class IntegrationId extends EntityId {
...
static {
  ...
  mappings.put("IntegrationId", IntegrationId.class);
  JSON.registerDiscriminator(IntegrationId.class, "entityType", mappings);
}
}
