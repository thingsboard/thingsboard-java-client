 ...
 */
@JsonPropertyOrder({
  IntegrationId.JSON_PROPERTY_ID,
  IntegrationId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class IntegrationId {
  ...
  public IntegrationId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public IntegrationId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this IntegrationId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, integrationId.id) &&
        Objects.equals(this.entityType, integrationId.entityType);
  }
