...
/**
 * Gets or Sets TrendzSynchronizationResultType
 */
public enum TrendzSynchronizationResultType {
  ...
  TrendzSynchronizationResultType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static TrendzSynchronizationResultType fromValue(String value) {
    for (TrendzSynchronizationResultType b : TrendzSynchronizationResultType.values()) {
