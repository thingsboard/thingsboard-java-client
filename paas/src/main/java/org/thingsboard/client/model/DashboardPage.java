...
public class DashboardPage extends MobilePage {
  ...
  public DashboardPage label(@Nullable String label) {
    this.label = label;
    return this;
  }
  ...
  public DashboardPage icon(@Nullable String icon) {
    this.icon = icon;
    return this;
  }
  ...
  public DashboardPage dashboardId(@Nullable String dashboardId) {
  ...
  @Override
  public DashboardPage type(@Nonnull MobilePageType type) {
    this.setType(type);
    return this;
  }

  @Override
  public DashboardPage visible(@Nullable Boolean visible) {
...
static {
  ...
  mappings.put("DashboardPage", DashboardPage.class);
  JSON.registerDiscriminator(DashboardPage.class, "type", mappings);
}
}
