...
public class TenantInfo {
  ...
  public TenantInfo active(@Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public TenantInfo lastInactiveTs(@Nullable Long lastInactiveTs) {
  ...
  public TenantInfo currentPeriodStartTs(@Nullable Long currentPeriodStartTs) {
  ...
  public TenantInfo addonData(@Nullable TenantAddonData addonData) {
  ...
  public TenantInfo edgeLicenseVersion(@Nullable Integer edgeLicenseVersion) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdTime, additionalInfo, country, state, city, address, address2, zip, phone, email, title, region, tenantProfileId, version, active, lastInactiveTs, currentPeriodStartTs, addonData, edgeLicenseVersion, tenantProfileName, name);
  }
