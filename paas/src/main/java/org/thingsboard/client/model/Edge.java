...
public class Edge {
  ...
  public Edge edgeLicenseType(@javax.annotation.Nullable EdgeLicenseType edgeLicenseType) {
  ...
  @JsonProperty(value = JSON_PROPERTY_EDGE_LICENSE_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEdgeLicenseType(@javax.annotation.Nullable EdgeLicenseType edgeLicenseType) {
    this.edgeLicenseType = edgeLicenseType;
  }
  ...
  public Edge ownerId(@javax.annotation.Nullable EntityId ownerId) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdTime, tenantId, customerId, rootRuleChainId, name, type, label, routingKey, secret, edgeLicenseKey, cloudEndpoint, edgeLicenseType, version, ownerId, additionalInfo);
  }
