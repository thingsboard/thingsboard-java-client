...
import org.thingsboard.client.model.EdgeLicenseType;
...
@JsonPropertyOrder({
  ...
  Edge.JSON_PROPERTY_EDGE_LICENSE_TYPE,
...
public class Edge {
  ...
  public static final String JSON_PROPERTY_EDGE_LICENSE_TYPE = "edgeLicenseType";
  @Nullable
  private EdgeLicenseType edgeLicenseType;
  ...
  public Edge name(@Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public Edge type(@Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public Edge label(@Nullable String label) {
    this.label = label;
    return this;
  }
  ...
  public Edge routingKey(@Nonnull String routingKey) {
  ...
  public Edge secret(@Nonnull String secret) {
    this.secret = secret;
    return this;
  }
  ...
  public Edge edgeLicenseType(@Nullable EdgeLicenseType edgeLicenseType) {
    this.edgeLicenseType = edgeLicenseType;
    return this;
  }

  /**
   * Get edgeLicenseType
   * @return edgeLicenseType
   */
  @Nullable
  @JsonProperty(value = JSON_PROPERTY_EDGE_LICENSE_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public EdgeLicenseType getEdgeLicenseType() {
    return edgeLicenseType;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_EDGE_LICENSE_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEdgeLicenseType(@Nullable EdgeLicenseType edgeLicenseType) {
    this.edgeLicenseType = edgeLicenseType;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, edge.id) &&
        ...
        Objects.equals(this.edgeLicenseType, edge.edgeLicenseType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdTime, additionalInfo, tenantId, customerId, rootRuleChainId, name, type, label, routingKey, secret, edgeLicenseKey, cloudEndpoint, edgeLicenseType, version, ownerId);
  }
  ...
  public String toString() {
    ...
    sb.append("    edgeLicenseType: ").append(toIndentedString(edgeLicenseType)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `edgeLicenseType` to the URL query string
    if (getEdgeLicenseType() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sedgeLicenseType%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEdgeLicenseType()))));
    }
