...
import org.thingsboard.client.model.DeviceInfo;
...
public class PageDataDeviceInfo {
  ...
  public PageDataDeviceInfo data(@Nullable List<DeviceInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataDeviceInfo addDataItem(DeviceInfo dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<DeviceInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataDeviceInfo object is equal to o.
   */
  @Override
