...
public class MobileAppNotificationDeliveryMethodConfig extends NotificationDeliveryMethodConfig {
  ...
  public MobileAppNotificationDeliveryMethodConfig firebaseServiceAccountCredentials(@javax.annotation.Nullable String firebaseServiceAccountCredentials) {
  ...
  @JsonProperty(value = JSON_PROPERTY_FIREBASE_SERVICE_ACCOUNT_CREDENTIALS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFirebaseServiceAccountCredentials(@javax.annotation.Nullable String firebaseServiceAccountCredentials) {
    this.firebaseServiceAccountCredentials = firebaseServiceAccountCredentials;
  }


  public MobileAppNotificationDeliveryMethodConfig useSystemSettings(@javax.annotation.Nullable Boolean useSystemSettings) {
