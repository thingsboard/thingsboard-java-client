 ...
 */
@JsonPropertyOrder({
  ReportId.JSON_PROPERTY_ID,
  ReportId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class ReportId {
  ...
  public ReportId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ReportId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this ReportId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, reportId.id) &&
        Objects.equals(this.entityType, reportId.entityType);
  }
