...
public class ProductId extends EntityId {
  ...
  @Override
  public ProductId id(@javax.annotation.Nonnull UUID id) {
    this.setId(id);
    return this;
  }

  @Override
  public ProductId entityType(@javax.annotation.Nonnull EntityType entityType) {
    this.setEntityType(entityType);
    return this;
  }

  /**
   * Return true if this ProductId object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("ProductId", ProductId.class);
  JSON.registerDiscriminator(ProductId.class, "entityType", mappings);
}
}
