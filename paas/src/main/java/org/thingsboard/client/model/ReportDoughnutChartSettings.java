...
public class ReportDoughnutChartSettings extends ReportLatestChartSettings {
  ...
  public ReportDoughnutChartSettings layout(@javax.annotation.Nullable DoughnutLayout layout) {
    this.layout = layout;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_LAYOUT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLayout(@javax.annotation.Nullable DoughnutLayout layout) {
    this.layout = layout;
  }


  public ReportDoughnutChartSettings clockwise(@javax.annotation.Nullable Boolean clockwise) {
  ...
  public ReportDoughnutChartSettings totalValueFont(@javax.annotation.Nullable Font totalValueFont) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TOTAL_VALUE_FONT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTotalValueFont(@javax.annotation.Nullable Font totalValueFont) {
    this.totalValueFont = totalValueFont;
  }


  public ReportDoughnutChartSettings totalValueColor(@javax.annotation.Nullable String totalValueColor) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TOTAL_VALUE_COLOR, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTotalValueColor(@javax.annotation.Nullable String totalValueColor) {
    this.totalValueColor = totalValueColor;
  }


  @Override
  public ReportDoughnutChartSettings showTitle(@javax.annotation.Nullable Boolean showTitle) {
    this.setShowTitle(showTitle);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings titleFont(@javax.annotation.Nullable Font titleFont) {
    this.setTitleFont(titleFont);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings titleColor(@javax.annotation.Nullable String titleColor) {
    this.setTitleColor(titleColor);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings titleAlignment(@javax.annotation.Nullable TextAlignment titleAlignment) {
    this.setTitleAlignment(titleAlignment);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings units(@javax.annotation.Nullable String units) {
    this.setUnits(units);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings decimals(@javax.annotation.Nullable Integer decimals) {
    this.setDecimals(decimals);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings autoScale(@javax.annotation.Nullable Boolean autoScale) {
    this.setAutoScale(autoScale);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings sortSeries(@javax.annotation.Nullable Boolean sortSeries) {
    this.setSortSeries(sortSeries);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings showTotal(@javax.annotation.Nullable Boolean showTotal) {
    this.setShowTotal(showTotal);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings showLegend(@javax.annotation.Nullable Boolean showLegend) {
    this.setShowLegend(showLegend);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings legendPosition(@javax.annotation.Nullable LegendPosition legendPosition) {
    this.setLegendPosition(legendPosition);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings legendLabelFont(@javax.annotation.Nullable Font legendLabelFont) {
    this.setLegendLabelFont(legendLabelFont);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings legendLabelColor(@javax.annotation.Nullable String legendLabelColor) {
    this.setLegendLabelColor(legendLabelColor);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings legendValueFont(@javax.annotation.Nullable Font legendValueFont) {
    this.setLegendValueFont(legendValueFont);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings legendValueColor(@javax.annotation.Nullable String legendValueColor) {
    this.setLegendValueColor(legendValueColor);
    return this;
  }

  @Override
  public ReportDoughnutChartSettings legendShowTotal(@javax.annotation.Nullable Boolean legendShowTotal) {
