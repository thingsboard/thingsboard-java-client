...
`org.thingsboard.client.model.PageDataAgentAppEventInfo`

## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **data** | **List\<AgentAppEventInfo\>** | Array of the entities | [optional] |
...
| agentName | String | Name of the Agent that owns the Application. | [optional] [readonly] |
