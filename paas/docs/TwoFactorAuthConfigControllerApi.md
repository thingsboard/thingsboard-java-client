...
```
AccountTwoFaSettings deleteTwoFaAccountConfig(DeleteTwoFaAccountConfigArgs args) // Delete 2FA account config (deleteTwoFaAccountConfig)
TwoFaAccountConfig generateTwoFaAccountConfig(GenerateTwoFaAccountConfigArgs args) // Generate 2FA account config (generateTwoFaAccountConfig)
...
PlatformTwoFaSettings savePlatformTwoFaSettings(SavePlatformTwoFaSettingsArgs args) // Save platform 2FA settings (savePlatformTwoFaSettings)
void submitTwoFaAccountConfig(SubmitTwoFaAccountConfigArgs args) // Submit 2FA account config (submitTwoFaAccountConfig)
AccountTwoFaSettings updateTwoFaAccountConfig(UpdateTwoFaAccountConfigArgs args) // Update 2FA account config (updateTwoFaAccountConfig)
AccountTwoFaSettings verifyAndSaveTwoFaAccountConfig(VerifyAndSaveTwoFaAccountConfigArgs args) // Verify and save 2FA account config (verifyAndSaveTwoFaAccountConfig)
```
...
```java
AccountTwoFaSettings deleteTwoFaAccountConfig(DeleteTwoFaAccountConfigArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
DeleteTwoFaAccountConfigArgs.builder()
        .providerType(TwoFaProviderType)
        .build()
```

### `DeleteTwoFaAccountConfigArgs` builder fields
...
```java
TwoFaAccountConfig generateTwoFaAccountConfig(GenerateTwoFaAccountConfigArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
GenerateTwoFaAccountConfigArgs.builder()
        .providerType(String)
        .build()
```

### `GenerateTwoFaAccountConfigArgs` builder fields

| Field | Type | Required | Description | Notes |
|-------|------|----------|-------------|-------|
| `providerType` | `String` | **yes** | 2FA provider type to generate new account config for | |
...
```java
PlatformTwoFaSettings savePlatformTwoFaSettings(SavePlatformTwoFaSettingsArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
SavePlatformTwoFaSettingsArgs.builder()
        .platformTwoFaSettings(PlatformTwoFaSettings)
        .build()
```

### `SavePlatformTwoFaSettingsArgs` builder fields

| Field | Type | Required | Description | Notes |
|-------|------|----------|-------------|-------|
| `platformTwoFaSettings` | `PlatformTwoFaSettings` | **yes** |  | |
...
```java
void submitTwoFaAccountConfig(SubmitTwoFaAccountConfigArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
SubmitTwoFaAccountConfigArgs.builder()
        .twoFaAccountConfig(TwoFaAccountConfig)
        .build()
```

### `SubmitTwoFaAccountConfigArgs` builder fields

| Field | Type | Required | Description | Notes |
|-------|------|----------|-------------|-------|
| `twoFaAccountConfig` | `TwoFaAccountConfig` | **yes** |  | |
...
```java
AccountTwoFaSettings updateTwoFaAccountConfig(UpdateTwoFaAccountConfigArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
UpdateTwoFaAccountConfigArgs.builder()
        .providerType(TwoFaProviderType)
        .twoFaAccountConfigUpdateRequest(TwoFaAccountConfigUpdateRequest)
        .build()
```

### `UpdateTwoFaAccountConfigArgs` builder fields

| Field | Type | Required | Description | Notes |
|-------|------|----------|-------------|-------|
| `providerType` | `TwoFaProviderType` | **yes** |  | enum: `TOTP`, `SMS`, `EMAIL`, `BACKUP_CODE` |
| `twoFaAccountConfigUpdateRequest` | `TwoFaAccountConfigUpdateRequest` | **yes** |  | |
...
```java
AccountTwoFaSettings verifyAndSaveTwoFaAccountConfig(VerifyAndSaveTwoFaAccountConfigArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
VerifyAndSaveTwoFaAccountConfigArgs.builder()
        .twoFaAccountConfig(TwoFaAccountConfig)
        .build()
```

### `VerifyAndSaveTwoFaAccountConfigArgs` builder fields
