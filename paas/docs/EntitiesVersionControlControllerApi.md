...
```
EntityDataDiff compareEntityDataToVersion(CompareEntityDataToVersionArgs args) // Compare entity data to version (compareEntityDataToVersion)
EntityDataInfo getEntityDataInfo(GetEntityDataInfoArgs args) // Get entity data info (getEntityDataInfo)
VersionCreationResult getVersionCreateRequestStatus(GetVersionCreateRequestStatusArgs args) // Get version create request status (getVersionCreateRequestStatus)
VersionLoadResult getVersionLoadRequestStatus(GetVersionLoadRequestStatusArgs args) // Get version load request status (getVersionLoadRequestStatus)
List<VersionedEntityInfo> listAllEntitiesAtVersion(ListAllEntitiesAtVersionArgs args) // List all entities at version (listAllEntitiesAtVersion)
List<BranchInfo> listBranches() // List branches (listBranches)
List<VersionedEntityInfo> listEntitiesAtVersion(ListEntitiesAtVersionArgs args) // List entities at version (listEntitiesAtVersion)
PageDataEntityVersion listEntityTypeVersions(ListEntityTypeVersionsArgs args) // List entity type versions (listEntityTypeVersions)
PageDataEntityVersion listEntityVersions(ListEntityVersionsArgs args) // List entity versions (listEntityVersions)
PageDataEntityVersion listVersions(ListVersionsArgs args) // List all versions (listVersions)
UUID loadEntitiesVersion(LoadEntitiesVersionArgs args) // Load entities version (loadEntitiesVersion)
UUID saveEntitiesVersion(SaveEntitiesVersionArgs args) // Save entities version (saveEntitiesVersion)
```
...
```java
EntityDataDiff compareEntityDataToVersion(CompareEntityDataToVersionArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
CompareEntityDataToVersionArgs.builder()
        .entityType(EntityType)
        .internalEntityUuid(UUID)
        .versionId(String)
        .build()
```

### `CompareEntityDataToVersionArgs` builder fields

| Field | Type | Required | Description | Notes |
|-------|------|----------|-------------|-------|
| `entityType` | `EntityType` | **yes** | A string value representing the entity type. For example, 'DEVICE' | enum: `TENANT`, `CUSTOMER`, `USER`, `DASHBOARD`, `ASSET`, `DEVICE`, `ALARM`, `ENTITY_GROUP`, `CONVERTER`, `INTEGRATION`, `RULE_CHAIN`, `RULE_NODE`, `SCHEDULER_EVENT`, `BLOB_ENTITY`, `REPORT_TEMPLATE`, `REPORT`, `ENTITY_VIEW`, `WIDGETS_BUNDLE`, `WIDGET_TYPE`, `ROLE`, `GROUP_PERMISSION`, `TENANT_PROFILE`, `DEVICE_PROFILE`, `ASSET_PROFILE`, `API_USAGE_STATE`, `TB_RESOURCE`, `OTA_PACKAGE`, `EDGE`, `RPC`, `QUEUE`, `NOTIFICATION_TARGET`, `NOTIFICATION_TEMPLATE`, `NOTIFICATION_REQUEST`, `NOTIFICATION`, `NOTIFICATION_RULE`, `QUEUE_STATS`, `OAUTH2_CLIENT`, `DOMAIN`, `MOBILE_APP`, `MOBILE_APP_BUNDLE`, `CALCULATED_FIELD`, `JOB`, `SECRET`, `ADMIN_SETTINGS`, `AI_MODEL`, `API_KEY`, `BILLING_CUSTOMER`, `SUBSCRIPTION_PLAN`, `SUBSCRIPTION`, `COUPON`, `PRODUCT`, `SUBSCRIPTION_ADDON` |
| `internalEntityUuid` | `UUID` | **yes** | A string value representing the entity id. For example, '784f394c-42b6-435a-983c-b7beff2784f9' | |
| `versionId` | `String` | **yes** | Version id, for example fd82625bdd7d6131cf8027b44ee967012ecaf990. Represents commit hash. | |
...
```java
EntityDataInfo getEntityDataInfo(GetEntityDataInfoArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
GetEntityDataInfoArgs.builder()
        .versionId(String)
        .entityType(EntityType)
        .externalEntityUuid(UUID)
        .build()
```

### `GetEntityDataInfoArgs` builder fields

| Field | Type | Required | Description | Notes |
|-------|------|----------|-------------|-------|
| `versionId` | `String` | **yes** | Version id, for example fd82625bdd7d6131cf8027b44ee967012ecaf990. Represents commit hash. | |
| `entityType` | `EntityType` | **yes** | A string value representing the entity type. For example, 'DEVICE' | enum: `TENANT`, `CUSTOMER`, `USER`, `DASHBOARD`, `ASSET`, `DEVICE`, `ALARM`, `ENTITY_GROUP`, `CONVERTER`, `INTEGRATION`, `RULE_CHAIN`, `RULE_NODE`, `SCHEDULER_EVENT`, `BLOB_ENTITY`, `REPORT_TEMPLATE`, `REPORT`, `ENTITY_VIEW`, `WIDGETS_BUNDLE`, `WIDGET_TYPE`, `ROLE`, `GROUP_PERMISSION`, `TENANT_PROFILE`, `DEVICE_PROFILE`, `ASSET_PROFILE`, `API_USAGE_STATE`, `TB_RESOURCE`, `OTA_PACKAGE`, `EDGE`, `RPC`, `QUEUE`, `NOTIFICATION_TARGET`, `NOTIFICATION_TEMPLATE`, `NOTIFICATION_REQUEST`, `NOTIFICATION`, `NOTIFICATION_RULE`, `QUEUE_STATS`, `OAUTH2_CLIENT`, `DOMAIN`, `MOBILE_APP`, `MOBILE_APP_BUNDLE`, `CALCULATED_FIELD`, `JOB`, `SECRET`, `ADMIN_SETTINGS`, `AI_MODEL`, `API_KEY`, `BILLING_CUSTOMER`, `SUBSCRIPTION_PLAN`, `SUBSCRIPTION`, `COUPON`, `PRODUCT`, `SUBSCRIPTION_ADDON` |
| `externalEntityUuid` | `UUID` | **yes** | A string value representing external entity id | |
| `internalEntityId` | `UUID` | no | A string value representing the entity id. For example, '784f394c-42b6-435a-983c-b7beff2784f9' | |
...
```java
VersionCreationResult getVersionCreateRequestStatus(GetVersionCreateRequestStatusArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
GetVersionCreateRequestStatusArgs.builder()
        .requestId(UUID)
        .build()
```

### `GetVersionCreateRequestStatusArgs` builder fields

| Field | Type | Required | Description | Notes |
|-------|------|----------|-------------|-------|
| `requestId` | `UUID` | **yes** | A string value representing the version control request id. For example, '784f394c-42b6-435a-983c-b7beff2784f9' | |
...
```java
VersionLoadResult getVersionLoadRequestStatus(GetVersionLoadRequestStatusArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
GetVersionLoadRequestStatusArgs.builder()
        .requestId(UUID)
        .build()
```

### `GetVersionLoadRequestStatusArgs` builder fields
...
```java
List<VersionedEntityInfo> listAllEntitiesAtVersion(ListAllEntitiesAtVersionArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
ListAllEntitiesAtVersionArgs.builder()
        .versionId(String)
        .build()
```

### `ListAllEntitiesAtVersionArgs` builder fields
...
```java
List<VersionedEntityInfo> listEntitiesAtVersion(ListEntitiesAtVersionArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
ListEntitiesAtVersionArgs.builder()
        .entityType(EntityType)
        .versionId(String)
        .build()
```

### `ListEntitiesAtVersionArgs` builder fields
...
```java
PageDataEntityVersion listEntityTypeVersions(ListEntityTypeVersionsArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
ListEntityTypeVersionsArgs.builder()
        .entityType(EntityType)
        .branch(String)
        .pageSize(Integer)
        .page(Integer)
...
### `ListEntityTypeVersionsArgs` builder fields

| Field | Type | Required | Description | Notes |
|-------|------|----------|-------------|-------|
| `entityType` | `EntityType` | **yes** | A string value representing the entity type. For example, 'DEVICE' | enum: `TENANT`, `CUSTOMER`, `USER`, `DASHBOARD`, `ASSET`, `DEVICE`, `ALARM`, `ENTITY_GROUP`, `CONVERTER`, `INTEGRATION`, `RULE_CHAIN`, `RULE_NODE`, `SCHEDULER_EVENT`, `BLOB_ENTITY`, `REPORT_TEMPLATE`, `REPORT`, `ENTITY_VIEW`, `WIDGETS_BUNDLE`, `WIDGET_TYPE`, `ROLE`, `GROUP_PERMISSION`, `TENANT_PROFILE`, `DEVICE_PROFILE`, `ASSET_PROFILE`, `API_USAGE_STATE`, `TB_RESOURCE`, `OTA_PACKAGE`, `EDGE`, `RPC`, `QUEUE`, `NOTIFICATION_TARGET`, `NOTIFICATION_TEMPLATE`, `NOTIFICATION_REQUEST`, `NOTIFICATION`, `NOTIFICATION_RULE`, `QUEUE_STATS`, `OAUTH2_CLIENT`, `DOMAIN`, `MOBILE_APP`, `MOBILE_APP_BUNDLE`, `CALCULATED_FIELD`, `JOB`, `SECRET`, `ADMIN_SETTINGS`, `AI_MODEL`, `API_KEY`, `BILLING_CUSTOMER`, `SUBSCRIPTION_PLAN`, `SUBSCRIPTION`, `COUPON`, `PRODUCT`, `SUBSCRIPTION_ADDON` |
| `branch` | `String` | **yes** | The name of the working branch, for example 'master' | |
| `pageSize` | `Integer` | **yes** | Maximum amount of entities in a one page | |
| `page` | `Integer` | **yes** | Sequence number of page starting from 0 | |
| `textSearch` | `String` | no | The case insensitive 'substring' filter based on the entity version name. | |
| `sortProperty` | `String` | no | Property of entity to sort by | enum: `timestamp` |
...
```java
PageDataEntityVersion listEntityVersions(ListEntityVersionsArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
ListEntityVersionsArgs.builder()
        .entityType(EntityType)
        .externalEntityUuid(UUID)
        .branch(String)
        .pageSize(Integer)
...
### `ListEntityVersionsArgs` builder fields

| Field | Type | Required | Description | Notes |
|-------|------|----------|-------------|-------|
| `entityType` | `EntityType` | **yes** | A string value representing the entity type. For example, 'DEVICE' | enum: `TENANT`, `CUSTOMER`, `USER`, `DASHBOARD`, `ASSET`, `DEVICE`, `ALARM`, `ENTITY_GROUP`, `CONVERTER`, `INTEGRATION`, `RULE_CHAIN`, `RULE_NODE`, `SCHEDULER_EVENT`, `BLOB_ENTITY`, `REPORT_TEMPLATE`, `REPORT`, `ENTITY_VIEW`, `WIDGETS_BUNDLE`, `WIDGET_TYPE`, `ROLE`, `GROUP_PERMISSION`, `TENANT_PROFILE`, `DEVICE_PROFILE`, `ASSET_PROFILE`, `API_USAGE_STATE`, `TB_RESOURCE`, `OTA_PACKAGE`, `EDGE`, `RPC`, `QUEUE`, `NOTIFICATION_TARGET`, `NOTIFICATION_TEMPLATE`, `NOTIFICATION_REQUEST`, `NOTIFICATION`, `NOTIFICATION_RULE`, `QUEUE_STATS`, `OAUTH2_CLIENT`, `DOMAIN`, `MOBILE_APP`, `MOBILE_APP_BUNDLE`, `CALCULATED_FIELD`, `JOB`, `SECRET`, `ADMIN_SETTINGS`, `AI_MODEL`, `API_KEY`, `BILLING_CUSTOMER`, `SUBSCRIPTION_PLAN`, `SUBSCRIPTION`, `COUPON`, `PRODUCT`, `SUBSCRIPTION_ADDON` |
| `externalEntityUuid` | `UUID` | **yes** | A string value representing external entity id. This is `externalId` property of an entity, or otherwise if not set - simply id of this entity. | |
| `branch` | `String` | **yes** | The name of the working branch, for example 'master' | |
| `pageSize` | `Integer` | **yes** | Maximum amount of entities in a one page | |
| `page` | `Integer` | **yes** | Sequence number of page starting from 0 | |
| `internalEntityId` | `UUID` | no |  | |
| `textSearch` | `String` | no | The case insensitive 'substring' filter based on the entity version name. | |
| `sortProperty` | `String` | no | Property of entity to sort by | enum: `timestamp` |
| `sortOrder` | `String` | no | Sort order. ASC (ASCENDING) or DESC (DESCENDING) | enum: `ASC`, `DESC` |
...
```java
PageDataEntityVersion listVersions(ListVersionsArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
ListVersionsArgs.builder()
        .branch(String)
        .pageSize(Integer)
        .page(Integer)
        .build()
...
### `ListVersionsArgs` builder fields
...
```java
UUID loadEntitiesVersion(LoadEntitiesVersionArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
LoadEntitiesVersionArgs.builder()
        .versionLoadRequest(VersionLoadRequest)
        .build()
```

### `LoadEntitiesVersionArgs` builder fields

| Field | Type | Required | Description | Notes |
|-------|------|----------|-------------|-------|
| `versionLoadRequest` | `VersionLoadRequest` | **yes** |  | |
...
```java
UUID saveEntitiesVersion(SaveEntitiesVersionArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
SaveEntitiesVersionArgs.builder()
        .versionCreateRequest(VersionCreateRequest)
        .build()
```

### `SaveEntitiesVersionArgs` builder fields

| Field | Type | Required | Description | Notes |
|-------|------|----------|-------------|-------|
| `versionCreateRequest` | `VersionCreateRequest` | **yes** |  | |
