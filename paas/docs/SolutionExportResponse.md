...
`org.thingsboard.client.model.SolutionExportResponse`
...
|------------ | ------------- | ------------- | -------------|
| **solution** | **SolutionData** | The exported solution data containing all requested entities grouped by type. | [optional] |
| **warnings** | **List\<String\>** | List of dependency warnings. Generated when exported entities reference other entities that are not included in the export (e.g. a device profile references a rule chain that was not selected for export). | [optional] |
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| entities | Map<String, List<EntityExportData>> | Exported entities grouped by entity type. Each key is an entity type (e.g. DEVICE_PROFILE, RULE_CHAIN) and the value is a list of entity export data objects. |  |
