...
void sendAddonAccessRequest(SendAddonAccessRequestArgs args) // Send add-on access request notification to System/Tenant administrators (sendAddonAccessRequest)
...
void sendPlanUpgradeRequest(SendPlanUpgradeRequestArgs args) // Send plan upgrade request notification to Tenant administrators (sendPlanUpgradeRequest)
```
...
```java
void sendAddonAccessRequest(SendAddonAccessRequestArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
SendAddonAccessRequestArgs.builder()
        .addonType(String)
        .build()
```

### `SendAddonAccessRequestArgs` builder fields
...
```java
void sendPlanUpgradeRequest(SendPlanUpgradeRequestArgs args)
// build the request (required fields shown; add optional fields from the table below as needed):
SendPlanUpgradeRequestArgs.builder()
        .planName(String)
        .build()
```

### `SendPlanUpgradeRequestArgs` builder fields
