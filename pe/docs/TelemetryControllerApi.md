...
| [**getTimeseriesByReadTsKvQueries**](#getTimeseriesByReadTsKvQueries) | **POST** /api/plugins/telemetry/{entityType}/{entityId}/values/timeseries | Get time series data by read queries (getTimeseriesByReadTsKvQueries) |
