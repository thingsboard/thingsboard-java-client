...
`org.thingsboard.client.model.LwM2MServerSecurityConfigDefault`
...
| **securityHost** | **String** | Host for 'Security' mode (DTLS) | [optional] [readonly] |
| **securityPort** | **Integer** | Port for 'Security' mode (DTLS): Lwm2m Server or Bootstrap Server | [optional] [readonly] |
