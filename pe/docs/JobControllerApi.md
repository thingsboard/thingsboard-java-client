...
PageDataJob getJobs(@Nonnull Integer pageSize, @Nonnull Integer page, @Nullable String textSearch, @Nullable String sortProperty, @Nullable String sortOrder, @Nullable List<String> types, @Nullable List<String> statuses, @Nullable List<String> entities, @Nullable Long startTime, @Nullable Long endTime, @Nullable Boolean includeCustomers) // Get jobs (getJobs)
...
```
PageDataJob getJobs(@Nonnull Integer pageSize, @Nonnull Integer page, @Nullable String textSearch, @Nullable String sortProperty, @Nullable String sortOrder, @Nullable List<String> types, @Nullable List<String> statuses, @Nullable List<String> entities, @Nullable Long startTime, @Nullable Long endTime, @Nullable Boolean includeCustomers)
```
