...
public class AssetProfileExportData extends EntityExportData {
  public AssetProfileExportData() { 
  }

  @Override
  public AssetProfileExportData entity(@Nullable ExportableEntity entity) {
    this.setEntity(entity);
    return this;
  }

  @Override
  public AssetProfileExportData relations(@Nullable List<EntityRelation> relations) {
    this.setRelations(relations);
    return this;
  }

  @Override
  public AssetProfileExportData attributes(@Nullable Map<String, List<AttributeExportData>> attributes) {
    this.setAttributes(attributes);
    return this;
  }

  @Override
  public AssetProfileExportData calculatedFields(@Nullable List<CalculatedField> calculatedFields) {
    this.setCalculatedFields(calculatedFields);
    return this;
  }

  @Override
  public AssetProfileExportData entityType(@Nonnull EntityType entityType) {
...
static {
  ...
  JSON.registerDiscriminator(AssetProfileExportData.class, "entityType", mappings);
}
}
