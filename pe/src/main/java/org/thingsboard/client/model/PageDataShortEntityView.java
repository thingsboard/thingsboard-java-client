 ...
 */
@JsonPropertyOrder({
  PageDataShortEntityView.JSON_PROPERTY_DATA,
  PageDataShortEntityView.JSON_PROPERTY_TOTAL_PAGES,
  PageDataShortEntityView.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataShortEntityView.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataShortEntityView {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<ShortEntityView> data = new ArrayList<>();
  ...
  public PageDataShortEntityView() { 
  }
  ...
  public PageDataShortEntityView data(@javax.annotation.Nullable List<ShortEntityView> data) {
    this.data = data;
    return this;
  }

  public PageDataShortEntityView addDataItem(ShortEntityView dataItem) {
    if (this.data == null) {
  ...
  public List<ShortEntityView> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<ShortEntityView> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataShortEntityView object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataShortEntityView pageDataShortEntityView = (PageDataShortEntityView) o;
    return Objects.equals(this.data, pageDataShortEntityView.data) &&
        Objects.equals(this.totalPages, pageDataShortEntityView.totalPages) &&
        Objects.equals(this.totalElements, pageDataShortEntityView.totalElements) &&
        Objects.equals(this.hasNext, pageDataShortEntityView.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataShortEntityView {\n");
