...
public class TimeSeriesChartKeySettings extends DataKeySettings {
  ...
  @JsonProperty(value = JSON_PROPERTY_SHOW_IN_LEGEND, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setShowInLegend(@javax.annotation.Nullable Boolean showInLegend) {
    this.showInLegend = showInLegend;
  }


  public TimeSeriesChartKeySettings seriesType(@javax.annotation.Nullable TimeSeriesChartSeriesType seriesType) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SERIES_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSeriesType(@javax.annotation.Nullable TimeSeriesChartSeriesType seriesType) {
    this.seriesType = seriesType;
  }


  public TimeSeriesChartKeySettings lineSettings(@javax.annotation.Nullable LineSeriesSettings lineSettings) {
  ...
  public TimeSeriesChartKeySettings barSettings(@javax.annotation.Nullable BarSeriesSettings barSettings) {
  ...
  public TimeSeriesChartKeySettings comparisonSettings(@javax.annotation.Nullable DataKeyComparisonSettings comparisonSettings) {
  ...
  @JsonProperty(value = JSON_PROPERTY_COMPARISON_SETTINGS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setComparisonSettings(@javax.annotation.Nullable DataKeyComparisonSettings comparisonSettings) {
    this.comparisonSettings = comparisonSettings;
  }
