 ...
 */
@JsonPropertyOrder({
  PageDataNotificationTemplate.JSON_PROPERTY_DATA,
  PageDataNotificationTemplate.JSON_PROPERTY_TOTAL_PAGES,
  PageDataNotificationTemplate.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataNotificationTemplate.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:17:55.932789+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataNotificationTemplate {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<NotificationTemplate> data = new ArrayList<>();
  ...
  public PageDataNotificationTemplate() { 
  }
  ...
  public PageDataNotificationTemplate data(@javax.annotation.Nullable List<NotificationTemplate> data) {
    this.data = data;
    return this;
  }

  public PageDataNotificationTemplate addDataItem(NotificationTemplate dataItem) {
    if (this.data == null) {
  ...
  public List<NotificationTemplate> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<NotificationTemplate> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataNotificationTemplate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataNotificationTemplate pageDataNotificationTemplate = (PageDataNotificationTemplate) o;
    return Objects.equals(this.data, pageDataNotificationTemplate.data) &&
        Objects.equals(this.totalPages, pageDataNotificationTemplate.totalPages) &&
        Objects.equals(this.totalElements, pageDataNotificationTemplate.totalElements) &&
        Objects.equals(this.hasNext, pageDataNotificationTemplate.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataNotificationTemplate {\n");
