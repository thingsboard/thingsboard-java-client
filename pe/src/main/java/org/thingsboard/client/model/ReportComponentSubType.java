...
/**
 * Gets or Sets ReportComponentSubType
 */
public enum ReportComponentSubType {
  ...
  ReportComponentSubType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ReportComponentSubType fromValue(String value) {
    for (ReportComponentSubType b : ReportComponentSubType.values()) {
