 ...
 */
@JsonPropertyOrder({
  JobId.JSON_PROPERTY_ID,
  JobId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class JobId {
  ...
  public JobId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public JobId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this JobId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, jobId.id) &&
        Objects.equals(this.entityType, jobId.entityType);
  }
