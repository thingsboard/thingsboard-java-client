...
import org.thingsboard.client.model.Notification;
 ...
 */
@JsonPropertyOrder({
  PageDataNotification.JSON_PROPERTY_DATA,
  PageDataNotification.JSON_PROPERTY_TOTAL_PAGES,
  PageDataNotification.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataNotification.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:17:55.932789+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataNotification {
  ...
  public PageDataNotification data(@javax.annotation.Nullable List<Notification> data) {
    this.data = data;
    return this;
  }

  public PageDataNotification addDataItem(Notification dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<Notification> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataNotification object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataNotification pageDataNotification = (PageDataNotification) o;
    return Objects.equals(this.data, pageDataNotification.data) &&
        Objects.equals(this.totalPages, pageDataNotification.totalPages) &&
        Objects.equals(this.totalElements, pageDataNotification.totalElements) &&
        Objects.equals(this.hasNext, pageDataNotification.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataNotification {\n");
