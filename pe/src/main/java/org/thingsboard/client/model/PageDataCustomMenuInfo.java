 ...
 */
@JsonPropertyOrder({
  PageDataCustomMenuInfo.JSON_PROPERTY_DATA,
  PageDataCustomMenuInfo.JSON_PROPERTY_HAS_NEXT,
  PageDataCustomMenuInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataCustomMenuInfo.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataCustomMenuInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<CustomMenuInfo> data = new ArrayList<>();
  ...
  public PageDataCustomMenuInfo data(@javax.annotation.Nullable List<CustomMenuInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataCustomMenuInfo addDataItem(CustomMenuInfo dataItem) {
    if (this.data == null) {
  ...
  public List<CustomMenuInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<CustomMenuInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataCustomMenuInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataCustomMenuInfo pageDataCustomMenuInfo = (PageDataCustomMenuInfo) o;
    return Objects.equals(this.data, pageDataCustomMenuInfo.data) &&
        Objects.equals(this.hasNext, pageDataCustomMenuInfo.hasNext) &&
        Objects.equals(this.totalElements, pageDataCustomMenuInfo.totalElements) &&
        Objects.equals(this.totalPages, pageDataCustomMenuInfo.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataCustomMenuInfo {\n");
