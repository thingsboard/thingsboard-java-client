...
public enum TelemetryObserveStrategy {
  ...
  TelemetryObserveStrategy(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static TelemetryObserveStrategy fromValue(String value) {
    for (TelemetryObserveStrategy b : TelemetryObserveStrategy.values()) {
