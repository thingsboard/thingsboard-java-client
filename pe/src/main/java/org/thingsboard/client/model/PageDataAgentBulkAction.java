 ...
 */
@JsonPropertyOrder({
  PageDataAgentBulkAction.JSON_PROPERTY_DATA,
  PageDataAgentBulkAction.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAgentBulkAction.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAgentBulkAction.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAgentBulkAction {
  public static final String JSON_PROPERTY_DATA = "data";
  @Nullable
  private List<AgentBulkAction> data = new ArrayList<>();
  ...
  public PageDataAgentBulkAction() { 
  }
  ...
  public PageDataAgentBulkAction data(@Nullable List<AgentBulkAction> data) {
    this.data = data;
    return this;
  }

  public PageDataAgentBulkAction addDataItem(AgentBulkAction dataItem) {
    if (this.data == null) {
  ...
  public List<AgentBulkAction> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<AgentBulkAction> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAgentBulkAction object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAgentBulkAction pageDataAgentBulkAction = (PageDataAgentBulkAction) o;
    return Objects.equals(this.data, pageDataAgentBulkAction.data) &&
        Objects.equals(this.totalPages, pageDataAgentBulkAction.totalPages) &&
        Objects.equals(this.totalElements, pageDataAgentBulkAction.totalElements) &&
        Objects.equals(this.hasNext, pageDataAgentBulkAction.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAgentBulkAction {\n");
