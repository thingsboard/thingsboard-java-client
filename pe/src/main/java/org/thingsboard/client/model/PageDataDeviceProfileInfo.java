 ...
 */
@JsonPropertyOrder({
  PageDataDeviceProfileInfo.JSON_PROPERTY_DATA,
  PageDataDeviceProfileInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataDeviceProfileInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataDeviceProfileInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:17:55.932789+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataDeviceProfileInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<DeviceProfileInfo> data = new ArrayList<>();
  ...
  public PageDataDeviceProfileInfo() { 
  }
  ...
  public PageDataDeviceProfileInfo data(@javax.annotation.Nullable List<DeviceProfileInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataDeviceProfileInfo addDataItem(DeviceProfileInfo dataItem) {
    if (this.data == null) {
  ...
  public List<DeviceProfileInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<DeviceProfileInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataDeviceProfileInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataDeviceProfileInfo pageDataDeviceProfileInfo = (PageDataDeviceProfileInfo) o;
    return Objects.equals(this.data, pageDataDeviceProfileInfo.data) &&
        Objects.equals(this.totalPages, pageDataDeviceProfileInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataDeviceProfileInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataDeviceProfileInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataDeviceProfileInfo {\n");
