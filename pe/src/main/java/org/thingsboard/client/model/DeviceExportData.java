 ...
 */
@JsonPropertyOrder({
  DeviceExportData.JSON_PROPERTY_CREDENTIALS
})
...
public class DeviceExportData extends EntityExportData {
  public static final String JSON_PROPERTY_CREDENTIALS = "credentials";
  @Nullable
  private DeviceCredentials credentials;

  public DeviceExportData() { 
  }

  public DeviceExportData credentials(@Nullable DeviceCredentials credentials) {
  ...
  @JsonProperty(value = JSON_PROPERTY_CREDENTIALS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCredentials(@Nullable DeviceCredentials credentials) {
    this.credentials = credentials;
  }


  @Override
  public DeviceExportData entity(@Nullable ExportableEntity entity) {
    this.setEntity(entity);
    return this;
  }

  @Override
  public DeviceExportData relations(@Nullable List<EntityRelation> relations) {
    this.setRelations(relations);
    return this;
  }

  @Override
  public DeviceExportData attributes(@Nullable Map<String, List<AttributeExportData>> attributes) {
    this.setAttributes(attributes);
    return this;
  }

  @Override
  public DeviceExportData calculatedFields(@Nullable List<CalculatedField> calculatedFields) {
    this.setCalculatedFields(calculatedFields);
    return this;
  }

  @Override
  public DeviceExportData entityType(@Nonnull EntityType entityType) {
    this.setEntityType(entityType);
    return this;
  }

  /**
   * Return true if this DeviceExportData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DeviceExportData deviceExportData = (DeviceExportData) o;
    return Objects.equals(this.credentials, deviceExportData.credentials) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceExportData {\n");
...
static {
  ...
  mappings.put("DeviceExportData", DeviceExportData.class);
  JSON.registerDiscriminator(DeviceExportData.class, "entityType", mappings);
}
}
