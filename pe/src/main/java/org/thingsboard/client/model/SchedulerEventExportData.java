...
public class SchedulerEventExportData extends EntityExportData {
  public SchedulerEventExportData() { 
  }

  @Override
  public SchedulerEventExportData entity(@javax.annotation.Nullable ExportableEntity entity) {
    this.setEntity(entity);
    return this;
  }

  @Override
  public SchedulerEventExportData relations(@javax.annotation.Nullable List<EntityRelation> relations) {
    this.setRelations(relations);
    return this;
  }

  @Override
  public SchedulerEventExportData attributes(@javax.annotation.Nullable Map<String, List<AttributeExportData>> attributes) {
    this.setAttributes(attributes);
    return this;
  }

  @Override
  public SchedulerEventExportData calculatedFields(@javax.annotation.Nullable List<CalculatedField> calculatedFields) {
    this.setCalculatedFields(calculatedFields);
    return this;
  }

  @Override
  public SchedulerEventExportData entityType(@javax.annotation.Nonnull EntityType entityType) {
    this.setEntityType(entityType);
    return this;
  }

  /**
   * Return true if this SchedulerEventExportData object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class SchedulerEventExportData {\n");
...
static {
  ...
  mappings.put("SchedulerEventExportData", SchedulerEventExportData.class);
  JSON.registerDiscriminator(SchedulerEventExportData.class, "entityType", mappings);
}
}
