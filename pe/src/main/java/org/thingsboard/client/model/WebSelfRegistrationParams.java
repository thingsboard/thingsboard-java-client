...
public class WebSelfRegistrationParams extends SelfRegistrationParams {
  ...
  public WebSelfRegistrationParams domainId(@Nonnull DomainId domainId) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DOMAIN_ID, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDomainId(@Nonnull DomainId domainId) {
    this.domainId = domainId;
  }


  public WebSelfRegistrationParams privacyPolicy(@Nullable String privacyPolicy) {
  ...
  public WebSelfRegistrationParams termsOfUse(@Nullable String termsOfUse) {
  ...
  @Override
  public WebSelfRegistrationParams captcha(@Nullable CaptchaParams captcha) {
  ...
  @Override
  public WebSelfRegistrationParams signUpFields(@Nullable List<SignUpField> signUpFields) {
    this.setSignUpFields(signUpFields);
    return this;
  }

  @Override
  public WebSelfRegistrationParams customerTitlePrefix(@Nullable String customerTitlePrefix) {
    this.setCustomerTitlePrefix(customerTitlePrefix);
    return this;
  }

  @Override
  public WebSelfRegistrationParams showPrivacyPolicy(@Nullable Boolean showPrivacyPolicy) {
    this.setShowPrivacyPolicy(showPrivacyPolicy);
    return this;
  }

  @Override
  public WebSelfRegistrationParams showTermsOfUse(@Nullable Boolean showTermsOfUse) {
    this.setShowTermsOfUse(showTermsOfUse);
    return this;
  }

  @Override
  public WebSelfRegistrationParams defaultDashboard(@Nullable DefaultDashboardParams defaultDashboard) {
    this.setDefaultDashboard(defaultDashboard);
    return this;
  }

  @Override
  public WebSelfRegistrationParams homeDashboard(@Nullable HomeDashboardParams homeDashboard) {
    this.setHomeDashboard(homeDashboard);
    return this;
  }

  @Override
  public WebSelfRegistrationParams customerGroupId(@Nullable EntityGroupId customerGroupId) {
    this.setCustomerGroupId(customerGroupId);
    return this;
  }

  @Override
  public WebSelfRegistrationParams customMenuId(@Nullable CustomMenuId customMenuId) {
