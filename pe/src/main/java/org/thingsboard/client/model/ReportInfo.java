 ...
 */
@JsonPropertyOrder({
  ReportInfo.JSON_PROPERTY_ID,
  ReportInfo.JSON_PROPERTY_CREATED_TIME,
  ReportInfo.JSON_PROPERTY_TENANT_ID,
  ReportInfo.JSON_PROPERTY_CUSTOMER_ID,
  ReportInfo.JSON_PROPERTY_TEMPLATE_ID,
...
public class ReportInfo {
  ...
  public ReportInfo id(@javax.annotation.Nullable ReportId id) {
    this.id = id;
    return this;
  }
  ...
  public ReportInfo tenantId(@javax.annotation.Nonnull TenantId tenantId) {
  ...
  public ReportInfo customerId(@javax.annotation.Nullable CustomerId customerId) {
  ...
  public ReportInfo templateId(@javax.annotation.Nonnull ReportTemplateId templateId) {
  ...
  public ReportInfo format(@javax.annotation.Nonnull TbReportFormat format) {
    this.format = format;
    return this;
  }
  ...
  public ReportInfo name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ReportInfo userId(@javax.annotation.Nonnull UserId userId) {
    this.userId = userId;
    return this;
  }
  ...
  public ReportInfo templateInfo(@javax.annotation.Nullable EntityInfo templateInfo) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TEMPLATE_INFO, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTemplateInfo(@javax.annotation.Nullable EntityInfo templateInfo) {
    this.templateInfo = templateInfo;
  }


  public ReportInfo customerTitle(@javax.annotation.Nullable String customerTitle) {
  ...
  public ReportInfo userName(@javax.annotation.Nullable String userName) {
  ...
  public ReportInfo ownerId(@javax.annotation.Nullable EntityId ownerId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, reportInfo.id) &&
        Objects.equals(this.createdTime, reportInfo.createdTime) &&
        Objects.equals(this.tenantId, reportInfo.tenantId) &&
        Objects.equals(this.customerId, reportInfo.customerId) &&
        Objects.equals(this.templateId, reportInfo.templateId) &&
