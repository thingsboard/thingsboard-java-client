 ...
 */
@JsonPropertyOrder({
  EntityViewExportData.JSON_PROPERTY_ENTITY_TYPE,
  EntityViewExportData.JSON_PROPERTY_ENTITY,
  EntityViewExportData.JSON_PROPERTY_RELATIONS,
  EntityViewExportData.JSON_PROPERTY_ATTRIBUTES,
  EntityViewExportData.JSON_PROPERTY_CALCULATED_FIELDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class EntityViewExportData {
  ...
  public EntityViewExportData() { 
  }

  public EntityViewExportData entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  public EntityViewExportData entity(@javax.annotation.Nullable ExportableEntity entity) {
    this.entity = entity;
    return this;
  }
  ...
  public EntityViewExportData relations(@javax.annotation.Nullable List<EntityRelation> relations) {
    this.relations = relations;
    return this;
  }

  public EntityViewExportData addRelationsItem(EntityRelation relationsItem) {
  ...
  public EntityViewExportData attributes(@javax.annotation.Nullable Map<String, List<AttributeExportData>> attributes) {
    this.attributes = attributes;
    return this;
  }

  public EntityViewExportData putAttributesItem(String key, List<AttributeExportData> attributesItem) {
  ...
  public EntityViewExportData calculatedFields(@javax.annotation.Nullable List<CalculatedField> calculatedFields) {
    this.calculatedFields = calculatedFields;
    return this;
  }

  public EntityViewExportData addCalculatedFieldsItem(CalculatedField calculatedFieldsItem) {
  ...
  /**
   * Return true if this EntityViewExportData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EntityViewExportData entityViewExportData = (EntityViewExportData) o;
    return Objects.equals(this.entityType, entityViewExportData.entityType) &&
        Objects.equals(this.entity, entityViewExportData.entity) &&
        Objects.equals(this.relations, entityViewExportData.relations) &&
        Objects.equals(this.attributes, entityViewExportData.attributes) &&
        Objects.equals(this.calculatedFields, entityViewExportData.calculatedFields);
  }
  ...
  public String toString() {
    ...
    sb.append("class EntityViewExportData {\n");
