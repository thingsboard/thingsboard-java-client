 ...
 */
@JsonPropertyOrder({
  NotificationTemplateExportData.JSON_PROPERTY_ENTITY_TYPE,
  NotificationTemplateExportData.JSON_PROPERTY_ENTITY,
  NotificationTemplateExportData.JSON_PROPERTY_RELATIONS,
  NotificationTemplateExportData.JSON_PROPERTY_ATTRIBUTES,
  NotificationTemplateExportData.JSON_PROPERTY_CALCULATED_FIELDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class NotificationTemplateExportData {
  ...
  public NotificationTemplateExportData() { 
  }

  public NotificationTemplateExportData entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  public NotificationTemplateExportData entity(@javax.annotation.Nullable ExportableEntity entity) {
    this.entity = entity;
    return this;
  }
  ...
  public NotificationTemplateExportData relations(@javax.annotation.Nullable List<EntityRelation> relations) {
    this.relations = relations;
    return this;
  }

  public NotificationTemplateExportData addRelationsItem(EntityRelation relationsItem) {
  ...
  public NotificationTemplateExportData attributes(@javax.annotation.Nullable Map<String, List<AttributeExportData>> attributes) {
    this.attributes = attributes;
    return this;
  }

  public NotificationTemplateExportData putAttributesItem(String key, List<AttributeExportData> attributesItem) {
  ...
  public NotificationTemplateExportData calculatedFields(@javax.annotation.Nullable List<CalculatedField> calculatedFields) {
    this.calculatedFields = calculatedFields;
    return this;
  }

  public NotificationTemplateExportData addCalculatedFieldsItem(CalculatedField calculatedFieldsItem) {
  ...
  /**
   * Return true if this NotificationTemplateExportData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NotificationTemplateExportData notificationTemplateExportData = (NotificationTemplateExportData) o;
    return Objects.equals(this.entityType, notificationTemplateExportData.entityType) &&
        Objects.equals(this.entity, notificationTemplateExportData.entity) &&
        Objects.equals(this.relations, notificationTemplateExportData.relations) &&
        Objects.equals(this.attributes, notificationTemplateExportData.attributes) &&
        Objects.equals(this.calculatedFields, notificationTemplateExportData.calculatedFields);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationTemplateExportData {\n");
