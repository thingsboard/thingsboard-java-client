 ...
 */
@JsonPropertyOrder({
  PageDataAgentProfile.JSON_PROPERTY_DATA,
  PageDataAgentProfile.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAgentProfile.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAgentProfile.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAgentProfile {
  public static final String JSON_PROPERTY_DATA = "data";
  @Nullable
  private List<AgentProfile> data = new ArrayList<>();
  ...
  public PageDataAgentProfile data(@Nullable List<AgentProfile> data) {
    this.data = data;
    return this;
  }

  public PageDataAgentProfile addDataItem(AgentProfile dataItem) {
    if (this.data == null) {
  ...
  public List<AgentProfile> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<AgentProfile> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAgentProfile object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAgentProfile pageDataAgentProfile = (PageDataAgentProfile) o;
    return Objects.equals(this.data, pageDataAgentProfile.data) &&
        Objects.equals(this.totalPages, pageDataAgentProfile.totalPages) &&
        Objects.equals(this.totalElements, pageDataAgentProfile.totalElements) &&
        Objects.equals(this.hasNext, pageDataAgentProfile.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAgentProfile {\n");
