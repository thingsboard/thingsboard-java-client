...
public class WidgetTypeExportData extends EntityExportData {
  public WidgetTypeExportData() { 
  }

  @Override
  public WidgetTypeExportData entityType(@javax.annotation.Nonnull EntityType entityType) {
    this.setEntityType(entityType);
    return this;
  }

  @Override
  public WidgetTypeExportData entity(@javax.annotation.Nullable ExportableEntity entity) {
    this.setEntity(entity);
    return this;
  }

  @Override
  public WidgetTypeExportData relations(@javax.annotation.Nullable List<EntityRelation> relations) {
    this.setRelations(relations);
    return this;
  }

  @Override
  public WidgetTypeExportData attributes(@javax.annotation.Nullable Map<String, List<AttributeExportData>> attributes) {
    this.setAttributes(attributes);
    return this;
  }

  @Override
  public WidgetTypeExportData calculatedFields(@javax.annotation.Nullable List<CalculatedField> calculatedFields) {
    this.setCalculatedFields(calculatedFields);
    return this;
  }

  /**
   * Return true if this WidgetTypeExportData object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class WidgetTypeExportData {\n");
...
static {
  ...
  mappings.put("WidgetTypeExportData", WidgetTypeExportData.class);
  JSON.registerDiscriminator(WidgetTypeExportData.class, "entityType", mappings);
}
}
