 ...
 */
@JsonPropertyOrder({
  AssetExportData.JSON_PROPERTY_ENTITY_TYPE,
  AssetExportData.JSON_PROPERTY_ENTITY,
  AssetExportData.JSON_PROPERTY_RELATIONS,
  AssetExportData.JSON_PROPERTY_ATTRIBUTES,
  AssetExportData.JSON_PROPERTY_CALCULATED_FIELDS
})
...
public class AssetExportData {
  ...
  public AssetExportData entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  public AssetExportData entity(@javax.annotation.Nullable ExportableEntity entity) {
    this.entity = entity;
    return this;
  }
  ...
  public AssetExportData relations(@javax.annotation.Nullable List<EntityRelation> relations) {
    this.relations = relations;
    return this;
  }

  public AssetExportData addRelationsItem(EntityRelation relationsItem) {
  ...
  public AssetExportData attributes(@javax.annotation.Nullable Map<String, List<AttributeExportData>> attributes) {
    this.attributes = attributes;
    return this;
  }

  public AssetExportData putAttributesItem(String key, List<AttributeExportData> attributesItem) {
  ...
  public AssetExportData calculatedFields(@javax.annotation.Nullable List<CalculatedField> calculatedFields) {
    this.calculatedFields = calculatedFields;
    return this;
  }

  public AssetExportData addCalculatedFieldsItem(CalculatedField calculatedFieldsItem) {
  ...
  /**
   * Return true if this AssetExportData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AssetExportData assetExportData = (AssetExportData) o;
    return Objects.equals(this.entityType, assetExportData.entityType) &&
        Objects.equals(this.entity, assetExportData.entity) &&
        Objects.equals(this.relations, assetExportData.relations) &&
        Objects.equals(this.attributes, assetExportData.attributes) &&
        Objects.equals(this.calculatedFields, assetExportData.calculatedFields);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssetExportData {\n");
