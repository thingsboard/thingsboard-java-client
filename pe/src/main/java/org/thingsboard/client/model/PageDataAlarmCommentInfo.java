 ...
 */
@JsonPropertyOrder({
  PageDataAlarmCommentInfo.JSON_PROPERTY_DATA,
  PageDataAlarmCommentInfo.JSON_PROPERTY_HAS_NEXT,
  PageDataAlarmCommentInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAlarmCommentInfo.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAlarmCommentInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<AlarmCommentInfo> data = new ArrayList<>();
  ...
  public PageDataAlarmCommentInfo() { 
  }
  ...
  public PageDataAlarmCommentInfo data(@javax.annotation.Nullable List<AlarmCommentInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataAlarmCommentInfo addDataItem(AlarmCommentInfo dataItem) {
    if (this.data == null) {
  ...
  public List<AlarmCommentInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<AlarmCommentInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAlarmCommentInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAlarmCommentInfo pageDataAlarmCommentInfo = (PageDataAlarmCommentInfo) o;
    return Objects.equals(this.data, pageDataAlarmCommentInfo.data) &&
        Objects.equals(this.hasNext, pageDataAlarmCommentInfo.hasNext) &&
        Objects.equals(this.totalElements, pageDataAlarmCommentInfo.totalElements) &&
        Objects.equals(this.totalPages, pageDataAlarmCommentInfo.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAlarmCommentInfo {\n");
