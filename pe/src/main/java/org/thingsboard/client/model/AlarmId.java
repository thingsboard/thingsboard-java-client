 ...
 */
@JsonPropertyOrder({
  AlarmId.JSON_PROPERTY_ID,
  AlarmId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class AlarmId {
  ...
  public AlarmId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public AlarmId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this AlarmId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, alarmId.id) &&
        Objects.equals(this.entityType, alarmId.entityType);
  }
