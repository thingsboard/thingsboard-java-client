 ...
 */
@JsonPropertyOrder({
  TbResourceExportData.JSON_PROPERTY_ENTITY_TYPE,
  TbResourceExportData.JSON_PROPERTY_ENTITY,
  TbResourceExportData.JSON_PROPERTY_RELATIONS,
  TbResourceExportData.JSON_PROPERTY_ATTRIBUTES,
  TbResourceExportData.JSON_PROPERTY_CALCULATED_FIELDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class TbResourceExportData {
  ...
  public TbResourceExportData() { 
  }

  public TbResourceExportData entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  public TbResourceExportData entity(@javax.annotation.Nullable ExportableEntity entity) {
    this.entity = entity;
    return this;
  }
  ...
  public TbResourceExportData relations(@javax.annotation.Nullable List<EntityRelation> relations) {
    this.relations = relations;
    return this;
  }

  public TbResourceExportData addRelationsItem(EntityRelation relationsItem) {
  ...
  public TbResourceExportData attributes(@javax.annotation.Nullable Map<String, List<AttributeExportData>> attributes) {
    this.attributes = attributes;
    return this;
  }

  public TbResourceExportData putAttributesItem(String key, List<AttributeExportData> attributesItem) {
  ...
  public TbResourceExportData calculatedFields(@javax.annotation.Nullable List<CalculatedField> calculatedFields) {
    this.calculatedFields = calculatedFields;
    return this;
  }

  public TbResourceExportData addCalculatedFieldsItem(CalculatedField calculatedFieldsItem) {
  ...
  /**
   * Return true if this TbResourceExportData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TbResourceExportData tbResourceExportData = (TbResourceExportData) o;
    return Objects.equals(this.entityType, tbResourceExportData.entityType) &&
        Objects.equals(this.entity, tbResourceExportData.entity) &&
        Objects.equals(this.relations, tbResourceExportData.relations) &&
        Objects.equals(this.attributes, tbResourceExportData.attributes) &&
        Objects.equals(this.calculatedFields, tbResourceExportData.calculatedFields);
  }
  ...
  public String toString() {
    ...
    sb.append("class TbResourceExportData {\n");
