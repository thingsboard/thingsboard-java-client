...
@JsonPropertyOrder({
  ...
  NotificationRule.JSON_PROPERTY_CREATED_TIME,
  NotificationRule.JSON_PROPERTY_TENANT_ID,
  NotificationRule.JSON_PROPERTY_NAME,
  NotificationRule.JSON_PROPERTY_ENABLED,
  NotificationRule.JSON_PROPERTY_TEMPLATE_ID,
  NotificationRule.JSON_PROPERTY_TRIGGER_TYPE,
  NotificationRule.JSON_PROPERTY_TRIGGER_CONFIG,
...
public class NotificationRule {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, notificationRule.id) &&
        Objects.equals(this.createdTime, notificationRule.createdTime) &&
        Objects.equals(this.tenantId, notificationRule.tenantId) &&
        Objects.equals(this.name, notificationRule.name) &&
        Objects.equals(this.enabled, notificationRule.enabled) &&
        Objects.equals(this.templateId, notificationRule.templateId) &&
        Objects.equals(this.triggerType, notificationRule.triggerType) &&
        Objects.equals(this.triggerConfig, notificationRule.triggerConfig) &&
        Objects.equals(this.recipientsConfig, notificationRule.recipientsConfig) &&
        Objects.equals(this.additionalConfig, notificationRule.additionalConfig);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createdTime, tenantId, name, enabled, templateId, triggerType, triggerConfig, recipientsConfig, additionalConfig);
  }
