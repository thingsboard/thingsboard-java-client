 ...
 */
@JsonPropertyOrder({
  NotificationRuleRecipientsConfig.JSON_PROPERTY_TRIGGER_TYPE
})
...
public class NotificationRuleRecipientsConfig {
  ...
  public NotificationRuleRecipientsConfig triggerType(@Nullable NotificationRuleTriggerType triggerType) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TRIGGER_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTriggerType(@Nullable NotificationRuleTriggerType triggerType) {
    this.triggerType = triggerType;
  }


  /**
   * Return true if this NotificationRuleRecipientsConfig object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NotificationRuleRecipientsConfig notificationRuleRecipientsConfig = (NotificationRuleRecipientsConfig) o;
    return Objects.equals(this.triggerType, notificationRuleRecipientsConfig.triggerType);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationRuleRecipientsConfig {\n");
