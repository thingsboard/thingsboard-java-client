 ...
 */
@JsonPropertyOrder({
  PageDataWidgetsBundle.JSON_PROPERTY_DATA,
  PageDataWidgetsBundle.JSON_PROPERTY_HAS_NEXT,
  PageDataWidgetsBundle.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataWidgetsBundle.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataWidgetsBundle {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<WidgetsBundle> data = new ArrayList<>();
  ...
  public PageDataWidgetsBundle data(@javax.annotation.Nullable List<WidgetsBundle> data) {
    this.data = data;
    return this;
  }

  public PageDataWidgetsBundle addDataItem(WidgetsBundle dataItem) {
    if (this.data == null) {
  ...
  public List<WidgetsBundle> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<WidgetsBundle> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataWidgetsBundle object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataWidgetsBundle pageDataWidgetsBundle = (PageDataWidgetsBundle) o;
    return Objects.equals(this.data, pageDataWidgetsBundle.data) &&
        Objects.equals(this.hasNext, pageDataWidgetsBundle.hasNext) &&
        Objects.equals(this.totalElements, pageDataWidgetsBundle.totalElements) &&
        Objects.equals(this.totalPages, pageDataWidgetsBundle.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataWidgetsBundle {\n");
