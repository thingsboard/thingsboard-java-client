...
public class SingleEntityVersionCreateRequest extends VersionCreateRequest {
  ...
  public SingleEntityVersionCreateRequest entityId(@javax.annotation.Nullable EntityId entityId) {
  ...
  public SingleEntityVersionCreateRequest config(@javax.annotation.Nullable VersionCreateConfig config) {
    this.config = config;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CONFIG, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConfig(@javax.annotation.Nullable VersionCreateConfig config) {
    this.config = config;
  }
