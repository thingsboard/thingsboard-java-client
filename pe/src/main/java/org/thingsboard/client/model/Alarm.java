...
@JsonPropertyOrder({
  ...
  Alarm.JSON_PROPERTY_ORIGINATOR,
  Alarm.JSON_PROPERTY_SEVERITY,
  Alarm.JSON_PROPERTY_ACKNOWLEDGED,
  Alarm.JSON_PROPERTY_CLEARED,
  Alarm.JSON_PROPERTY_ASSIGNEE_ID,
  Alarm.JSON_PROPERTY_START_TS,
  Alarm.JSON_PROPERTY_END_TS,
  Alarm.JSON_PROPERTY_ACK_TS,
  Alarm.JSON_PROPERTY_CLEAR_TS,
  Alarm.JSON_PROPERTY_ASSIGN_TS,
  Alarm.JSON_PROPERTY_DETAILS,
  Alarm.JSON_PROPERTY_PROPAGATE,
  Alarm.JSON_PROPERTY_PROPAGATE_TO_OWNER,
  Alarm.JSON_PROPERTY_PROPAGATE_TO_OWNER_HIERARCHY,
...
public class Alarm {
  ...
  public Alarm type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public Alarm originator(@javax.annotation.Nonnull EntityId originator) {
  ...
  public Alarm severity(@javax.annotation.Nonnull AlarmSeverity severity) {
  ...
  public Alarm acknowledged(@javax.annotation.Nonnull Boolean acknowledged) {
  ...
  public Alarm cleared(@javax.annotation.Nonnull Boolean cleared) {
  ...
  public Alarm assigneeId(@javax.annotation.Nullable UserId assigneeId) {
  ...
  public Alarm startTs(@javax.annotation.Nullable Long startTs) {
  ...
  public Alarm endTs(@javax.annotation.Nullable Long endTs) {
    this.endTs = endTs;
    return this;
  }
  ...
  public Alarm ackTs(@javax.annotation.Nullable Long ackTs) {
    this.ackTs = ackTs;
    return this;
  }
  ...
  public Alarm clearTs(@javax.annotation.Nullable Long clearTs) {
  ...
  public Alarm assignTs(@javax.annotation.Nullable Long assignTs) {
  ...
  public Alarm details(@javax.annotation.Nullable com.fasterxml.jackson.databind.JsonNode details) {
  ...
  public Alarm propagate(@javax.annotation.Nullable Boolean propagate) {
  ...
  public Alarm propagateToOwner(@javax.annotation.Nullable Boolean propagateToOwner) {
  ...
  public Alarm propagateToOwnerHierarchy(@javax.annotation.Nullable Boolean propagateToOwnerHierarchy) {
  ...
  public Alarm propagateToTenant(@javax.annotation.Nullable Boolean propagateToTenant) {
  ...
  public Alarm propagateRelationTypes(@javax.annotation.Nullable List<String> propagateRelationTypes) {
    this.propagateRelationTypes = propagateRelationTypes;
    return this;
  }

  public Alarm addPropagateRelationTypesItem(String propagateRelationTypesItem) {
  ...
  /**
   * Return true if this Alarm object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, alarm.id) &&
        ...
        Objects.equals(this.cleared, alarm.cleared) &&
        Objects.equals(this.assigneeId, alarm.assigneeId) &&
        Objects.equals(this.startTs, alarm.startTs) &&
        Objects.equals(this.endTs, alarm.endTs) &&
        Objects.equals(this.ackTs, alarm.ackTs) &&
        Objects.equals(this.clearTs, alarm.clearTs) &&
        Objects.equals(this.assignTs, alarm.assignTs) &&
        Objects.equals(this.details, alarm.details) &&
        Objects.equals(this.propagate, alarm.propagate) &&
        Objects.equals(this.propagateToOwner, alarm.propagateToOwner) &&
        Objects.equals(this.propagateToOwnerHierarchy, alarm.propagateToOwnerHierarchy) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdTime, tenantId, customerId, type, originator, severity, acknowledged, cleared, assigneeId, startTs, endTs, ackTs, clearTs, assignTs, details, propagate, propagateToOwner, propagateToOwnerHierarchy, propagateToTenant, propagateRelationTypes, name, status);
  }
