 ...
 */
@JsonPropertyOrder({
  CaptchaParams.JSON_PROPERTY_VERSION
})
...
public class CaptchaParams {
  ...
  public CaptchaParams version(@javax.annotation.Nonnull String version) {
  ...
  /**
   * Return true if this CaptchaParams object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CaptchaParams captchaParams = (CaptchaParams) o;
    return Objects.equals(this.version, captchaParams.version);
  }
...
static {
  ...
  mappings.put("enterprise", EnterpriseCaptchaParams.class);
  mappings.put("v2", V2CaptchaParams.class);
  mappings.put("v3", V3CaptchaParams.class);
  mappings.put("CaptchaParams", CaptchaParams.class);
  JSON.registerDiscriminator(CaptchaParams.class, "version", mappings);
}
}
