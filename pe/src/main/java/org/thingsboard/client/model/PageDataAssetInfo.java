 ...
 */
@JsonPropertyOrder({
  PageDataAssetInfo.JSON_PROPERTY_DATA,
  PageDataAssetInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAssetInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAssetInfo.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAssetInfo {
  ...
  public PageDataAssetInfo data(@Nullable List<AssetInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataAssetInfo addDataItem(AssetInfo dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<AssetInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAssetInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAssetInfo pageDataAssetInfo = (PageDataAssetInfo) o;
    return Objects.equals(this.data, pageDataAssetInfo.data) &&
        Objects.equals(this.totalPages, pageDataAssetInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataAssetInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataAssetInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAssetInfo {\n");
