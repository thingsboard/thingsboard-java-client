...
public class AgentApplicationId extends EntityId {
  public AgentApplicationId() { 
  }

  @Override
  public AgentApplicationId id(@Nonnull UUID id) {
    this.setId(id);
    return this;
  }

  /**
   * Return true if this AgentApplicationId object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class AgentApplicationId {\n");
...
static {
  ...
  mappings.put("AgentApplicationId", AgentApplicationId.class);
  JSON.registerDiscriminator(AgentApplicationId.class, "entityType", mappings);
}
}
