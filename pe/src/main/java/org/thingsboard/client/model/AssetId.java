 ...
 */
@JsonPropertyOrder({
  AssetId.JSON_PROPERTY_ID,
  AssetId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class AssetId {
  ...
  public AssetId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public AssetId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this AssetId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, assetId.id) &&
        Objects.equals(this.entityType, assetId.entityType);
  }
