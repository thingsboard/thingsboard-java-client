 ...
 */
@JsonPropertyOrder({
  RoleId.JSON_PROPERTY_ID,
  RoleId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class RoleId {
  ...
  public RoleId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public RoleId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this RoleId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, roleId.id) &&
        Objects.equals(this.entityType, roleId.entityType);
  }
