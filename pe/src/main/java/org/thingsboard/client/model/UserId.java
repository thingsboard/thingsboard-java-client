 ...
 */
@JsonPropertyOrder({
  UserId.JSON_PROPERTY_ID,
  UserId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class UserId {
  ...
  public UserId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public UserId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this UserId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, userId.id) &&
        Objects.equals(this.entityType, userId.entityType);
  }
