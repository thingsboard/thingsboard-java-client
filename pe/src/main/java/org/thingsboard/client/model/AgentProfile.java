 ...
 */
@JsonPropertyOrder({
  AgentProfile.JSON_PROPERTY_ID,
  AgentProfile.JSON_PROPERTY_CREATED_TIME,
  AgentProfile.JSON_PROPERTY_TENANT_ID,
  AgentProfile.JSON_PROPERTY_NAME,
  AgentProfile.JSON_PROPERTY_DESCRIPTION,
  AgentProfile.JSON_PROPERTY_PROVISION_KEY,
  AgentProfile.JSON_PROPERTY_PROVISION_SECRET,
  AgentProfile.JSON_PROPERTY_PROVISION_TYPE,
  AgentProfile.JSON_PROPERTY_VERSION,
  AgentProfile.JSON_PROPERTY_DEFAULT
})
...
public class AgentProfile {
  ...
  public AgentProfile id(@Nullable AgentProfileId id) {
    this.id = id;
    return this;
  }
  ...
  public AgentProfile name(@Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AgentProfile description(@Nullable String description) {
  ...
  public AgentProfile provisionKey(@Nullable String provisionKey) {
  ...
  public AgentProfile provisionSecret(@Nullable String provisionSecret) {
  ...
  public AgentProfile provisionType(@Nullable AgentProvisionType provisionType) {
  ...
  public AgentProfile version(@Nullable Long version) {
  ...
  public AgentProfile _default(@Nullable Boolean _default) {
  ...
  /**
   * Return true if this AgentProfile object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, agentProfile.id) &&
        Objects.equals(this.createdTime, agentProfile.createdTime) &&
        Objects.equals(this.tenantId, agentProfile.tenantId) &&
        Objects.equals(this.name, agentProfile.name) &&
        Objects.equals(this.description, agentProfile.description) &&
        Objects.equals(this.provisionKey, agentProfile.provisionKey) &&
        Objects.equals(this.provisionSecret, agentProfile.provisionSecret) &&
        Objects.equals(this.provisionType, agentProfile.provisionType) &&
        Objects.equals(this.version, agentProfile.version) &&
        Objects.equals(this._default, agentProfile._default);
  }
