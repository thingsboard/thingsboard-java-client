 ...
 */
@JsonPropertyOrder({
  PageDataAgentProfileInfo.JSON_PROPERTY_DATA,
  PageDataAgentProfileInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAgentProfileInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAgentProfileInfo.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAgentProfileInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @Nullable
  private List<AgentProfileInfo> data = new ArrayList<>();
  ...
  public PageDataAgentProfileInfo() { 
  }
  ...
  public PageDataAgentProfileInfo data(@Nullable List<AgentProfileInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataAgentProfileInfo addDataItem(AgentProfileInfo dataItem) {
    if (this.data == null) {
  ...
  public List<AgentProfileInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<AgentProfileInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAgentProfileInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAgentProfileInfo pageDataAgentProfileInfo = (PageDataAgentProfileInfo) o;
    return Objects.equals(this.data, pageDataAgentProfileInfo.data) &&
        Objects.equals(this.totalPages, pageDataAgentProfileInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataAgentProfileInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataAgentProfileInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAgentProfileInfo {\n");
