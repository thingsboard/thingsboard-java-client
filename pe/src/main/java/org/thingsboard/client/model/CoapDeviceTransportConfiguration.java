 ...
 */
@JsonPropertyOrder({
  CoapDeviceTransportConfiguration.JSON_PROPERTY_POWER_MODE,
  CoapDeviceTransportConfiguration.JSON_PROPERTY_PSM_ACTIVITY_TIMER,
  CoapDeviceTransportConfiguration.JSON_PROPERTY_EDRX_CYCLE,
  CoapDeviceTransportConfiguration.JSON_PROPERTY_PAGING_TRANSMISSION_WINDOW
})
...
public class CoapDeviceTransportConfiguration extends DeviceTransportConfiguration {
  ...
  public CoapDeviceTransportConfiguration() { 
  }

  public CoapDeviceTransportConfiguration powerMode(@javax.annotation.Nullable PowerMode powerMode) {
  ...
  public CoapDeviceTransportConfiguration psmActivityTimer(@javax.annotation.Nullable Long psmActivityTimer) {
  ...
  public CoapDeviceTransportConfiguration edrxCycle(@javax.annotation.Nullable Long edrxCycle) {
  ...
  public CoapDeviceTransportConfiguration pagingTransmissionWindow(@javax.annotation.Nullable Long pagingTransmissionWindow) {
  ...
  @Override
  public CoapDeviceTransportConfiguration type(@javax.annotation.Nonnull String type) {
    this.setType(type);
    return this;
  }

  /**
   * Return true if this CoapDeviceTransportConfiguration object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CoapDeviceTransportConfiguration coapDeviceTransportConfiguration = (CoapDeviceTransportConfiguration) o;
    return Objects.equals(this.powerMode, coapDeviceTransportConfiguration.powerMode) &&
        Objects.equals(this.psmActivityTimer, coapDeviceTransportConfiguration.psmActivityTimer) &&
        Objects.equals(this.edrxCycle, coapDeviceTransportConfiguration.edrxCycle) &&
        Objects.equals(this.pagingTransmissionWindow, coapDeviceTransportConfiguration.pagingTransmissionWindow) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoapDeviceTransportConfiguration {\n");
...
static {
  ...
  mappings.put("CoapDeviceTransportConfiguration", CoapDeviceTransportConfiguration.class);
  JSON.registerDiscriminator(CoapDeviceTransportConfiguration.class, "type", mappings);
}
}
