...
public class CoapDeviceTransportConfiguration extends DeviceTransportConfiguration {
  ...
  public CoapDeviceTransportConfiguration powerMode(@Nullable PowerMode powerMode) {
  ...
  public CoapDeviceTransportConfiguration psmActivityTimer(@Nullable Long psmActivityTimer) {
  ...
  public CoapDeviceTransportConfiguration edrxCycle(@Nullable Long edrxCycle) {
  ...
  public CoapDeviceTransportConfiguration pagingTransmissionWindow(@Nullable Long pagingTransmissionWindow) {
  ...
  @Override
  public CoapDeviceTransportConfiguration type(@Nonnull String type) {
    this.setType(type);
    return this;
  }
