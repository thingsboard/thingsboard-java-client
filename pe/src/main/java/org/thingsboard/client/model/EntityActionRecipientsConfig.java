 ...
 */
@JsonPropertyOrder({
  EntityActionRecipientsConfig.JSON_PROPERTY_TARGETS
})
...
public class EntityActionRecipientsConfig extends NotificationRuleRecipientsConfig {
  public static final String JSON_PROPERTY_TARGETS = "targets";
  @Nonnull
  private List<UUID> targets = new ArrayList<>();

  public EntityActionRecipientsConfig() { 
  }

  public EntityActionRecipientsConfig targets(@Nonnull List<UUID> targets) {
    this.targets = targets;
    return this;
  }

  public EntityActionRecipientsConfig addTargetsItem(UUID targetsItem) {
  ...
  @Override
  public EntityActionRecipientsConfig triggerType(@Nullable NotificationRuleTriggerType triggerType) {
    this.setTriggerType(triggerType);
    return this;
  }

  /**
   * Return true if this EntityActionRecipientsConfig object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EntityActionRecipientsConfig entityActionRecipientsConfig = (EntityActionRecipientsConfig) o;
    return Objects.equals(this.targets, entityActionRecipientsConfig.targets) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class EntityActionRecipientsConfig {\n");
...
static {
  ...
  mappings.put("EntityActionRecipientsConfig", EntityActionRecipientsConfig.class);
  JSON.registerDiscriminator(EntityActionRecipientsConfig.class, "triggerType", mappings);
}
}
