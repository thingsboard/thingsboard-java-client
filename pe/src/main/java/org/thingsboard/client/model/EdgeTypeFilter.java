...
public class EdgeTypeFilter extends EntityFilter {
  ...
  public EdgeTypeFilter edgeTypes(@Nullable List<String> edgeTypes) {
  ...
  public EdgeTypeFilter edgeNameFilter(@Nullable String edgeNameFilter) {
  ...
  @JsonProperty(value = JSON_PROPERTY_EDGE_NAME_FILTER, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEdgeNameFilter(@Nullable String edgeNameFilter) {
    this.edgeNameFilter = edgeNameFilter;
  }


  public EdgeTypeFilter edgeType(@Nullable String edgeType) {
  ...
  @JsonProperty(value = JSON_PROPERTY_EDGE_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEdgeType(@Nullable String edgeType) {
    this.edgeType = edgeType;
  }


  @Override
  public EdgeTypeFilter type(@Nonnull String type) {
    this.setType(type);
    return this;
  }
