...
public class OpenAiChatModelConfig extends AiModelConfig {
  ...
  public OpenAiChatModelConfig providerConfig(@javax.annotation.Nonnull OpenAiProviderConfig providerConfig) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PROVIDER_CONFIG, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProviderConfig(@javax.annotation.Nonnull OpenAiProviderConfig providerConfig) {
    this.providerConfig = providerConfig;
  }


  public OpenAiChatModelConfig modelId(@javax.annotation.Nonnull String modelId) {
  ...
  public OpenAiChatModelConfig temperature(@javax.annotation.Nullable Double temperature) {
  ...
  public OpenAiChatModelConfig topP(@javax.annotation.Nullable Double topP) {
    this.topP = topP;
    return this;
  }
  ...
  public OpenAiChatModelConfig frequencyPenalty(@javax.annotation.Nullable Double frequencyPenalty) {
  ...
  public OpenAiChatModelConfig presencePenalty(@javax.annotation.Nullable Double presencePenalty) {
  ...
  public OpenAiChatModelConfig maxOutputTokens(@javax.annotation.Nullable Integer maxOutputTokens) {
  ...
  public OpenAiChatModelConfig timeoutSeconds(@javax.annotation.Nullable Integer timeoutSeconds) {
  ...
  public OpenAiChatModelConfig maxRetries(@javax.annotation.Nullable Integer maxRetries) {
  ...
  @Override
  public OpenAiChatModelConfig provider(@javax.annotation.Nonnull String provider) {
