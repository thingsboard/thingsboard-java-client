...
import org.thingsboard.client.model.AlarmRuleDefinitionInfo;
 ...
 */
@JsonPropertyOrder({
  PageDataAlarmRuleDefinitionInfo.JSON_PROPERTY_DATA,
  PageDataAlarmRuleDefinitionInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAlarmRuleDefinitionInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAlarmRuleDefinitionInfo.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAlarmRuleDefinitionInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @Nullable
  private List<AlarmRuleDefinitionInfo> data = new ArrayList<>();
  ...
  public PageDataAlarmRuleDefinitionInfo() { 
  }
  ...
  public PageDataAlarmRuleDefinitionInfo data(@Nullable List<AlarmRuleDefinitionInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataAlarmRuleDefinitionInfo addDataItem(AlarmRuleDefinitionInfo dataItem) {
    if (this.data == null) {
  ...
  public List<AlarmRuleDefinitionInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<AlarmRuleDefinitionInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAlarmRuleDefinitionInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAlarmRuleDefinitionInfo pageDataAlarmRuleDefinitionInfo = (PageDataAlarmRuleDefinitionInfo) o;
    return Objects.equals(this.data, pageDataAlarmRuleDefinitionInfo.data) &&
        Objects.equals(this.totalPages, pageDataAlarmRuleDefinitionInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataAlarmRuleDefinitionInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataAlarmRuleDefinitionInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAlarmRuleDefinitionInfo {\n");
