...
public class DebugConverterEventFilter extends EventFilter {
  ...
  public DebugConverterEventFilter isError(@javax.annotation.Nullable IsErrorEnum isError) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(server, isError, errorStr, type, in, out, metadata, super.hashCode());
  }
