...
public class AccountTwoFaSettings {
  ...
  public AccountTwoFaSettings putConfigsItem(String key, TwoFaAccountConfig configsItem) {
  ...
  /**
   * Return true if this AccountTwoFaSettings object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AccountTwoFaSettings accountTwoFaSettings = (AccountTwoFaSettings) o;
    return Objects.equals(this.configs, accountTwoFaSettings.configs);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountTwoFaSettings {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getConfigs() != null) {
      for (String _key : getConfigs().keySet()) {
        if (getConfigs().get(_key) != null) {
          joiner.add(getConfigs().get(_key).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sconfigs%s%s", prefix, suffix,
