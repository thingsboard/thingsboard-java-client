 ...
 */
@JsonPropertyOrder({
  Lwm2mDeviceTransportConfiguration.JSON_PROPERTY_POWER_MODE,
  Lwm2mDeviceTransportConfiguration.JSON_PROPERTY_PSM_ACTIVITY_TIMER,
  Lwm2mDeviceTransportConfiguration.JSON_PROPERTY_EDRX_CYCLE,
  Lwm2mDeviceTransportConfiguration.JSON_PROPERTY_PAGING_TRANSMISSION_WINDOW
})
...
public class Lwm2mDeviceTransportConfiguration extends DeviceTransportConfiguration {
  ...
  public Lwm2mDeviceTransportConfiguration() { 
  }

  public Lwm2mDeviceTransportConfiguration powerMode(@javax.annotation.Nullable PowerMode powerMode) {
  ...
  public Lwm2mDeviceTransportConfiguration psmActivityTimer(@javax.annotation.Nullable Long psmActivityTimer) {
  ...
  public Lwm2mDeviceTransportConfiguration edrxCycle(@javax.annotation.Nullable Long edrxCycle) {
  ...
  public Lwm2mDeviceTransportConfiguration pagingTransmissionWindow(@javax.annotation.Nullable Long pagingTransmissionWindow) {
  ...
  @Override
  public Lwm2mDeviceTransportConfiguration type(@javax.annotation.Nonnull String type) {
    this.setType(type);
    return this;
  }

  /**
   * Return true if this Lwm2mDeviceTransportConfiguration object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    Lwm2mDeviceTransportConfiguration lwm2mDeviceTransportConfiguration = (Lwm2mDeviceTransportConfiguration) o;
    return Objects.equals(this.powerMode, lwm2mDeviceTransportConfiguration.powerMode) &&
        Objects.equals(this.psmActivityTimer, lwm2mDeviceTransportConfiguration.psmActivityTimer) &&
        Objects.equals(this.edrxCycle, lwm2mDeviceTransportConfiguration.edrxCycle) &&
        Objects.equals(this.pagingTransmissionWindow, lwm2mDeviceTransportConfiguration.pagingTransmissionWindow) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(powerMode, psmActivityTimer, edrxCycle, pagingTransmissionWindow, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Lwm2mDeviceTransportConfiguration {\n");
...
static {
  ...
  mappings.put("Lwm2mDeviceTransportConfiguration", Lwm2mDeviceTransportConfiguration.class);
  JSON.registerDiscriminator(Lwm2mDeviceTransportConfiguration.class, "type", mappings);
}
}
