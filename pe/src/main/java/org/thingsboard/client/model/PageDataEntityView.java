 ...
 */
@JsonPropertyOrder({
  PageDataEntityView.JSON_PROPERTY_DATA,
  PageDataEntityView.JSON_PROPERTY_TOTAL_PAGES,
  PageDataEntityView.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataEntityView.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataEntityView {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<EntityView> data = new ArrayList<>();
  ...
  public PageDataEntityView data(@javax.annotation.Nullable List<EntityView> data) {
    this.data = data;
    return this;
  }

  public PageDataEntityView addDataItem(EntityView dataItem) {
    if (this.data == null) {
  ...
  public List<EntityView> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<EntityView> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataEntityView object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataEntityView pageDataEntityView = (PageDataEntityView) o;
    return Objects.equals(this.data, pageDataEntityView.data) &&
        Objects.equals(this.totalPages, pageDataEntityView.totalPages) &&
        Objects.equals(this.totalElements, pageDataEntityView.totalElements) &&
        Objects.equals(this.hasNext, pageDataEntityView.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataEntityView {\n");
