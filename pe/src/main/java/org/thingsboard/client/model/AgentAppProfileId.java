...
public class AgentAppProfileId extends EntityId {
  public AgentAppProfileId() { 
  }

  @Override
  public AgentAppProfileId id(@Nonnull UUID id) {
    this.setId(id);
    return this;
  }

  /**
   * Return true if this AgentAppProfileId object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class AgentAppProfileId {\n");
...
static {
  ...
  mappings.put("AgentAppProfileId", AgentAppProfileId.class);
  JSON.registerDiscriminator(AgentAppProfileId.class, "entityType", mappings);
}
}
