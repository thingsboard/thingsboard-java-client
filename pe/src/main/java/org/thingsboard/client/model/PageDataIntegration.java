 ...
 */
@JsonPropertyOrder({
  PageDataIntegration.JSON_PROPERTY_DATA,
  PageDataIntegration.JSON_PROPERTY_HAS_NEXT,
  PageDataIntegration.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataIntegration.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataIntegration {
  ...
  public PageDataIntegration data(@javax.annotation.Nullable List<Integration> data) {
    this.data = data;
    return this;
  }

  public PageDataIntegration addDataItem(Integration dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<Integration> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataIntegration object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataIntegration pageDataIntegration = (PageDataIntegration) o;
    return Objects.equals(this.data, pageDataIntegration.data) &&
        Objects.equals(this.hasNext, pageDataIntegration.hasNext) &&
        Objects.equals(this.totalElements, pageDataIntegration.totalElements) &&
        Objects.equals(this.totalPages, pageDataIntegration.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataIntegration {\n");
