...
public class HasIdObject {
  ...
  /**
   * Return true if this HasIdObject object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    HasIdObject hasIdObject = (HasIdObject) o;
    return equalsNullable(this.id, hasIdObject.id);
  }
