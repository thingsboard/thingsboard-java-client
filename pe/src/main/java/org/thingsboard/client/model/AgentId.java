...
public class AgentId extends EntityId {
  ...
  @Override
  public AgentId id(@Nonnull UUID id) {
    this.setId(id);
    return this;
  }

  /**
   * Return true if this AgentId object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("AgentId", AgentId.class);
  JSON.registerDiscriminator(AgentId.class, "entityType", mappings);
}
}
