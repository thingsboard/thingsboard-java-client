 ...
 */
@JsonPropertyOrder({
  PageDataDashboardInfo.JSON_PROPERTY_DATA,
  PageDataDashboardInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataDashboardInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataDashboardInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:17:55.932789+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataDashboardInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<DashboardInfo> data = new ArrayList<>();
  ...
  public PageDataDashboardInfo data(@javax.annotation.Nullable List<DashboardInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataDashboardInfo addDataItem(DashboardInfo dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<DashboardInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataDashboardInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataDashboardInfo pageDataDashboardInfo = (PageDataDashboardInfo) o;
    return Objects.equals(this.data, pageDataDashboardInfo.data) &&
        Objects.equals(this.totalPages, pageDataDashboardInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataDashboardInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataDashboardInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataDashboardInfo {\n");
