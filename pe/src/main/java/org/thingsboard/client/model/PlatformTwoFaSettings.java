...
public class PlatformTwoFaSettings {
  ...
  public PlatformTwoFaSettings useSystemTwoFactorAuthSettings(@javax.annotation.Nullable Boolean useSystemTwoFactorAuthSettings) {
  ...
  @JsonProperty(value = JSON_PROPERTY_USE_SYSTEM_TWO_FACTOR_AUTH_SETTINGS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUseSystemTwoFactorAuthSettings(@javax.annotation.Nullable Boolean useSystemTwoFactorAuthSettings) {
    this.useSystemTwoFactorAuthSettings = useSystemTwoFactorAuthSettings;
  }
