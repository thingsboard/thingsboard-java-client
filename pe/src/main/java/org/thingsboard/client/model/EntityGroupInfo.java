 ...
 */
@JsonPropertyOrder({
  EntityGroupInfo.JSON_PROPERTY_ID,
  EntityGroupInfo.JSON_PROPERTY_CREATED_TIME,
  EntityGroupInfo.JSON_PROPERTY_TYPE,
  EntityGroupInfo.JSON_PROPERTY_NAME,
  EntityGroupInfo.JSON_PROPERTY_OWNER_ID,
  EntityGroupInfo.JSON_PROPERTY_ADDITIONAL_INFO,
...
public class EntityGroupInfo {
  ...
  /**
   * Return true if this EntityGroupInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EntityGroupInfo entityGroupInfo = (EntityGroupInfo) o;
    return Objects.equals(this.id, entityGroupInfo.id) &&
        Objects.equals(this.createdTime, entityGroupInfo.createdTime) &&
        Objects.equals(this.type, entityGroupInfo.type) &&
        Objects.equals(this.name, entityGroupInfo.name) &&
        Objects.equals(this.ownerId, entityGroupInfo.ownerId) &&
        Objects.equals(this.additionalInfo, entityGroupInfo.additionalInfo) &&
  ...
  public String toString() {
    ...
    sb.append("class EntityGroupInfo {\n");
