 ...
 */
@JsonPropertyOrder({
  DeviceProfileExportData.JSON_PROPERTY_ENTITY_TYPE,
  DeviceProfileExportData.JSON_PROPERTY_ENTITY,
  DeviceProfileExportData.JSON_PROPERTY_RELATIONS,
  DeviceProfileExportData.JSON_PROPERTY_ATTRIBUTES,
  DeviceProfileExportData.JSON_PROPERTY_CALCULATED_FIELDS
})
...
public class DeviceProfileExportData {
  ...
  public DeviceProfileExportData() { 
  }

  public DeviceProfileExportData entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  public DeviceProfileExportData entity(@javax.annotation.Nullable ExportableEntity entity) {
    this.entity = entity;
    return this;
  }
  ...
  public DeviceProfileExportData relations(@javax.annotation.Nullable List<EntityRelation> relations) {
    this.relations = relations;
    return this;
  }

  public DeviceProfileExportData addRelationsItem(EntityRelation relationsItem) {
  ...
  public DeviceProfileExportData attributes(@javax.annotation.Nullable Map<String, List<AttributeExportData>> attributes) {
    this.attributes = attributes;
    return this;
  }

  public DeviceProfileExportData putAttributesItem(String key, List<AttributeExportData> attributesItem) {
  ...
  public DeviceProfileExportData calculatedFields(@javax.annotation.Nullable List<CalculatedField> calculatedFields) {
    this.calculatedFields = calculatedFields;
    return this;
  }

  public DeviceProfileExportData addCalculatedFieldsItem(CalculatedField calculatedFieldsItem) {
  ...
  /**
   * Return true if this DeviceProfileExportData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DeviceProfileExportData deviceProfileExportData = (DeviceProfileExportData) o;
    return Objects.equals(this.entityType, deviceProfileExportData.entityType) &&
        Objects.equals(this.entity, deviceProfileExportData.entity) &&
        Objects.equals(this.relations, deviceProfileExportData.relations) &&
        Objects.equals(this.attributes, deviceProfileExportData.attributes) &&
        Objects.equals(this.calculatedFields, deviceProfileExportData.calculatedFields);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceProfileExportData {\n");
