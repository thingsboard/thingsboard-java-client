...
public class SimpleAlarmConditionExpression extends AlarmConditionExpression {
  ...
  public SimpleAlarmConditionExpression filters(@javax.annotation.Nonnull List<AlarmRuleConditionFilter> filters) {
  ...
  @JsonProperty(value = JSON_PROPERTY_FILTERS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFilters(@javax.annotation.Nonnull List<AlarmRuleConditionFilter> filters) {
    this.filters = filters;
  }


  public SimpleAlarmConditionExpression operation(@javax.annotation.Nullable ComplexOperation operation) {
  ...
  @Override
  public SimpleAlarmConditionExpression type(@javax.annotation.Nonnull String type) {
    this.setType(type);
    return this;
  }
