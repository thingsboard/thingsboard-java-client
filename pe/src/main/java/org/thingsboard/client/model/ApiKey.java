...
@JsonPropertyOrder({
  ...
  ApiKey.JSON_PROPERTY_CREATED_TIME,
  ApiKey.JSON_PROPERTY_TENANT_ID,
  ApiKey.JSON_PROPERTY_USER_ID,
  ApiKey.JSON_PROPERTY_EXPIRATION_TIME,
  ApiKey.JSON_PROPERTY_DESCRIPTION,
  ApiKey.JSON_PROPERTY_ENABLED,
  ApiKey.JSON_PROPERTY_VALUE,
  ApiKey.JSON_PROPERTY_EXPIRED
})
...
public class ApiKey {
  ...
  public ApiKey id(@Nullable ApiKeyId id) {
    this.id = id;
    return this;
  }
  ...
  public ApiKey userId(@Nullable UserId userId) {
    this.userId = userId;
    return this;
  }
  ...
  public ApiKey expirationTime(@Nullable Long expirationTime) {
  ...
  public ApiKey description(@Nonnull String description) {
  ...
  public ApiKey enabled(@Nullable Boolean enabled) {
  ...
  public ApiKey value(@Nonnull String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, apiKey.id) &&
        Objects.equals(this.createdTime, apiKey.createdTime) &&
        Objects.equals(this.tenantId, apiKey.tenantId) &&
        Objects.equals(this.userId, apiKey.userId) &&
        Objects.equals(this.expirationTime, apiKey.expirationTime) &&
        ...
        Objects.equals(this.expired, apiKey.expired);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createdTime, tenantId, userId, expirationTime, description, enabled, value, expired);
  }
