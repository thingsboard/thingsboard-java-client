 ...
 */
@JsonPropertyOrder({
  RateLimitsRecipientsConfig.JSON_PROPERTY_TARGETS
})
...
public class RateLimitsRecipientsConfig extends NotificationRuleRecipientsConfig {
  public static final String JSON_PROPERTY_TARGETS = "targets";
  @Nonnull
  private List<UUID> targets = new ArrayList<>();

  public RateLimitsRecipientsConfig() { 
  }

  public RateLimitsRecipientsConfig targets(@Nonnull List<UUID> targets) {
    this.targets = targets;
    return this;
  }

  public RateLimitsRecipientsConfig addTargetsItem(UUID targetsItem) {
  ...
  @Override
  public RateLimitsRecipientsConfig triggerType(@Nullable NotificationRuleTriggerType triggerType) {
    this.setTriggerType(triggerType);
    return this;
  }

  /**
   * Return true if this RateLimitsRecipientsConfig object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RateLimitsRecipientsConfig rateLimitsRecipientsConfig = (RateLimitsRecipientsConfig) o;
    return Objects.equals(this.targets, rateLimitsRecipientsConfig.targets) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class RateLimitsRecipientsConfig {\n");
...
static {
  ...
  mappings.put("RateLimitsRecipientsConfig", RateLimitsRecipientsConfig.class);
  JSON.registerDiscriminator(RateLimitsRecipientsConfig.class, "triggerType", mappings);
}
}
