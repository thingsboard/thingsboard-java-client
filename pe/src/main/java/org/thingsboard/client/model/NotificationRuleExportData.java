 ...
 */
@JsonPropertyOrder({
  NotificationRuleExportData.JSON_PROPERTY_ENTITY_TYPE,
  NotificationRuleExportData.JSON_PROPERTY_ENTITY,
  NotificationRuleExportData.JSON_PROPERTY_RELATIONS,
  NotificationRuleExportData.JSON_PROPERTY_ATTRIBUTES,
  NotificationRuleExportData.JSON_PROPERTY_CALCULATED_FIELDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class NotificationRuleExportData {
  ...
  public NotificationRuleExportData addRelationsItem(EntityRelation relationsItem) {
  ...
  public NotificationRuleExportData putAttributesItem(String key, List<AttributeExportData> attributesItem) {
  ...
  public NotificationRuleExportData addCalculatedFieldsItem(CalculatedField calculatedFieldsItem) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationRuleExportData notificationRuleExportData = (NotificationRuleExportData) o;
    return Objects.equals(this.entityType, notificationRuleExportData.entityType) &&
        Objects.equals(this.entity, notificationRuleExportData.entity) &&
        Objects.equals(this.relations, notificationRuleExportData.relations) &&
        Objects.equals(this.attributes, notificationRuleExportData.attributes) &&
        Objects.equals(this.calculatedFields, notificationRuleExportData.calculatedFields);
  }
