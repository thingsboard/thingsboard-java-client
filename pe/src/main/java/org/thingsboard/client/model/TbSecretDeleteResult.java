 ...
 */
@JsonPropertyOrder({
  TbSecretDeleteResult.JSON_PROPERTY_SUCCESS,
  TbSecretDeleteResult.JSON_PROPERTY_REFERENCES
})
...
public class TbSecretDeleteResult {
  ...
  public TbSecretDeleteResult() { 
  }

  public TbSecretDeleteResult success(@javax.annotation.Nullable Boolean success) {
  ...
  public TbSecretDeleteResult references(@javax.annotation.Nullable Map<String, List<EntityInfo>> references) {
    this.references = references;
    return this;
  }

  public TbSecretDeleteResult putReferencesItem(String key, List<EntityInfo> referencesItem) {
  ...
  /**
   * Return true if this TbSecretDeleteResult object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TbSecretDeleteResult tbSecretDeleteResult = (TbSecretDeleteResult) o;
    return Objects.equals(this.success, tbSecretDeleteResult.success) &&
        Objects.equals(this.references, tbSecretDeleteResult.references);
  }
  ...
  public String toString() {
    ...
    sb.append("class TbSecretDeleteResult {\n");
