 ...
 */
@JsonPropertyOrder({
  EntityInfo.JSON_PROPERTY_ID,
  EntityInfo.JSON_PROPERTY_NAME
})
...
public class EntityInfo {
  ...
  public EntityInfo id(@javax.annotation.Nullable EntityId id) {
    this.id = id;
    return this;
  }
  ...
  public EntityInfo name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
