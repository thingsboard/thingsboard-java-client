...
public class GroupPermissionId extends EntityId {
...
static {
  ...
  mappings.put("GroupPermissionId", GroupPermissionId.class);
  JSON.registerDiscriminator(GroupPermissionId.class, "entityType", mappings);
}
}
