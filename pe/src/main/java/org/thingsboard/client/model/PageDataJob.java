 ...
 */
@JsonPropertyOrder({
  PageDataJob.JSON_PROPERTY_DATA,
  PageDataJob.JSON_PROPERTY_TOTAL_PAGES,
  PageDataJob.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataJob.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataJob {
  ...
  public PageDataJob data(@Nullable List<Job> data) {
    this.data = data;
    return this;
  }

  public PageDataJob addDataItem(Job dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<Job> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataJob object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataJob pageDataJob = (PageDataJob) o;
    return Objects.equals(this.data, pageDataJob.data) &&
        Objects.equals(this.totalPages, pageDataJob.totalPages) &&
        Objects.equals(this.totalElements, pageDataJob.totalElements) &&
        Objects.equals(this.hasNext, pageDataJob.hasNext);
  }
