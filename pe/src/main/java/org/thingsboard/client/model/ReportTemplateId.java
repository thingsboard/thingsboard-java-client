...
public class ReportTemplateId extends EntityId {
...
static {
  ...
  mappings.put("ReportTemplateId", ReportTemplateId.class);
  JSON.registerDiscriminator(ReportTemplateId.class, "entityType", mappings);
}
}
