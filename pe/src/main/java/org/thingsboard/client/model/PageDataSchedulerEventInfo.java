 ...
 */
@JsonPropertyOrder({
  PageDataSchedulerEventInfo.JSON_PROPERTY_DATA,
  PageDataSchedulerEventInfo.JSON_PROPERTY_HAS_NEXT,
  PageDataSchedulerEventInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataSchedulerEventInfo.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataSchedulerEventInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<SchedulerEventInfo> data = new ArrayList<>();
  ...
  public PageDataSchedulerEventInfo() { 
  }
  ...
  public PageDataSchedulerEventInfo data(@javax.annotation.Nullable List<SchedulerEventInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataSchedulerEventInfo addDataItem(SchedulerEventInfo dataItem) {
    if (this.data == null) {
  ...
  public List<SchedulerEventInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<SchedulerEventInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataSchedulerEventInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataSchedulerEventInfo pageDataSchedulerEventInfo = (PageDataSchedulerEventInfo) o;
    return Objects.equals(this.data, pageDataSchedulerEventInfo.data) &&
        Objects.equals(this.hasNext, pageDataSchedulerEventInfo.hasNext) &&
        Objects.equals(this.totalElements, pageDataSchedulerEventInfo.totalElements) &&
        Objects.equals(this.totalPages, pageDataSchedulerEventInfo.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataSchedulerEventInfo {\n");
