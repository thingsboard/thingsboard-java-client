...
public class DefaultMenuItem extends MenuItem {
  ...
  public DefaultMenuItem name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public DefaultMenuItem icon(@javax.annotation.Nullable String icon) {
    this.icon = icon;
    return this;
  }
  ...
  @Override
  public DefaultMenuItem type(@javax.annotation.Nonnull MenuItemType type) {
    this.setType(type);
    return this;
  }
