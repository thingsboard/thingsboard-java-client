...
import org.thingsboard.client.model.AmazonBedrockProviderConfig;
...
public class AmazonBedrockChatModelConfig extends AiModelConfig {
  ...
  public AmazonBedrockChatModelConfig providerConfig(@javax.annotation.Nonnull AmazonBedrockProviderConfig providerConfig) {
  ...
  public AmazonBedrockProviderConfig getProviderConfig() {
    return providerConfig;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PROVIDER_CONFIG, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProviderConfig(@javax.annotation.Nonnull AmazonBedrockProviderConfig providerConfig) {
    this.providerConfig = providerConfig;
  }


  public AmazonBedrockChatModelConfig modelId(@javax.annotation.Nonnull String modelId) {
  ...
  public AmazonBedrockChatModelConfig temperature(@javax.annotation.Nullable Double temperature) {
  ...
  public AmazonBedrockChatModelConfig topP(@javax.annotation.Nullable Double topP) {
    this.topP = topP;
    return this;
  }
  ...
  public AmazonBedrockChatModelConfig maxOutputTokens(@javax.annotation.Nullable Integer maxOutputTokens) {
  ...
  public AmazonBedrockChatModelConfig timeoutSeconds(@javax.annotation.Nullable Integer timeoutSeconds) {
  ...
  public AmazonBedrockChatModelConfig maxRetries(@javax.annotation.Nullable Integer maxRetries) {
  ...
  @Override
  public AmazonBedrockChatModelConfig provider(@javax.annotation.Nonnull String provider) {
...
static {
  ...
  mappings.put("AmazonBedrockChatModelConfig", AmazonBedrockChatModelConfig.class);
  JSON.registerDiscriminator(AmazonBedrockChatModelConfig.class, "provider", mappings);
}
}
