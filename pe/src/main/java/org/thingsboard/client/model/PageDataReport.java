 ...
 */
@JsonPropertyOrder({
  PageDataReport.JSON_PROPERTY_DATA,
  PageDataReport.JSON_PROPERTY_TOTAL_PAGES,
  PageDataReport.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataReport.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataReport {
  ...
  public PageDataReport data(@Nullable List<Report> data) {
    this.data = data;
    return this;
  }

  public PageDataReport addDataItem(Report dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<Report> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataReport object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataReport pageDataReport = (PageDataReport) o;
    return Objects.equals(this.data, pageDataReport.data) &&
        Objects.equals(this.totalPages, pageDataReport.totalPages) &&
        Objects.equals(this.totalElements, pageDataReport.totalElements) &&
        Objects.equals(this.hasNext, pageDataReport.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataReport {\n");
