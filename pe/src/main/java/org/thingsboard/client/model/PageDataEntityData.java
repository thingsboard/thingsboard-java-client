 ...
 */
@JsonPropertyOrder({
  PageDataEntityData.JSON_PROPERTY_DATA,
  PageDataEntityData.JSON_PROPERTY_TOTAL_PAGES,
  PageDataEntityData.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataEntityData.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:17:55.932789+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataEntityData {
  ...
  public PageDataEntityData data(@javax.annotation.Nullable List<EntityData> data) {
    this.data = data;
    return this;
  }

  public PageDataEntityData addDataItem(EntityData dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<EntityData> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataEntityData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataEntityData pageDataEntityData = (PageDataEntityData) o;
    return Objects.equals(this.data, pageDataEntityData.data) &&
        Objects.equals(this.totalPages, pageDataEntityData.totalPages) &&
        Objects.equals(this.totalElements, pageDataEntityData.totalElements) &&
        Objects.equals(this.hasNext, pageDataEntityData.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataEntityData {\n");
