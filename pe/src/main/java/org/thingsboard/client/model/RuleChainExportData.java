 ...
 */
@JsonPropertyOrder({
  RuleChainExportData.JSON_PROPERTY_META_DATA
})
...
public class RuleChainExportData extends EntityExportData {
  public static final String JSON_PROPERTY_META_DATA = "metaData";
  @Nullable
  private RuleChainMetaData metaData;

  public RuleChainExportData() { 
  }

  public RuleChainExportData metaData(@Nullable RuleChainMetaData metaData) {
  ...
  @JsonProperty(value = JSON_PROPERTY_META_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMetaData(@Nullable RuleChainMetaData metaData) {
    this.metaData = metaData;
  }


  @Override
  public RuleChainExportData entity(@Nullable ExportableEntity entity) {
    this.setEntity(entity);
    return this;
  }

  @Override
  public RuleChainExportData relations(@Nullable List<EntityRelation> relations) {
    this.setRelations(relations);
    return this;
  }

  @Override
  public RuleChainExportData attributes(@Nullable Map<String, List<AttributeExportData>> attributes) {
    this.setAttributes(attributes);
    return this;
  }

  @Override
  public RuleChainExportData calculatedFields(@Nullable List<CalculatedField> calculatedFields) {
    this.setCalculatedFields(calculatedFields);
    return this;
  }

  @Override
  public RuleChainExportData entityType(@Nonnull EntityType entityType) {
    this.setEntityType(entityType);
    return this;
  }

  /**
   * Return true if this RuleChainExportData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RuleChainExportData ruleChainExportData = (RuleChainExportData) o;
    return Objects.equals(this.metaData, ruleChainExportData.metaData) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class RuleChainExportData {\n");
...
static {
  ...
  mappings.put("RuleChainExportData", RuleChainExportData.class);
  JSON.registerDiscriminator(RuleChainExportData.class, "entityType", mappings);
}
}
