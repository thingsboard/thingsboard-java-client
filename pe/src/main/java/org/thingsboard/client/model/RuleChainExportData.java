...
public class RuleChainExportData extends EntityExportData {
  ...
  public RuleChainExportData metaData(@javax.annotation.Nullable RuleChainMetaData metaData) {
  ...
  @JsonProperty(value = JSON_PROPERTY_META_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMetaData(@javax.annotation.Nullable RuleChainMetaData metaData) {
    this.metaData = metaData;
  }
  ...
  @Override
  public RuleChainExportData relations(@javax.annotation.Nullable List<EntityRelation> relations) {
    this.setRelations(relations);
    return this;
  }

  @Override
  public RuleChainExportData attributes(@javax.annotation.Nullable Map<String, List<AttributeExportData>> attributes) {
