...
public class PageDataBlobEntityWithCustomerInfo {
  ...
  public PageDataBlobEntityWithCustomerInfo data(@Nullable List<BlobEntityWithCustomerInfo> data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<BlobEntityWithCustomerInfo> data) {
    this.data = data;
  }
