...
import org.thingsboard.client.model.BlobEntityWithCustomerInfo;
 ...
 */
@JsonPropertyOrder({
  PageDataBlobEntityWithCustomerInfo.JSON_PROPERTY_DATA,
  PageDataBlobEntityWithCustomerInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataBlobEntityWithCustomerInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataBlobEntityWithCustomerInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:17:55.932789+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataBlobEntityWithCustomerInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<BlobEntityWithCustomerInfo> data = new ArrayList<>();
  ...
  public PageDataBlobEntityWithCustomerInfo() { 
  }
  ...
  public PageDataBlobEntityWithCustomerInfo data(@javax.annotation.Nullable List<BlobEntityWithCustomerInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataBlobEntityWithCustomerInfo addDataItem(BlobEntityWithCustomerInfo dataItem) {
    if (this.data == null) {
  ...
  public List<BlobEntityWithCustomerInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<BlobEntityWithCustomerInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataBlobEntityWithCustomerInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataBlobEntityWithCustomerInfo pageDataBlobEntityWithCustomerInfo = (PageDataBlobEntityWithCustomerInfo) o;
    return Objects.equals(this.data, pageDataBlobEntityWithCustomerInfo.data) &&
        Objects.equals(this.totalPages, pageDataBlobEntityWithCustomerInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataBlobEntityWithCustomerInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataBlobEntityWithCustomerInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataBlobEntityWithCustomerInfo {\n");
