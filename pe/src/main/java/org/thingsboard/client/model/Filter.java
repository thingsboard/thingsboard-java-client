...
public class Filter {
  ...
  public Filter addKeyFiltersItem(KeyFilter keyFiltersItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, filter.id) &&
        Objects.equals(this.filter, filter.filter) &&
        Objects.equals(this.keyFilters, filter.keyFilters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, filter, keyFilters);
  }
