...
public class GoogleAiGeminiChatModelConfig extends AiModelConfig {
  ...
  @JsonProperty(value = JSON_PROPERTY_PROVIDER_CONFIG, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProviderConfig(@Nonnull GoogleAiGeminiProviderConfig providerConfig) {
    this.providerConfig = providerConfig;
  }


  public GoogleAiGeminiChatModelConfig modelId(@Nonnull String modelId) {
  ...
  public GoogleAiGeminiChatModelConfig temperature(@Nullable Double temperature) {
  ...
  public GoogleAiGeminiChatModelConfig topP(@Nullable Double topP) {
    this.topP = topP;
    return this;
  }
  ...
  public GoogleAiGeminiChatModelConfig topK(@Nullable Integer topK) {
    this.topK = topK;
    return this;
  }
  ...
  public GoogleAiGeminiChatModelConfig frequencyPenalty(@Nullable Double frequencyPenalty) {
  ...
  public GoogleAiGeminiChatModelConfig presencePenalty(@Nullable Double presencePenalty) {
  ...
  public GoogleAiGeminiChatModelConfig maxOutputTokens(@Nullable Integer maxOutputTokens) {
  ...
  public GoogleAiGeminiChatModelConfig timeoutSeconds(@Nullable Integer timeoutSeconds) {
  ...
  public GoogleAiGeminiChatModelConfig maxRetries(@Nullable Integer maxRetries) {
  ...
  @Override
  public GoogleAiGeminiChatModelConfig provider(@Nonnull String provider) {
