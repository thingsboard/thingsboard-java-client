...
import org.thingsboard.client.model.GoogleAiGeminiProviderConfig;
...
@JsonPropertyOrder({
  ...
  GoogleAiGeminiChatModelConfig.JSON_PROPERTY_TOP_P,
  GoogleAiGeminiChatModelConfig.JSON_PROPERTY_TOP_K,
  GoogleAiGeminiChatModelConfig.JSON_PROPERTY_FREQUENCY_PENALTY,
...
public class GoogleAiGeminiChatModelConfig extends AiModelConfig {
  ...
  public GoogleAiGeminiChatModelConfig providerConfig(@javax.annotation.Nonnull GoogleAiGeminiProviderConfig providerConfig) {
  ...
  public GoogleAiGeminiProviderConfig getProviderConfig() {
    return providerConfig;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PROVIDER_CONFIG, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProviderConfig(@javax.annotation.Nonnull GoogleAiGeminiProviderConfig providerConfig) {
    this.providerConfig = providerConfig;
  }


  public GoogleAiGeminiChatModelConfig modelId(@javax.annotation.Nonnull String modelId) {
  ...
  public GoogleAiGeminiChatModelConfig temperature(@javax.annotation.Nullable Double temperature) {
  ...
  public GoogleAiGeminiChatModelConfig topP(@javax.annotation.Nullable Double topP) {
    this.topP = topP;
    return this;
  }
  ...
  public GoogleAiGeminiChatModelConfig topK(@javax.annotation.Nullable Integer topK) {
    this.topK = topK;
    return this;
  }
  ...
  public GoogleAiGeminiChatModelConfig frequencyPenalty(@javax.annotation.Nullable Double frequencyPenalty) {
  ...
  public GoogleAiGeminiChatModelConfig presencePenalty(@javax.annotation.Nullable Double presencePenalty) {
  ...
  public GoogleAiGeminiChatModelConfig maxOutputTokens(@javax.annotation.Nullable Integer maxOutputTokens) {
  ...
  public GoogleAiGeminiChatModelConfig timeoutSeconds(@javax.annotation.Nullable Integer timeoutSeconds) {
  ...
  public GoogleAiGeminiChatModelConfig maxRetries(@javax.annotation.Nullable Integer maxRetries) {
  ...
  @Override
  public GoogleAiGeminiChatModelConfig provider(@javax.annotation.Nonnull String provider) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.modelType, googleAiGeminiChatModelConfig.modelType) &&
        ...
        Objects.equals(this.topK, googleAiGeminiChatModelConfig.topK) &&
        Objects.equals(this.frequencyPenalty, googleAiGeminiChatModelConfig.frequencyPenalty) &&
        Objects.equals(this.presencePenalty, googleAiGeminiChatModelConfig.presencePenalty) &&
...
static {
  ...
  mappings.put("GoogleAiGeminiChatModelConfig", GoogleAiGeminiChatModelConfig.class);
  JSON.registerDiscriminator(GoogleAiGeminiChatModelConfig.class, "provider", mappings);
}
}
