...
public class DeviceTypeFilter extends EntityFilter {
  ...
  public DeviceTypeFilter deviceNameFilter(@javax.annotation.Nullable String deviceNameFilter) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DEVICE_NAME_FILTER, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDeviceNameFilter(@javax.annotation.Nullable String deviceNameFilter) {
    this.deviceNameFilter = deviceNameFilter;
  }
