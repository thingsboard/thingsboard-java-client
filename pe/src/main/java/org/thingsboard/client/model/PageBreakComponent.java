...
public class PageBreakComponent extends ReportComponent {
  public PageBreakComponent() { 
  }

  @Override
  public PageBreakComponent subType(@Nonnull ReportComponentSubType subType) {
  ...
  public String toString() {
    ...
    sb.append("class PageBreakComponent {\n");
...
static {
  ...
  mappings.put("PageBreakComponent", PageBreakComponent.class);
  JSON.registerDiscriminator(PageBreakComponent.class, "type", mappings);
}
}
