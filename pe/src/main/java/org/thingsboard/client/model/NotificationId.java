 ...
 */
@JsonPropertyOrder({
  NotificationId.JSON_PROPERTY_ID,
  NotificationId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class NotificationId {
  ...
  public NotificationId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public NotificationId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this NotificationId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, notificationId.id) &&
        Objects.equals(this.entityType, notificationId.entityType);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationId {\n");
