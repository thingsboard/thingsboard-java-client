...
public class ReportTemplateConfig {
  ...
  public ReportTemplateConfig namePattern(@Nullable String namePattern) {
  ...
  public ReportTemplateConfig timeDataPattern(@Nullable String timeDataPattern) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TIME_DATA_PATTERN, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTimeDataPattern(@Nullable String timeDataPattern) {
    this.timeDataPattern = timeDataPattern;
  }


  public ReportTemplateConfig format(@Nonnull TbReportFormat format) {
    this.format = format;
    return this;
  }
  ...
  public ReportTemplateConfig entityAliases(@Nullable List<EntityAlias> entityAliases) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENTITY_ALIASES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityAliases(@Nullable List<EntityAlias> entityAliases) {
    this.entityAliases = entityAliases;
  }


  public ReportTemplateConfig filters(@Nullable List<Filter> filters) {
  ...
  public ReportTemplateConfig components(@Nullable List<ReportComponent> components) {
  ...
  @JsonProperty(value = JSON_PROPERTY_COMPONENTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setComponents(@Nullable List<ReportComponent> components) {
    this.components = components;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(namePattern, timeDataPattern, format, entityAliases, filters, components);
  }
