...
public class SlackDeliveryMethodNotificationTemplate extends DeliveryMethodNotificationTemplate {
  ...
  @Override
  public SlackDeliveryMethodNotificationTemplate enabled(@javax.annotation.Nullable Boolean enabled) {
    this.setEnabled(enabled);
    return this;
  }

  @Override
  public SlackDeliveryMethodNotificationTemplate body(@javax.annotation.Nonnull String body) {
    this.setBody(body);
    return this;
  }

  @Override
  public SlackDeliveryMethodNotificationTemplate method(@javax.annotation.Nonnull String method) {
  ...
  public String toString() {
    ...
    sb.append("class SlackDeliveryMethodNotificationTemplate {\n");
...
static {
  ...
  mappings.put("SlackDeliveryMethodNotificationTemplate", SlackDeliveryMethodNotificationTemplate.class);
  JSON.registerDiscriminator(SlackDeliveryMethodNotificationTemplate.class, "method", mappings);
}
}
