...
public class WidgetTypeDetails {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fqn, widgetTypeDetails.fqn) &&
        ...
        Objects.equals(this.id, widgetTypeDetails.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fqn, name, deprecated, image, description, descriptor, resources, id, createdTime, tenantId, scada, version, tags);
  }
