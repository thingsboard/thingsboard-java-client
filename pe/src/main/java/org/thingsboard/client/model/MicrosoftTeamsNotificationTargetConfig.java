...
public class MicrosoftTeamsNotificationTargetConfig extends NotificationTargetConfig {
  ...
  public MicrosoftTeamsNotificationTargetConfig webhookUrl(@Nonnull String webhookUrl) {
  ...
  @JsonProperty(value = JSON_PROPERTY_WEBHOOK_URL, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setWebhookUrl(@Nonnull String webhookUrl) {
    this.webhookUrl = webhookUrl;
  }


  public MicrosoftTeamsNotificationTargetConfig channelName(@Nonnull String channelName) {
  ...
  public MicrosoftTeamsNotificationTargetConfig useOldApi(@Nullable Boolean useOldApi) {
  ...
  @JsonProperty(value = JSON_PROPERTY_USE_OLD_API, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUseOldApi(@Nullable Boolean useOldApi) {
    this.useOldApi = useOldApi;
  }


  public MicrosoftTeamsNotificationTargetConfig email(@Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public MicrosoftTeamsNotificationTargetConfig firstName(@Nullable String firstName) {
  ...
  public MicrosoftTeamsNotificationTargetConfig id(@Nullable Object id) {
  ...
  public MicrosoftTeamsNotificationTargetConfig lastName(@Nullable String lastName) {
  ...
  public MicrosoftTeamsNotificationTargetConfig title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  @Override
  public MicrosoftTeamsNotificationTargetConfig description(@Nullable String description) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(webhookUrl, channelName, useOldApi, email, firstName, hashCodeNullable(id), lastName, title, super.hashCode());
  }
