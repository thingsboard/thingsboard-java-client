 ...
 */
@JsonPropertyOrder({
  PageDataNotificationTarget.JSON_PROPERTY_DATA,
  PageDataNotificationTarget.JSON_PROPERTY_TOTAL_PAGES,
  PageDataNotificationTarget.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataNotificationTarget.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:17:55.932789+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataNotificationTarget {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<NotificationTarget> data = new ArrayList<>();
  ...
  public PageDataNotificationTarget() { 
  }
  ...
  public PageDataNotificationTarget data(@javax.annotation.Nullable List<NotificationTarget> data) {
    this.data = data;
    return this;
  }

  public PageDataNotificationTarget addDataItem(NotificationTarget dataItem) {
    if (this.data == null) {
  ...
  public List<NotificationTarget> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<NotificationTarget> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataNotificationTarget object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataNotificationTarget pageDataNotificationTarget = (PageDataNotificationTarget) o;
    return Objects.equals(this.data, pageDataNotificationTarget.data) &&
        Objects.equals(this.totalPages, pageDataNotificationTarget.totalPages) &&
        Objects.equals(this.totalElements, pageDataNotificationTarget.totalElements) &&
        Objects.equals(this.hasNext, pageDataNotificationTarget.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataNotificationTarget {\n");
