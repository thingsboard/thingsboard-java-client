...
public class Dashboard {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, image, mobileHide, mobileOrder, _configuration, name, resources, assignedCustomers, createdTime, customerId, id, ownerId, tenantId, version);
  }
