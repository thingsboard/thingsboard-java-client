...
public class Dashboard {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdTime, tenantId, customerId, title, image, assignedCustomers, mobileHide, mobileOrder, version, resources, _configuration, name, ownerId);
  }
