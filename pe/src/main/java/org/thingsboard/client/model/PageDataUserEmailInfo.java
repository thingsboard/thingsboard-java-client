 ...
 */
@JsonPropertyOrder({
  PageDataUserEmailInfo.JSON_PROPERTY_DATA,
  PageDataUserEmailInfo.JSON_PROPERTY_HAS_NEXT,
  PageDataUserEmailInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataUserEmailInfo.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataUserEmailInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<UserEmailInfo> data = new ArrayList<>();
  ...
  public PageDataUserEmailInfo data(@javax.annotation.Nullable List<UserEmailInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataUserEmailInfo addDataItem(UserEmailInfo dataItem) {
    if (this.data == null) {
  ...
  public List<UserEmailInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<UserEmailInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataUserEmailInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataUserEmailInfo pageDataUserEmailInfo = (PageDataUserEmailInfo) o;
    return Objects.equals(this.data, pageDataUserEmailInfo.data) &&
        Objects.equals(this.hasNext, pageDataUserEmailInfo.hasNext) &&
        Objects.equals(this.totalElements, pageDataUserEmailInfo.totalElements) &&
        Objects.equals(this.totalPages, pageDataUserEmailInfo.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataUserEmailInfo {\n");
