...
import org.thingsboard.client.model.TrendzViewConfigLite;
 ...
 */
@JsonPropertyOrder({
  PageDataTrendzViewConfigLite.JSON_PROPERTY_DATA,
  PageDataTrendzViewConfigLite.JSON_PROPERTY_TOTAL_PAGES,
...
public class PageDataTrendzViewConfigLite {
  ...
  public PageDataTrendzViewConfigLite addDataItem(TrendzViewConfigLite dataItem) {
    if (this.data == null) {
  ...
  /**
   * Return true if this PageDataTrendzViewConfigLite object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataTrendzViewConfigLite pageDataTrendzViewConfigLite = (PageDataTrendzViewConfigLite) o;
    return Objects.equals(this.data, pageDataTrendzViewConfigLite.data) &&
        Objects.equals(this.totalPages, pageDataTrendzViewConfigLite.totalPages) &&
        Objects.equals(this.totalElements, pageDataTrendzViewConfigLite.totalElements) &&
        Objects.equals(this.hasNext, pageDataTrendzViewConfigLite.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataTrendzViewConfigLite {\n");
