 ...
 */
@JsonPropertyOrder({
  PageDataApiKeyInfo.JSON_PROPERTY_DATA,
  PageDataApiKeyInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataApiKeyInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataApiKeyInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:17:55.932789+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataApiKeyInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<ApiKeyInfo> data = new ArrayList<>();
  ...
  public PageDataApiKeyInfo data(@javax.annotation.Nullable List<ApiKeyInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataApiKeyInfo addDataItem(ApiKeyInfo dataItem) {
    if (this.data == null) {
  ...
  public List<ApiKeyInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<ApiKeyInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataApiKeyInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataApiKeyInfo pageDataApiKeyInfo = (PageDataApiKeyInfo) o;
    return Objects.equals(this.data, pageDataApiKeyInfo.data) &&
        Objects.equals(this.totalPages, pageDataApiKeyInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataApiKeyInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataApiKeyInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataApiKeyInfo {\n");
