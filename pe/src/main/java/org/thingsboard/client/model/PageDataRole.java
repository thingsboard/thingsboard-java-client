 ...
 */
@JsonPropertyOrder({
  PageDataRole.JSON_PROPERTY_DATA,
  PageDataRole.JSON_PROPERTY_TOTAL_PAGES,
  PageDataRole.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataRole.JSON_PROPERTY_HAS_NEXT
})
@Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataRole {
  ...
  public PageDataRole data(@Nullable List<Role> data) {
    this.data = data;
    return this;
  }

  public PageDataRole addDataItem(Role dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<Role> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataRole object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataRole pageDataRole = (PageDataRole) o;
    return Objects.equals(this.data, pageDataRole.data) &&
        Objects.equals(this.totalPages, pageDataRole.totalPages) &&
        Objects.equals(this.totalElements, pageDataRole.totalElements) &&
        Objects.equals(this.hasNext, pageDataRole.hasNext);
  }
