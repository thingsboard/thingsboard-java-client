...
public class GetManagedRelatedEntityIds200ResponseInner extends AbstractOpenApiSchema {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getActualInstance() instanceof BlobEntityId) {
        if (getActualInstance() != null) {
          joiner.add(((BlobEntityId)getActualInstance()).toUrlQueryString(prefix + "one_of_14" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof CalculatedFieldId) {
        if (getActualInstance() != null) {
          joiner.add(((CalculatedFieldId)getActualInstance()).toUrlQueryString(prefix + "one_of_15" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof ConverterId) {
        if (getActualInstance() != null) {
          joiner.add(((ConverterId)getActualInstance()).toUrlQueryString(prefix + "one_of_16" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof CustomerId) {
        if (getActualInstance() != null) {
          joiner.add(((CustomerId)getActualInstance()).toUrlQueryString(prefix + "one_of_17" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof DashboardId) {
        if (getActualInstance() != null) {
          joiner.add(((DashboardId)getActualInstance()).toUrlQueryString(prefix + "one_of_18" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof DeviceId) {
        if (getActualInstance() != null) {
          joiner.add(((DeviceId)getActualInstance()).toUrlQueryString(prefix + "one_of_19" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof DeviceProfileId) {
        if (getActualInstance() != null) {
          joiner.add(((DeviceProfileId)getActualInstance()).toUrlQueryString(prefix + "one_of_20" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof DomainId) {
        if (getActualInstance() != null) {
          joiner.add(((DomainId)getActualInstance()).toUrlQueryString(prefix + "one_of_21" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof EdgeId) {
        if (getActualInstance() != null) {
          joiner.add(((EdgeId)getActualInstance()).toUrlQueryString(prefix + "one_of_22" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof EntityGroupId) {
        if (getActualInstance() != null) {
          joiner.add(((EntityGroupId)getActualInstance()).toUrlQueryString(prefix + "one_of_23" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof EntityViewId) {
        if (getActualInstance() != null) {
          joiner.add(((EntityViewId)getActualInstance()).toUrlQueryString(prefix + "one_of_24" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof GroupPermissionId) {
        if (getActualInstance() != null) {
          joiner.add(((GroupPermissionId)getActualInstance()).toUrlQueryString(prefix + "one_of_25" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof IntegrationId) {
        if (getActualInstance() != null) {
          joiner.add(((IntegrationId)getActualInstance()).toUrlQueryString(prefix + "one_of_26" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof JobId) {
        if (getActualInstance() != null) {
          joiner.add(((JobId)getActualInstance()).toUrlQueryString(prefix + "one_of_27" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof MobileAppBundleId) {
        if (getActualInstance() != null) {
          joiner.add(((MobileAppBundleId)getActualInstance()).toUrlQueryString(prefix + "one_of_28" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof MobileAppId) {
        if (getActualInstance() != null) {
          joiner.add(((MobileAppId)getActualInstance()).toUrlQueryString(prefix + "one_of_29" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof NotificationId) {
        if (getActualInstance() != null) {
          joiner.add(((NotificationId)getActualInstance()).toUrlQueryString(prefix + "one_of_30" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof NotificationRequestId) {
        if (getActualInstance() != null) {
          joiner.add(((NotificationRequestId)getActualInstance()).toUrlQueryString(prefix + "one_of_31" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof NotificationRuleId) {
        if (getActualInstance() != null) {
          joiner.add(((NotificationRuleId)getActualInstance()).toUrlQueryString(prefix + "one_of_32" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof NotificationTargetId) {
        if (getActualInstance() != null) {
          joiner.add(((NotificationTargetId)getActualInstance()).toUrlQueryString(prefix + "one_of_33" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof NotificationTemplateId) {
        if (getActualInstance() != null) {
          joiner.add(((NotificationTemplateId)getActualInstance()).toUrlQueryString(prefix + "one_of_34" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof OAuth2ClientId) {
        if (getActualInstance() != null) {
          joiner.add(((OAuth2ClientId)getActualInstance()).toUrlQueryString(prefix + "one_of_35" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof OtaPackageId) {
        if (getActualInstance() != null) {
          joiner.add(((OtaPackageId)getActualInstance()).toUrlQueryString(prefix + "one_of_36" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof QueueId) {
        if (getActualInstance() != null) {
          joiner.add(((QueueId)getActualInstance()).toUrlQueryString(prefix + "one_of_37" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof QueueStatsId) {
        if (getActualInstance() != null) {
          joiner.add(((QueueStatsId)getActualInstance()).toUrlQueryString(prefix + "one_of_38" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof ReportId) {
        if (getActualInstance() != null) {
          joiner.add(((ReportId)getActualInstance()).toUrlQueryString(prefix + "one_of_39" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof ReportTemplateId) {
        if (getActualInstance() != null) {
          joiner.add(((ReportTemplateId)getActualInstance()).toUrlQueryString(prefix + "one_of_40" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof RoleId) {
        if (getActualInstance() != null) {
          joiner.add(((RoleId)getActualInstance()).toUrlQueryString(prefix + "one_of_41" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof RpcId) {
        if (getActualInstance() != null) {
          joiner.add(((RpcId)getActualInstance()).toUrlQueryString(prefix + "one_of_42" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof RuleChainId) {
        if (getActualInstance() != null) {
          joiner.add(((RuleChainId)getActualInstance()).toUrlQueryString(prefix + "one_of_43" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof RuleNodeId) {
        if (getActualInstance() != null) {
          joiner.add(((RuleNodeId)getActualInstance()).toUrlQueryString(prefix + "one_of_44" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof SchedulerEventId) {
        if (getActualInstance() != null) {
          joiner.add(((SchedulerEventId)getActualInstance()).toUrlQueryString(prefix + "one_of_45" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof SecretId) {
        if (getActualInstance() != null) {
          joiner.add(((SecretId)getActualInstance()).toUrlQueryString(prefix + "one_of_46" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof TbResourceId) {
        if (getActualInstance() != null) {
          joiner.add(((TbResourceId)getActualInstance()).toUrlQueryString(prefix + "one_of_47" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof TenantId) {
        if (getActualInstance() != null) {
          joiner.add(((TenantId)getActualInstance()).toUrlQueryString(prefix + "one_of_48" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof TenantProfileId) {
        if (getActualInstance() != null) {
          joiner.add(((TenantProfileId)getActualInstance()).toUrlQueryString(prefix + "one_of_49" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof UserId) {
        if (getActualInstance() != null) {
          joiner.add(((UserId)getActualInstance()).toUrlQueryString(prefix + "one_of_50" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof WidgetTypeId) {
        if (getActualInstance() != null) {
          joiner.add(((WidgetTypeId)getActualInstance()).toUrlQueryString(prefix + "one_of_51" + suffix));
        }
        return joiner.toString();
    }
    if (getActualInstance() instanceof WidgetsBundleId) {
        if (getActualInstance() != null) {
          joiner.add(((WidgetsBundleId)getActualInstance()).toUrlQueryString(prefix + "one_of_52" + suffix));
        }
        return joiner.toString();
    }
    return null;
