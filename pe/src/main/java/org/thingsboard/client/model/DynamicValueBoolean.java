...
public class DynamicValueBoolean {
  ...
  public DynamicValueBoolean resolvedValue(@Nullable Boolean resolvedValue) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RESOLVED_VALUE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResolvedValue(@Nullable Boolean resolvedValue) {
    this.resolvedValue = resolvedValue;
  }


  public DynamicValueBoolean sourceType(@Nullable DynamicValueSourceType sourceType) {
  ...
  public DynamicValueBoolean sourceAttribute(@Nullable String sourceAttribute) {
  ...
  public DynamicValueBoolean inherit(@Nullable Boolean inherit) {
