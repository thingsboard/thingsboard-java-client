 ...
 */
@JsonPropertyOrder({
  RawDataEventFilter.JSON_PROPERTY_SERVER,
  RawDataEventFilter.JSON_PROPERTY_UUID,
  RawDataEventFilter.JSON_PROPERTY_MESSAGE_TYPE,
  RawDataEventFilter.JSON_PROPERTY_MESSAGE
})
...
public class RawDataEventFilter extends EventFilter {
  ...
  public RawDataEventFilter server(@javax.annotation.Nullable String server) {
    this.server = server;
    return this;
  }
  ...
  public RawDataEventFilter uuid(@javax.annotation.Nullable String uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public RawDataEventFilter messageType(@javax.annotation.Nullable String messageType) {
  ...
  public RawDataEventFilter message(@javax.annotation.Nullable String message) {
  ...
  @Override
  public RawDataEventFilter eventType(@javax.annotation.Nonnull EventType eventType) {
    this.setEventType(eventType);
    return this;
  }

  @Override
  public RawDataEventFilter notEmpty(@javax.annotation.Nullable Boolean notEmpty) {
    this.setNotEmpty(notEmpty);
    return this;
  }

  /**
   * Return true if this RawDataEventFilter object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RawDataEventFilter rawDataEventFilter = (RawDataEventFilter) o;
    return Objects.equals(this.server, rawDataEventFilter.server) &&
        Objects.equals(this.uuid, rawDataEventFilter.uuid) &&
        Objects.equals(this.messageType, rawDataEventFilter.messageType) &&
        Objects.equals(this.message, rawDataEventFilter.message) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(server, uuid, messageType, message, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RawDataEventFilter {\n");
...
static {
  ...
  JSON.registerDiscriminator(RawDataEventFilter.class, "eventType", mappings);
}
}
