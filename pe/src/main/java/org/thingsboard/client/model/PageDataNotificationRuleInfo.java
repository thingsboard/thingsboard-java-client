 ...
 */
@JsonPropertyOrder({
  PageDataNotificationRuleInfo.JSON_PROPERTY_DATA,
  PageDataNotificationRuleInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataNotificationRuleInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataNotificationRuleInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-02-24T16:17:55.932789+02:00[Europe/Kiev]", comments = "Generator version: 7.20.0")
public class PageDataNotificationRuleInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<NotificationRuleInfo> data = new ArrayList<>();
  ...
  public PageDataNotificationRuleInfo() { 
  }
  ...
  public PageDataNotificationRuleInfo data(@javax.annotation.Nullable List<NotificationRuleInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataNotificationRuleInfo addDataItem(NotificationRuleInfo dataItem) {
    if (this.data == null) {
  ...
  public List<NotificationRuleInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<NotificationRuleInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataNotificationRuleInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataNotificationRuleInfo pageDataNotificationRuleInfo = (PageDataNotificationRuleInfo) o;
    return Objects.equals(this.data, pageDataNotificationRuleInfo.data) &&
        Objects.equals(this.totalPages, pageDataNotificationRuleInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataNotificationRuleInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataNotificationRuleInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataNotificationRuleInfo {\n");
