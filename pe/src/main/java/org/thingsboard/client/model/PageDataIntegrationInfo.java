...
import org.thingsboard.client.model.IntegrationInfo;
 ...
 */
@JsonPropertyOrder({
  PageDataIntegrationInfo.JSON_PROPERTY_DATA,
  PageDataIntegrationInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataIntegrationInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataIntegrationInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataIntegrationInfo {
  ...
  public PageDataIntegrationInfo() { 
  }
  ...
  public PageDataIntegrationInfo data(@javax.annotation.Nullable List<IntegrationInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataIntegrationInfo addDataItem(IntegrationInfo dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<IntegrationInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataIntegrationInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataIntegrationInfo pageDataIntegrationInfo = (PageDataIntegrationInfo) o;
    return Objects.equals(this.data, pageDataIntegrationInfo.data) &&
        Objects.equals(this.totalPages, pageDataIntegrationInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataIntegrationInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataIntegrationInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataIntegrationInfo {\n");
