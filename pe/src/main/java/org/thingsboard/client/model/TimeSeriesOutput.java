...
public class TimeSeriesOutput extends Output {
  ...
  @Override
  public TimeSeriesOutput decimalsByDefault(@javax.annotation.Nullable Integer decimalsByDefault) {
  ...
  @Override
  public TimeSeriesOutput scope(@javax.annotation.Nullable AttributeScope scope) {
    this.setScope(scope);
    return this;
  }
  ...
  /**
   * Return true if this TimeSeriesOutput object is equal to o.
   */
  @Override
...
static {
  ...
  mappings.put("TimeSeriesOutput", TimeSeriesOutput.class);
  JSON.registerDiscriminator(TimeSeriesOutput.class, "type", mappings);
}
}
