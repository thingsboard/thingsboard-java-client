 ...
 */
@JsonPropertyOrder({
  DashboardExportData.JSON_PROPERTY_ENTITY_TYPE,
  DashboardExportData.JSON_PROPERTY_ENTITY,
  DashboardExportData.JSON_PROPERTY_RELATIONS,
  DashboardExportData.JSON_PROPERTY_ATTRIBUTES,
  DashboardExportData.JSON_PROPERTY_CALCULATED_FIELDS
})
...
public class DashboardExportData {
  ...
  public DashboardExportData entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  public DashboardExportData entity(@javax.annotation.Nullable ExportableEntity entity) {
    this.entity = entity;
    return this;
  }
  ...
  public DashboardExportData relations(@javax.annotation.Nullable List<EntityRelation> relations) {
    this.relations = relations;
    return this;
  }

  public DashboardExportData addRelationsItem(EntityRelation relationsItem) {
  ...
  public DashboardExportData attributes(@javax.annotation.Nullable Map<String, List<AttributeExportData>> attributes) {
    this.attributes = attributes;
    return this;
  }

  public DashboardExportData putAttributesItem(String key, List<AttributeExportData> attributesItem) {
  ...
  public DashboardExportData calculatedFields(@javax.annotation.Nullable List<CalculatedField> calculatedFields) {
    this.calculatedFields = calculatedFields;
    return this;
  }

  public DashboardExportData addCalculatedFieldsItem(CalculatedField calculatedFieldsItem) {
  ...
  /**
   * Return true if this DashboardExportData object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardExportData dashboardExportData = (DashboardExportData) o;
    return Objects.equals(this.entityType, dashboardExportData.entityType) &&
        Objects.equals(this.entity, dashboardExportData.entity) &&
        Objects.equals(this.relations, dashboardExportData.relations) &&
        Objects.equals(this.attributes, dashboardExportData.attributes) &&
        Objects.equals(this.calculatedFields, dashboardExportData.calculatedFields);
  }
