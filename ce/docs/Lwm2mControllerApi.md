...
Device saveLwm2mDeviceWithCredentials(SaveLwm2mDeviceWithCredentialsArgs args) // Save LwM2M device with credentials (saveLwm2mDeviceWithCredentials) (Deprecated)
```
