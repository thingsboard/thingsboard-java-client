...
public class Lwm2mDeviceTransportConfiguration extends DeviceTransportConfiguration {
  ...
  public Lwm2mDeviceTransportConfiguration powerMode(@Nullable PowerMode powerMode) {
  ...
  public Lwm2mDeviceTransportConfiguration psmActivityTimer(@Nullable Long psmActivityTimer) {
  ...
  public Lwm2mDeviceTransportConfiguration edrxCycle(@Nullable Long edrxCycle) {
  ...
  public Lwm2mDeviceTransportConfiguration pagingTransmissionWindow(@Nullable Long pagingTransmissionWindow) {
  ...
  @Override
  public Lwm2mDeviceTransportConfiguration type(@Nonnull String type) {
    this.setType(type);
    return this;
  }
