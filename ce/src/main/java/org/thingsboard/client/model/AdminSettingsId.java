...
public class AdminSettingsId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.ADMIN_SETTINGS;
...
static {
  ...
  mappings.put("AdminSettingsId", AdminSettingsId.class);
  JSON.registerDiscriminator(AdminSettingsId.class, "entityType", mappings);
}
}
