...
public class AlarmRuleStringFilterPredicate extends AlarmRuleKeyFilterPredicate {
  ...
  @JsonProperty(value = JSON_PROPERTY_OPERATION, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOperation(@javax.annotation.Nonnull StringOperation operation) {
    this.operation = operation;
  }


  public AlarmRuleStringFilterPredicate value(@javax.annotation.Nonnull AlarmConditionValueString value) {
    this.value = value;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_VALUE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setValue(@javax.annotation.Nonnull AlarmConditionValueString value) {
    this.value = value;
  }
