...
public class NotificationTemplateId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.NOTIFICATION_TEMPLATE;
...
static {
  ...
  mappings.put("NotificationTemplateId", NotificationTemplateId.class);
  JSON.registerDiscriminator(NotificationTemplateId.class, "entityType", mappings);
}
}
