...
public class DashboardId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.DASHBOARD;
...
static {
  ...
  mappings.put("DashboardId", DashboardId.class);
  JSON.registerDiscriminator(DashboardId.class, "entityType", mappings);
}
}
