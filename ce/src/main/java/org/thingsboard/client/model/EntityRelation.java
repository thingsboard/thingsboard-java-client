 ...
 */
@JsonPropertyOrder({
  EntityRelation.JSON_PROPERTY_FROM,
  EntityRelation.JSON_PROPERTY_TO,
  EntityRelation.JSON_PROPERTY_TYPE,
  EntityRelation.JSON_PROPERTY_TYPE_GROUP,
  EntityRelation.JSON_PROPERTY_VERSION,
  EntityRelation.JSON_PROPERTY_ADDITIONAL_INFO
})
...
public class EntityRelation {
  ...
  public EntityRelation from(@javax.annotation.Nonnull EntityId from) {
    this.from = from;
    return this;
  }
  ...
  public EntityRelation to(@javax.annotation.Nonnull EntityId to) {
    this.to = to;
    return this;
  }
  ...
  public EntityRelation type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public EntityRelation typeGroup(@javax.annotation.Nonnull RelationTypeGroup typeGroup) {
  ...
  public EntityRelation version(@javax.annotation.Nullable Long version) {
  ...
  public EntityRelation additionalInfo(@javax.annotation.Nullable com.fasterxml.jackson.databind.JsonNode additionalInfo) {
  ...
  /**
   * Return true if this EntityRelation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.from, entityRelation.from) &&
        Objects.equals(this.to, entityRelation.to) &&
        Objects.equals(this.type, entityRelation.type) &&
        Objects.equals(this.typeGroup, entityRelation.typeGroup) &&
        Objects.equals(this.version, entityRelation.version) &&
        Objects.equals(this.additionalInfo, entityRelation.additionalInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(from, to, type, typeGroup, version, additionalInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EntityRelation {\n");
