...
public class TelemetryEntityView {
  ...
  public TelemetryEntityView addTimeseriesItem(String timeseriesItem) {
  ...
  /**
   * Return true if this TelemetryEntityView object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TelemetryEntityView telemetryEntityView = (TelemetryEntityView) o;
    return Objects.equals(this.timeseries, telemetryEntityView.timeseries) &&
        Objects.equals(this.attributes, telemetryEntityView.attributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timeseries, attributes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TelemetryEntityView {\n");
    ...
    if (getTimeseries() != null) {
      for (int i = 0; i < getTimeseries().size(); i++) {
        joiner.add(String.format(java.util.Locale.ROOT, "%stimeseries%s%s=%s", prefix, suffix,
            ...
            ApiClient.urlEncode(ApiClient.valueToString(getTimeseries().get(i)))));
      }
    }
