...
public class TbResourceId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.TB_RESOURCE;
...
static {
  ...
  mappings.put("TbResourceId", TbResourceId.class);
  JSON.registerDiscriminator(TbResourceId.class, "entityType", mappings);
}
}
