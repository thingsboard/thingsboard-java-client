 ...
 */
@JsonPropertyOrder({
  PageDataTbResourceInfo.JSON_PROPERTY_DATA,
  PageDataTbResourceInfo.JSON_PROPERTY_HAS_NEXT,
  PageDataTbResourceInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataTbResourceInfo.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataTbResourceInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<TbResourceInfo> data = new ArrayList<>();
  ...
  public PageDataTbResourceInfo data(@javax.annotation.Nullable List<TbResourceInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataTbResourceInfo addDataItem(TbResourceInfo dataItem) {
    if (this.data == null) {
  ...
  public List<TbResourceInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<TbResourceInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataTbResourceInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataTbResourceInfo pageDataTbResourceInfo = (PageDataTbResourceInfo) o;
    return Objects.equals(this.data, pageDataTbResourceInfo.data) &&
        Objects.equals(this.hasNext, pageDataTbResourceInfo.hasNext) &&
        Objects.equals(this.totalElements, pageDataTbResourceInfo.totalElements) &&
        Objects.equals(this.totalPages, pageDataTbResourceInfo.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataTbResourceInfo {\n");
