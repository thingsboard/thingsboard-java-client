...
public class MistralAiChatModelConfig extends AiModelConfig {
  ...
  @JsonProperty(value = JSON_PROPERTY_PROVIDER_CONFIG, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProviderConfig(@Nonnull MistralAiProviderConfig providerConfig) {
    this.providerConfig = providerConfig;
  }


  public MistralAiChatModelConfig modelId(@Nonnull String modelId) {
  ...
  public MistralAiChatModelConfig temperature(@Nullable Double temperature) {
  ...
  public MistralAiChatModelConfig topP(@Nullable Double topP) {
    this.topP = topP;
    return this;
  }
  ...
  public MistralAiChatModelConfig frequencyPenalty(@Nullable Double frequencyPenalty) {
  ...
  public MistralAiChatModelConfig presencePenalty(@Nullable Double presencePenalty) {
  ...
  public MistralAiChatModelConfig maxOutputTokens(@Nullable Integer maxOutputTokens) {
  ...
  public MistralAiChatModelConfig timeoutSeconds(@Nullable Integer timeoutSeconds) {
  ...
  public MistralAiChatModelConfig maxRetries(@Nullable Integer maxRetries) {
