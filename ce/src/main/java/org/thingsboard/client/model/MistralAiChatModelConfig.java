...
import org.thingsboard.client.model.MistralAiProviderConfig;
...
@JsonPropertyOrder({
  ...
  MistralAiChatModelConfig.JSON_PROPERTY_TOP_P,
  MistralAiChatModelConfig.JSON_PROPERTY_FREQUENCY_PENALTY,
...
public class MistralAiChatModelConfig extends AiModelConfig {
  ...
  public MistralAiChatModelConfig providerConfig(@javax.annotation.Nonnull MistralAiProviderConfig providerConfig) {
  ...
  public MistralAiProviderConfig getProviderConfig() {
    return providerConfig;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PROVIDER_CONFIG, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProviderConfig(@javax.annotation.Nonnull MistralAiProviderConfig providerConfig) {
    this.providerConfig = providerConfig;
  }


  public MistralAiChatModelConfig modelId(@javax.annotation.Nonnull String modelId) {
  ...
  public MistralAiChatModelConfig temperature(@javax.annotation.Nullable Double temperature) {
  ...
  public MistralAiChatModelConfig topP(@javax.annotation.Nullable Double topP) {
    this.topP = topP;
    return this;
  }
  ...
  public MistralAiChatModelConfig frequencyPenalty(@javax.annotation.Nullable Double frequencyPenalty) {
  ...
  public MistralAiChatModelConfig presencePenalty(@javax.annotation.Nullable Double presencePenalty) {
  ...
  public MistralAiChatModelConfig maxOutputTokens(@javax.annotation.Nullable Integer maxOutputTokens) {
  ...
  public MistralAiChatModelConfig timeoutSeconds(@javax.annotation.Nullable Integer timeoutSeconds) {
  ...
  public MistralAiChatModelConfig maxRetries(@javax.annotation.Nullable Integer maxRetries) {
  ...
  @Override
  public MistralAiChatModelConfig provider(@javax.annotation.Nonnull String provider) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.modelType, mistralAiChatModelConfig.modelType) &&
        ...
        Objects.equals(this.frequencyPenalty, mistralAiChatModelConfig.frequencyPenalty) &&
        Objects.equals(this.presencePenalty, mistralAiChatModelConfig.presencePenalty) &&
...
static {
  ...
  mappings.put("MistralAiChatModelConfig", MistralAiChatModelConfig.class);
  JSON.registerDiscriminator(MistralAiChatModelConfig.class, "provider", mappings);
}
}
