...
@JsonPropertyOrder({
  ...
  ApiUsageStateId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class ApiUsageStateId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.API_USAGE_STATE;

  public ApiUsageStateId() { 
  }
  ...
  public ApiUsageStateId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  /**
   * Return true if this ApiUsageStateId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ApiUsageStateId apiUsageStateId = (ApiUsageStateId) o;
    return Objects.equals(this.id, apiUsageStateId.id) &&
        Objects.equals(this.entityType, apiUsageStateId.entityType) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiUsageStateId {\n");
...
static {
  ...
  mappings.put("ApiUsageStateId", ApiUsageStateId.class);
  JSON.registerDiscriminator(ApiUsageStateId.class, "entityType", mappings);
}
}
