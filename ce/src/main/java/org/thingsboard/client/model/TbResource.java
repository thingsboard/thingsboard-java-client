...
public class TbResource {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdTime, tenantId, title, resourceType, resourceSubType, resourceKey, publicResourceKey, etag, fileName, descriptor, publicLink, name, _public, link, data, preview);
  }
