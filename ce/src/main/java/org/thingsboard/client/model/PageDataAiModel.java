 ...
 */
@JsonPropertyOrder({
  PageDataAiModel.JSON_PROPERTY_DATA,
  PageDataAiModel.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAiModel.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAiModel.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataAiModel {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<AiModel> data = new ArrayList<>();
  ...
  public PageDataAiModel data(@javax.annotation.Nullable List<AiModel> data) {
    this.data = data;
    return this;
  }

  public PageDataAiModel addDataItem(AiModel dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<AiModel> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAiModel object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAiModel pageDataAiModel = (PageDataAiModel) o;
    return Objects.equals(this.data, pageDataAiModel.data) &&
        Objects.equals(this.totalPages, pageDataAiModel.totalPages) &&
        Objects.equals(this.totalElements, pageDataAiModel.totalElements) &&
        Objects.equals(this.hasNext, pageDataAiModel.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAiModel {\n");
