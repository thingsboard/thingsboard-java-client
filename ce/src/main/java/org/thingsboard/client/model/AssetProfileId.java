...
public class AssetProfileId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.ASSET_PROFILE;
...
static {
  ...
  mappings.put("AssetProfileId", AssetProfileId.class);
  JSON.registerDiscriminator(AssetProfileId.class, "entityType", mappings);
}
}
