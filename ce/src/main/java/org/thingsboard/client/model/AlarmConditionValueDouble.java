...
public class AlarmConditionValueDouble {
  ...
  public AlarmConditionValueDouble staticValue(@Nullable Double staticValue) {
  ...
  @JsonProperty(value = JSON_PROPERTY_STATIC_VALUE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStaticValue(@Nullable Double staticValue) {
    this.staticValue = staticValue;
  }


  public AlarmConditionValueDouble dynamicValueArgument(@Nullable String dynamicValueArgument) {
