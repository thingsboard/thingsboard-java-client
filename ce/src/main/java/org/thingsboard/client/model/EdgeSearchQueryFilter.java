 ...
 */
@JsonPropertyOrder({
  EdgeSearchQueryFilter.JSON_PROPERTY_ROOT_ENTITY,
  EdgeSearchQueryFilter.JSON_PROPERTY_RELATION_TYPE,
  EdgeSearchQueryFilter.JSON_PROPERTY_DIRECTION,
  EdgeSearchQueryFilter.JSON_PROPERTY_MAX_LEVEL,
  EdgeSearchQueryFilter.JSON_PROPERTY_FETCH_LAST_LEVEL_ONLY,
  EdgeSearchQueryFilter.JSON_PROPERTY_ROOT_STATE_ENTITY,
  EdgeSearchQueryFilter.JSON_PROPERTY_DEFAULT_STATE_ENTITY,
  EdgeSearchQueryFilter.JSON_PROPERTY_EDGE_TYPES
})
...
public class EdgeSearchQueryFilter extends EntityFilter {
  ...
  public EdgeSearchQueryFilter() { 
  }

  public EdgeSearchQueryFilter rootEntity(@javax.annotation.Nullable AliasEntityId rootEntity) {
  ...
  public EdgeSearchQueryFilter relationType(@javax.annotation.Nullable String relationType) {
  ...
  public EdgeSearchQueryFilter direction(@javax.annotation.Nullable EntitySearchDirection direction) {
  ...
  public EdgeSearchQueryFilter maxLevel(@javax.annotation.Nullable Integer maxLevel) {
  ...
  public EdgeSearchQueryFilter fetchLastLevelOnly(@javax.annotation.Nullable Boolean fetchLastLevelOnly) {
  ...
  public EdgeSearchQueryFilter rootStateEntity(@javax.annotation.Nullable Boolean rootStateEntity) {
  ...
  public EdgeSearchQueryFilter defaultStateEntity(@javax.annotation.Nullable AliasEntityId defaultStateEntity) {
  ...
  public EdgeSearchQueryFilter edgeTypes(@javax.annotation.Nullable List<String> edgeTypes) {
    this.edgeTypes = edgeTypes;
    return this;
  }

  public EdgeSearchQueryFilter addEdgeTypesItem(String edgeTypesItem) {
  ...
  @Override
  public EdgeSearchQueryFilter type(@javax.annotation.Nonnull String type) {
    this.setType(type);
    return this;
  }

  /**
   * Return true if this EdgeSearchQueryFilter object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EdgeSearchQueryFilter edgeSearchQueryFilter = (EdgeSearchQueryFilter) o;
    return Objects.equals(this.rootEntity, edgeSearchQueryFilter.rootEntity) &&
        Objects.equals(this.relationType, edgeSearchQueryFilter.relationType) &&
        Objects.equals(this.direction, edgeSearchQueryFilter.direction) &&
        Objects.equals(this.maxLevel, edgeSearchQueryFilter.maxLevel) &&
        Objects.equals(this.fetchLastLevelOnly, edgeSearchQueryFilter.fetchLastLevelOnly) &&
        Objects.equals(this.rootStateEntity, edgeSearchQueryFilter.rootStateEntity) &&
        Objects.equals(this.defaultStateEntity, edgeSearchQueryFilter.defaultStateEntity) &&
        Objects.equals(this.edgeTypes, edgeSearchQueryFilter.edgeTypes) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rootEntity, relationType, direction, maxLevel, fetchLastLevelOnly, rootStateEntity, defaultStateEntity, edgeTypes, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EdgeSearchQueryFilter {\n");
...
static {
  ...
  mappings.put("EdgeSearchQueryFilter", EdgeSearchQueryFilter.class);
  JSON.registerDiscriminator(EdgeSearchQueryFilter.class, "type", mappings);
}
}
