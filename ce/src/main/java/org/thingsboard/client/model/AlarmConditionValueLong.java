...
public class AlarmConditionValueLong {
  ...
  public AlarmConditionValueLong staticValue(@Nullable Long staticValue) {
  ...
  @JsonProperty(value = JSON_PROPERTY_STATIC_VALUE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStaticValue(@Nullable Long staticValue) {
    this.staticValue = staticValue;
  }


  public AlarmConditionValueLong dynamicValueArgument(@Nullable String dynamicValueArgument) {
