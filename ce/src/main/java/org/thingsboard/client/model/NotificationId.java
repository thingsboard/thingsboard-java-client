...
public class NotificationId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.NOTIFICATION;
...
static {
  ...
  mappings.put("NotificationId", NotificationId.class);
  JSON.registerDiscriminator(NotificationId.class, "entityType", mappings);
}
}
