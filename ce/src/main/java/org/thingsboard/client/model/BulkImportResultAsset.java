...
public class BulkImportResultAsset {
  ...
  public BulkImportResultAsset created(@javax.annotation.Nullable Object created) {
  ...
  public BulkImportResultAsset updated(@javax.annotation.Nullable Object updated) {
  ...
  public BulkImportResultAsset errors(@javax.annotation.Nullable Object errors) {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.created, bulkImportResultAsset.created) &&
        equalsNullable(this.updated, bulkImportResultAsset.updated) &&
        equalsNullable(this.errors, bulkImportResultAsset.errors) &&
