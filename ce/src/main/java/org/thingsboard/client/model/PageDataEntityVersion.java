 ...
 */
@JsonPropertyOrder({
  PageDataEntityVersion.JSON_PROPERTY_DATA,
  PageDataEntityVersion.JSON_PROPERTY_TOTAL_PAGES,
  PageDataEntityVersion.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataEntityVersion.JSON_PROPERTY_HAS_NEXT
})
...
public class PageDataEntityVersion {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<EntityVersion> data = new ArrayList<>();
  ...
  public PageDataEntityVersion data(@javax.annotation.Nullable List<EntityVersion> data) {
    this.data = data;
    return this;
  }

  public PageDataEntityVersion addDataItem(EntityVersion dataItem) {
    if (this.data == null) {
  ...
  public List<EntityVersion> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<EntityVersion> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataEntityVersion object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataEntityVersion pageDataEntityVersion = (PageDataEntityVersion) o;
    return Objects.equals(this.data, pageDataEntityVersion.data) &&
        Objects.equals(this.totalPages, pageDataEntityVersion.totalPages) &&
        Objects.equals(this.totalElements, pageDataEntityVersion.totalElements) &&
        Objects.equals(this.hasNext, pageDataEntityVersion.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataEntityVersion {\n");
