...
public class TbResourceExportData extends EntityExportData {
  ...
  @Override
  public TbResourceExportData entity(@Nullable ExportableEntity entity) {
    this.setEntity(entity);
    return this;
  }

  @Override
  public TbResourceExportData relations(@Nullable List<EntityRelation> relations) {
    this.setRelations(relations);
    return this;
  }

  @Override
  public TbResourceExportData attributes(@Nullable Map<String, List<AttributeExportData>> attributes) {
    this.setAttributes(attributes);
    return this;
  }

  @Override
  public TbResourceExportData calculatedFields(@Nullable List<CalculatedField> calculatedFields) {
    this.setCalculatedFields(calculatedFields);
    return this;
  }

  @Override
  public TbResourceExportData entityType(@Nonnull EntityType entityType) {
