 ...
 */
@JsonPropertyOrder({
  PageDataCalculatedField.JSON_PROPERTY_DATA,
  PageDataCalculatedField.JSON_PROPERTY_HAS_NEXT,
  PageDataCalculatedField.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataCalculatedField.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataCalculatedField {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<CalculatedField> data = new ArrayList<>();
  ...
  public PageDataCalculatedField() { 
  }
  ...
  public PageDataCalculatedField data(@javax.annotation.Nullable List<CalculatedField> data) {
    this.data = data;
    return this;
  }

  public PageDataCalculatedField addDataItem(CalculatedField dataItem) {
    if (this.data == null) {
  ...
  public List<CalculatedField> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<CalculatedField> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataCalculatedField object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataCalculatedField pageDataCalculatedField = (PageDataCalculatedField) o;
    return Objects.equals(this.data, pageDataCalculatedField.data) &&
        Objects.equals(this.hasNext, pageDataCalculatedField.hasNext) &&
        Objects.equals(this.totalElements, pageDataCalculatedField.totalElements) &&
        Objects.equals(this.totalPages, pageDataCalculatedField.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataCalculatedField {\n");
