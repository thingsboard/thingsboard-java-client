...
public class NotificationRuleId {
  ...
  public NotificationRuleId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public NotificationRuleId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this NotificationRuleId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NotificationRuleId notificationRuleId = (NotificationRuleId) o;
    return Objects.equals(this.id, notificationRuleId.id) &&
        Objects.equals(this.entityType, notificationRuleId.entityType);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationRuleId {\n");
