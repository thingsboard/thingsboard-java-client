...
public class NotificationRuleId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.NOTIFICATION_RULE;
...
static {
  ...
  mappings.put("NotificationRuleId", NotificationRuleId.class);
  JSON.registerDiscriminator(NotificationRuleId.class, "entityType", mappings);
}
}
