...
public class WebDeliveryMethodNotificationTemplate extends DeliveryMethodNotificationTemplate {
  ...
  public WebDeliveryMethodNotificationTemplate subject(@javax.annotation.Nonnull String subject) {
  ...
  public WebDeliveryMethodNotificationTemplate additionalConfig(@javax.annotation.Nullable com.fasterxml.jackson.databind.JsonNode additionalConfig) {
  ...
  @Override
  public WebDeliveryMethodNotificationTemplate enabled(@javax.annotation.Nullable Boolean enabled) {
    this.setEnabled(enabled);
    return this;
  }

  @Override
  public WebDeliveryMethodNotificationTemplate body(@javax.annotation.Nonnull String body) {
    this.setBody(body);
    return this;
  }

  @Override
  public WebDeliveryMethodNotificationTemplate method(@javax.annotation.Nonnull String method) {
