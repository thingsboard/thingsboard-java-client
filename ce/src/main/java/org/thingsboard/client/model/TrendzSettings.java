 ...
 */
@JsonPropertyOrder({
  TrendzSettings.JSON_PROPERTY_ENABLED,
...
public class TrendzSettings {
  ...
  /**
   * Return true if this TrendzSettings object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TrendzSettings trendzSettings = (TrendzSettings) o;
    return Objects.equals(this.enabled, trendzSettings.enabled) &&
        Objects.equals(this.baseUrl, trendzSettings.baseUrl) &&
        Objects.equals(this.apiKey, trendzSettings.apiKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, baseUrl, apiKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrendzSettings {\n");
