...
public class AlarmRuleCondition {
  ...
  public AlarmRuleCondition expression(@javax.annotation.Nonnull AlarmConditionExpression expression) {
  ...
  @JsonProperty(value = JSON_PROPERTY_EXPRESSION, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setExpression(@javax.annotation.Nonnull AlarmConditionExpression expression) {
    this.expression = expression;
  }


  public AlarmRuleCondition schedule(@javax.annotation.Nullable AlarmConditionValueAlarmRuleSchedule schedule) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SCHEDULE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSchedule(@javax.annotation.Nullable AlarmConditionValueAlarmRuleSchedule schedule) {
    this.schedule = schedule;
  }


  public AlarmRuleCondition type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
