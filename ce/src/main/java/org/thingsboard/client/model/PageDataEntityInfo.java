 ...
 */
@JsonPropertyOrder({
  PageDataEntityInfo.JSON_PROPERTY_DATA,
  PageDataEntityInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataEntityInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataEntityInfo.JSON_PROPERTY_HAS_NEXT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataEntityInfo {
  ...
  public PageDataEntityInfo data(@javax.annotation.Nullable List<EntityInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataEntityInfo addDataItem(EntityInfo dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<EntityInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataEntityInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataEntityInfo pageDataEntityInfo = (PageDataEntityInfo) o;
    return Objects.equals(this.data, pageDataEntityInfo.data) &&
        Objects.equals(this.totalPages, pageDataEntityInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataEntityInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataEntityInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataEntityInfo {\n");
