 ...
 */
@JsonPropertyOrder({
  PageDataWidgetTypeInfo.JSON_PROPERTY_DATA,
  PageDataWidgetTypeInfo.JSON_PROPERTY_HAS_NEXT,
  PageDataWidgetTypeInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataWidgetTypeInfo.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataWidgetTypeInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<WidgetTypeInfo> data = new ArrayList<>();
  ...
  public PageDataWidgetTypeInfo data(@javax.annotation.Nullable List<WidgetTypeInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataWidgetTypeInfo addDataItem(WidgetTypeInfo dataItem) {
    if (this.data == null) {
  ...
  public List<WidgetTypeInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<WidgetTypeInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataWidgetTypeInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataWidgetTypeInfo pageDataWidgetTypeInfo = (PageDataWidgetTypeInfo) o;
    return Objects.equals(this.data, pageDataWidgetTypeInfo.data) &&
        Objects.equals(this.hasNext, pageDataWidgetTypeInfo.hasNext) &&
        Objects.equals(this.totalElements, pageDataWidgetTypeInfo.totalElements) &&
        Objects.equals(this.totalPages, pageDataWidgetTypeInfo.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataWidgetTypeInfo {\n");
