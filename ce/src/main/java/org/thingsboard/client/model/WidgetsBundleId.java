...
public class WidgetsBundleId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.WIDGETS_BUNDLE;
...
static {
  ...
  mappings.put("WidgetsBundleId", WidgetsBundleId.class);
  JSON.registerDiscriminator(WidgetsBundleId.class, "entityType", mappings);
}
}
