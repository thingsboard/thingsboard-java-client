...
public class OAuth2ClientId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.OAUTH2_CLIENT;
...
static {
  ...
  mappings.put("OAuth2ClientId", OAuth2ClientId.class);
  JSON.registerDiscriminator(OAuth2ClientId.class, "entityType", mappings);
}
}
