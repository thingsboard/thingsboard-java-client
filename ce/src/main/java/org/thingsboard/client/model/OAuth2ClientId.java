 ...
 */
@JsonPropertyOrder({
  OAuth2ClientId.JSON_PROPERTY_ID,
  OAuth2ClientId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class OAuth2ClientId {
  ...
  public OAuth2ClientId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public OAuth2ClientId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this OAuth2ClientId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OAuth2ClientId oauth2ClientId = (OAuth2ClientId) o;
    return Objects.equals(this.id, oauth2ClientId.id) &&
        Objects.equals(this.entityType, oauth2ClientId.entityType);
  }
  ...
  public String toString() {
    ...
    sb.append("class OAuth2ClientId {\n");
