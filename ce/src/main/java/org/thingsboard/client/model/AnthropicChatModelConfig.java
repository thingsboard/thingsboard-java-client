...
public class AnthropicChatModelConfig extends AiModelConfig {
  ...
  @JsonProperty(value = JSON_PROPERTY_PROVIDER_CONFIG, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProviderConfig(@Nonnull AnthropicProviderConfig providerConfig) {
    this.providerConfig = providerConfig;
  }


  public AnthropicChatModelConfig modelId(@Nonnull String modelId) {
  ...
  public AnthropicChatModelConfig temperature(@Nullable Double temperature) {
  ...
  public AnthropicChatModelConfig topP(@Nullable Double topP) {
    this.topP = topP;
    return this;
  }
  ...
  public AnthropicChatModelConfig topK(@Nullable Integer topK) {
    this.topK = topK;
    return this;
  }
  ...
  public AnthropicChatModelConfig maxOutputTokens(@Nullable Integer maxOutputTokens) {
  ...
  public AnthropicChatModelConfig timeoutSeconds(@Nullable Integer timeoutSeconds) {
  ...
  public AnthropicChatModelConfig maxRetries(@Nullable Integer maxRetries) {
