 ...
 */
@JsonPropertyOrder({
  PageDataDevice.JSON_PROPERTY_DATA,
  PageDataDevice.JSON_PROPERTY_HAS_NEXT,
  PageDataDevice.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataDevice.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataDevice {
  ...
  public PageDataDevice data(@javax.annotation.Nullable List<Device> data) {
    this.data = data;
    return this;
  }

  public PageDataDevice addDataItem(Device dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<Device> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataDevice object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataDevice pageDataDevice = (PageDataDevice) o;
    return Objects.equals(this.data, pageDataDevice.data) &&
        Objects.equals(this.hasNext, pageDataDevice.hasNext) &&
        Objects.equals(this.totalElements, pageDataDevice.totalElements) &&
        Objects.equals(this.totalPages, pageDataDevice.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataDevice {\n");
