...
public class NotificationRequestId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.NOTIFICATION_REQUEST;
...
static {
  ...
  mappings.put("NotificationRequestId", NotificationRequestId.class);
  JSON.registerDiscriminator(NotificationRequestId.class, "entityType", mappings);
}
}
