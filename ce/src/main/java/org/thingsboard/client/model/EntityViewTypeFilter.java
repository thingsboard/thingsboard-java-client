...
public class EntityViewTypeFilter extends EntityFilter {
  ...
  public EntityViewTypeFilter entityViewNameFilter(@javax.annotation.Nullable String entityViewNameFilter) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENTITY_VIEW_NAME_FILTER, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEntityViewNameFilter(@javax.annotation.Nullable String entityViewNameFilter) {
    this.entityViewNameFilter = entityViewNameFilter;
  }
