...
public class DynamicValueLong {
  ...
  public DynamicValueLong resolvedValue(@Nullable Long resolvedValue) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RESOLVED_VALUE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResolvedValue(@Nullable Long resolvedValue) {
    this.resolvedValue = resolvedValue;
  }


  public DynamicValueLong sourceType(@Nullable DynamicValueSourceType sourceType) {
  ...
  public DynamicValueLong sourceAttribute(@Nullable String sourceAttribute) {
  ...
  public DynamicValueLong inherit(@Nullable Boolean inherit) {
