...
public class RuleNodeId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.RULE_NODE;
...
static {
  ...
  mappings.put("RuleNodeId", RuleNodeId.class);
  JSON.registerDiscriminator(RuleNodeId.class, "entityType", mappings);
}
}
