...
public class NotificationTargetId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.NOTIFICATION_TARGET;
...
static {
  ...
  mappings.put("NotificationTargetId", NotificationTargetId.class);
  JSON.registerDiscriminator(NotificationTargetId.class, "entityType", mappings);
}
}
