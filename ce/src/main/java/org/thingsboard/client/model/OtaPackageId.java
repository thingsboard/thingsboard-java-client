...
public class OtaPackageId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.OTA_PACKAGE;
...
static {
  ...
  mappings.put("OtaPackageId", OtaPackageId.class);
  JSON.registerDiscriminator(OtaPackageId.class, "entityType", mappings);
}
}
