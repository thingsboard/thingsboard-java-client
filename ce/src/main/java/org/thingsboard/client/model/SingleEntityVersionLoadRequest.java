...
public class SingleEntityVersionLoadRequest extends VersionLoadRequest {
  ...
  @JsonProperty(value = JSON_PROPERTY_EXTERNAL_ENTITY_ID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setExternalEntityId(@Nullable EntityId externalEntityId) {
    this.externalEntityId = externalEntityId;
  }


  public SingleEntityVersionLoadRequest config(@Nullable VersionLoadConfig config) {
    this.config = config;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_CONFIG, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConfig(@Nullable VersionLoadConfig config) {
    this.config = config;
  }


  @Override
  public SingleEntityVersionLoadRequest versionId(@Nullable String versionId) {
    this.setVersionId(versionId);
    return this;
  }

  @Override
  public SingleEntityVersionLoadRequest type(@Nonnull VersionLoadRequestType type) {
    this.setType(type);
    return this;
  }
