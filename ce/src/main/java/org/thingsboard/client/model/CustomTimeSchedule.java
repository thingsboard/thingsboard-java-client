...
public class CustomTimeSchedule extends AlarmSchedule {
  ...
  public CustomTimeSchedule timezone(@javax.annotation.Nullable String timezone) {
  ...
  public CustomTimeSchedule items(@javax.annotation.Nullable List<CustomTimeScheduleItem> items) {
    this.items = items;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ITEMS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItems(@javax.annotation.Nullable List<CustomTimeScheduleItem> items) {
    this.items = items;
  }
