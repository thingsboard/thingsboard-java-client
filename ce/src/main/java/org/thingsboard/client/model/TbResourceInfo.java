...
public class TbResourceInfo {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdTime, tenantId, title, resourceType, resourceSubType, resourceKey, publicResourceKey, etag, fileName, descriptor, publicLink, name, _public, link);
  }
