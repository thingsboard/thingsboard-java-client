...
public class EntityViewId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.ENTITY_VIEW;
...
static {
  ...
  mappings.put("EntityViewId", EntityViewId.class);
  JSON.registerDiscriminator(EntityViewId.class, "entityType", mappings);
}
}
