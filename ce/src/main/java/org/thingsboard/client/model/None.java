...
public class None extends OllamaAuth {
  public None() { 
  }

  @Override
  public None type(@javax.annotation.Nonnull String type) {
    this.setType(type);
    return this;
  }

  /**
   * Return true if this None object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(None.class, "type", mappings);
}
}
