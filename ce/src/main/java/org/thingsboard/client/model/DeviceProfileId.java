...
public class DeviceProfileId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.DEVICE_PROFILE;
...
static {
  ...
  mappings.put("DeviceProfileId", DeviceProfileId.class);
  JSON.registerDiscriminator(DeviceProfileId.class, "entityType", mappings);
}
}
