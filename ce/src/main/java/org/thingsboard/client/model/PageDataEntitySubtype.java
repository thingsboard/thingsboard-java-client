 ...
 */
@JsonPropertyOrder({
  PageDataEntitySubtype.JSON_PROPERTY_DATA,
  PageDataEntitySubtype.JSON_PROPERTY_HAS_NEXT,
  PageDataEntitySubtype.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataEntitySubtype.JSON_PROPERTY_TOTAL_PAGES
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.20.0")
public class PageDataEntitySubtype {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<EntitySubtype> data = new ArrayList<>();
  ...
  public PageDataEntitySubtype data(@javax.annotation.Nullable List<EntitySubtype> data) {
    this.data = data;
    return this;
  }

  public PageDataEntitySubtype addDataItem(EntitySubtype dataItem) {
    if (this.data == null) {
  ...
  public List<EntitySubtype> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<EntitySubtype> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataEntitySubtype object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataEntitySubtype pageDataEntitySubtype = (PageDataEntitySubtype) o;
    return Objects.equals(this.data, pageDataEntitySubtype.data) &&
        Objects.equals(this.hasNext, pageDataEntitySubtype.hasNext) &&
        Objects.equals(this.totalElements, pageDataEntitySubtype.totalElements) &&
        Objects.equals(this.totalPages, pageDataEntitySubtype.totalPages);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataEntitySubtype {\n");
