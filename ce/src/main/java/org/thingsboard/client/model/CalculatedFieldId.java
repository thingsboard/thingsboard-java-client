...
public class CalculatedFieldId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.CALCULATED_FIELD;
...
static {
  ...
  mappings.put("CalculatedFieldId", CalculatedFieldId.class);
  JSON.registerDiscriminator(CalculatedFieldId.class, "entityType", mappings);
}
}
