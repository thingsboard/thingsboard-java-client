...
public class EventFilter {
  ...
  public EventFilter eventType(@Nonnull EventType eventType) {
  ...
  public EventFilter notEmpty(@Nullable Boolean notEmpty) {
  ...
  @JsonProperty(value = JSON_PROPERTY_NOT_EMPTY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNotEmpty(@Nullable Boolean notEmpty) {
    this.notEmpty = notEmpty;
  }
