 ...
 */
@JsonPropertyOrder({
  PageDataAlarmInfo.JSON_PROPERTY_DATA,
  PageDataAlarmInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAlarmInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAlarmInfo.JSON_PROPERTY_HAS_NEXT
})
...
public class PageDataAlarmInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<AlarmInfo> data = new ArrayList<>();
  ...
  public PageDataAlarmInfo data(@javax.annotation.Nullable List<AlarmInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataAlarmInfo addDataItem(AlarmInfo dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<AlarmInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAlarmInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAlarmInfo pageDataAlarmInfo = (PageDataAlarmInfo) o;
    return Objects.equals(this.data, pageDataAlarmInfo.data) &&
        Objects.equals(this.totalPages, pageDataAlarmInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataAlarmInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataAlarmInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAlarmInfo {\n");
