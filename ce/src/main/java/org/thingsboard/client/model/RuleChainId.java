...
public class RuleChainId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.RULE_CHAIN;
...
static {
  ...
  mappings.put("RuleChainId", RuleChainId.class);
  JSON.registerDiscriminator(RuleChainId.class, "entityType", mappings);
}
}
