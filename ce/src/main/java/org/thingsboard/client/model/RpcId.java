...
public class RpcId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.RPC;
...
static {
  ...
  mappings.put("RpcId", RpcId.class);
  JSON.registerDiscriminator(RpcId.class, "entityType", mappings);
}
}
