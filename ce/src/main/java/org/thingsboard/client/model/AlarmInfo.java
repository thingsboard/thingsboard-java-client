 ...
 */
@JsonPropertyOrder({
  AlarmInfo.JSON_PROPERTY_ID,
  AlarmInfo.JSON_PROPERTY_CREATED_TIME,
  AlarmInfo.JSON_PROPERTY_TENANT_ID,
  AlarmInfo.JSON_PROPERTY_CUSTOMER_ID,
  AlarmInfo.JSON_PROPERTY_TYPE,
  AlarmInfo.JSON_PROPERTY_ORIGINATOR,
  AlarmInfo.JSON_PROPERTY_SEVERITY,
  AlarmInfo.JSON_PROPERTY_ACKNOWLEDGED,
  AlarmInfo.JSON_PROPERTY_CLEARED,
  AlarmInfo.JSON_PROPERTY_ASSIGNEE_ID,
  AlarmInfo.JSON_PROPERTY_START_TS,
  AlarmInfo.JSON_PROPERTY_END_TS,
  ...
  AlarmInfo.JSON_PROPERTY_ORIGINATOR_LABEL,
...
public class AlarmInfo {
  ...
  public AlarmInfo id(@javax.annotation.Nullable AlarmId id) {
    this.id = id;
    return this;
  }
  ...
  public AlarmInfo type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public AlarmInfo originator(@javax.annotation.Nonnull EntityId originator) {
  ...
  public AlarmInfo severity(@javax.annotation.Nonnull AlarmSeverity severity) {
  ...
  public AlarmInfo acknowledged(@javax.annotation.Nonnull Boolean acknowledged) {
  ...
  public AlarmInfo cleared(@javax.annotation.Nonnull Boolean cleared) {
  ...
  public AlarmInfo assigneeId(@javax.annotation.Nullable UserId assigneeId) {
  ...
  public AlarmInfo startTs(@javax.annotation.Nullable Long startTs) {
  ...
  public AlarmInfo endTs(@javax.annotation.Nullable Long endTs) {
    this.endTs = endTs;
    return this;
  }
  ...
  public AlarmInfo ackTs(@javax.annotation.Nullable Long ackTs) {
    this.ackTs = ackTs;
    return this;
  }
  ...
  public AlarmInfo clearTs(@javax.annotation.Nullable Long clearTs) {
  ...
  public AlarmInfo assignTs(@javax.annotation.Nullable Long assignTs) {
  ...
  public AlarmInfo propagateToOwner(@javax.annotation.Nullable Boolean propagateToOwner) {
  ...
  public AlarmInfo propagateToTenant(@javax.annotation.Nullable Boolean propagateToTenant) {
  ...
  public AlarmInfo propagateRelationTypes(@javax.annotation.Nullable List<String> propagateRelationTypes) {
    this.propagateRelationTypes = propagateRelationTypes;
    return this;
  }

  public AlarmInfo addPropagateRelationTypesItem(String propagateRelationTypesItem) {
  ...
  public AlarmInfo originatorName(@javax.annotation.Nullable String originatorName) {
  ...
  public AlarmInfo originatorLabel(@javax.annotation.Nullable String originatorLabel) {
  ...
  public AlarmInfo originatorDisplayName(@javax.annotation.Nullable String originatorDisplayName) {
  ...
  public AlarmInfo assignee(@javax.annotation.Nullable AlarmAssignee assignee) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, alarmInfo.id) &&
        Objects.equals(this.createdTime, alarmInfo.createdTime) &&
        Objects.equals(this.tenantId, alarmInfo.tenantId) &&
        Objects.equals(this.customerId, alarmInfo.customerId) &&
        Objects.equals(this.type, alarmInfo.type) &&
        Objects.equals(this.originator, alarmInfo.originator) &&
        Objects.equals(this.severity, alarmInfo.severity) &&
        Objects.equals(this.acknowledged, alarmInfo.acknowledged) &&
        Objects.equals(this.cleared, alarmInfo.cleared) &&
        Objects.equals(this.assigneeId, alarmInfo.assigneeId) &&
        Objects.equals(this.startTs, alarmInfo.startTs) &&
        Objects.equals(this.endTs, alarmInfo.endTs) &&
        ...
        Objects.equals(this.originatorLabel, alarmInfo.originatorLabel) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, createdTime, tenantId, customerId, type, originator, severity, acknowledged, cleared, assigneeId, startTs, endTs, ackTs, clearTs, assignTs, propagate, propagateToOwner, propagateToTenant, propagateRelationTypes, originatorName, originatorLabel, originatorDisplayName, assignee, name, status, details);
  }
