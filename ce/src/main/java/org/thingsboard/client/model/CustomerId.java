...
public class CustomerId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.CUSTOMER;
...
static {
  ...
  mappings.put("CustomerId", CustomerId.class);
  JSON.registerDiscriminator(CustomerId.class, "entityType", mappings);
}
}
