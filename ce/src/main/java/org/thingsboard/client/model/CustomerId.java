...
@JsonPropertyOrder({
  ...
  CustomerId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class CustomerId {
  ...
  public CustomerId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public CustomerId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this CustomerId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, customerId.id) &&
        Objects.equals(this.entityType, customerId.entityType);
  }
