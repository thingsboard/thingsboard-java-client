...
public class PageDataOtaPackageInfo {
  ...
  public PageDataOtaPackageInfo data(@Nullable List<OtaPackageInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataOtaPackageInfo addDataItem(OtaPackageInfo dataItem) {
    if (this.data == null) {
  ...
  public List<OtaPackageInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@Nullable List<OtaPackageInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataOtaPackageInfo object is equal to o.
   */
  @Override
