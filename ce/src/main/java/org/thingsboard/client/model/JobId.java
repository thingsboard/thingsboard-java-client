...
public class JobId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.JOB;
...
static {
  ...
  mappings.put("JobId", JobId.class);
  JSON.registerDiscriminator(JobId.class, "entityType", mappings);
}
}
