...
public class BulkImportResultEdge {
  ...
  public BulkImportResultEdge created(@Nullable Integer created) {
  ...
  public BulkImportResultEdge updated(@Nullable Integer updated) {
  ...
  public BulkImportResultEdge errors(@Nullable Integer errors) {
    this.errors = errors;
    return this;
  }
  ...
  public BulkImportResultEdge errorsList(@Nullable List<String> errorsList) {
