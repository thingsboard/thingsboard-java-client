...
public class TenantProfileId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.TENANT_PROFILE;
...
static {
  ...
  mappings.put("TenantProfileId", TenantProfileId.class);
  JSON.registerDiscriminator(TenantProfileId.class, "entityType", mappings);
}
}
