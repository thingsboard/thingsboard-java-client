 ...
 */
@JsonPropertyOrder({
  TenantProfileId.JSON_PROPERTY_ID,
  TenantProfileId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class TenantProfileId {
  ...
  public TenantProfileId() { 
  }

  public TenantProfileId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public TenantProfileId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this TenantProfileId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TenantProfileId tenantProfileId = (TenantProfileId) o;
    return Objects.equals(this.id, tenantProfileId.id) &&
  ...
  public String toString() {
    ...
    sb.append("class TenantProfileId {\n");
