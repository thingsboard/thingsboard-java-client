...
public class MobileAppBundleId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.MOBILE_APP_BUNDLE;
...
static {
  ...
  mappings.put("MobileAppBundleId", MobileAppBundleId.class);
  JSON.registerDiscriminator(MobileAppBundleId.class, "entityType", mappings);
}
}
