 ...
 */
@JsonPropertyOrder({
  DeviceActivityRecipientsConfig.JSON_PROPERTY_TARGETS
})
...
public class DeviceActivityRecipientsConfig extends NotificationRuleRecipientsConfig {
  ...
  public DeviceActivityRecipientsConfig() { 
  }

  public DeviceActivityRecipientsConfig targets(@Nonnull List<UUID> targets) {
    this.targets = targets;
    return this;
  }

  public DeviceActivityRecipientsConfig addTargetsItem(UUID targetsItem) {
  ...
  @Override
  public DeviceActivityRecipientsConfig triggerType(@Nullable NotificationRuleTriggerType triggerType) {
    this.setTriggerType(triggerType);
    return this;
  }

  /**
   * Return true if this DeviceActivityRecipientsConfig object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DeviceActivityRecipientsConfig deviceActivityRecipientsConfig = (DeviceActivityRecipientsConfig) o;
    return Objects.equals(this.targets, deviceActivityRecipientsConfig.targets) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceActivityRecipientsConfig {\n");
...
static {
  ...
  mappings.put("DeviceActivityRecipientsConfig", DeviceActivityRecipientsConfig.class);
  JSON.registerDiscriminator(DeviceActivityRecipientsConfig.class, "triggerType", mappings);
}
}
