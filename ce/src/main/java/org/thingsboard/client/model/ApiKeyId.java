 ...
 */
@JsonPropertyOrder({
  ApiKeyId.JSON_PROPERTY_ID,
  ApiKeyId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class ApiKeyId {
  ...
  public ApiKeyId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ApiKeyId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this ApiKeyId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, apiKeyId.id) &&
