...
public class ApiKeyId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.API_KEY;
...
static {
  ...
  mappings.put("ApiKeyId", ApiKeyId.class);
  JSON.registerDiscriminator(ApiKeyId.class, "entityType", mappings);
}
}
