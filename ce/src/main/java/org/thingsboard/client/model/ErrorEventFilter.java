 ...
 */
@JsonPropertyOrder({
  ErrorEventFilter.JSON_PROPERTY_SERVER,
  ErrorEventFilter.JSON_PROPERTY_METHOD,
  ErrorEventFilter.JSON_PROPERTY_ERROR_STR
})
...
public class ErrorEventFilter extends EventFilter {
  ...
  public ErrorEventFilter() { 
  }

  public ErrorEventFilter server(@javax.annotation.Nullable String server) {
    this.server = server;
    return this;
  }
  ...
  public ErrorEventFilter method(@javax.annotation.Nullable String method) {
    this.method = method;
    return this;
  }
  ...
  public ErrorEventFilter errorStr(@javax.annotation.Nullable String errorStr) {
  ...
  @Override
  public ErrorEventFilter notEmpty(@javax.annotation.Nullable Boolean notEmpty) {
    this.setNotEmpty(notEmpty);
    return this;
  }

  @Override
  public ErrorEventFilter eventType(@javax.annotation.Nonnull EventType eventType) {
    this.setEventType(eventType);
    return this;
  }

  /**
   * Return true if this ErrorEventFilter object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ErrorEventFilter errorEventFilter = (ErrorEventFilter) o;
    return Objects.equals(this.server, errorEventFilter.server) &&
        Objects.equals(this.method, errorEventFilter.method) &&
        Objects.equals(this.errorStr, errorEventFilter.errorStr) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(server, method, errorStr, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ErrorEventFilter {\n");
...
static {
  ...
  mappings.put("ErrorEventFilter", ErrorEventFilter.class);
  JSON.registerDiscriminator(ErrorEventFilter.class, "eventType", mappings);
}
}
