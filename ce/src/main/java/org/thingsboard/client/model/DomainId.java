...
public class DomainId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.DOMAIN;
...
static {
  ...
  mappings.put("DomainId", DomainId.class);
  JSON.registerDiscriminator(DomainId.class, "entityType", mappings);
}
}
