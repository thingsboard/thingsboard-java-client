 ...
 */
@JsonPropertyOrder({
  DomainId.JSON_PROPERTY_ID,
  DomainId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class DomainId {
  ...
  public DomainId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public DomainId entityType(@javax.annotation.Nonnull EntityType entityType) {
  ...
  /**
   * Return true if this DomainId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, domainId.id) &&
        Objects.equals(this.entityType, domainId.entityType);
  }
