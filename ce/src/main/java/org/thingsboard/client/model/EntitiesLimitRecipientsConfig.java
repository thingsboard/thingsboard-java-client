...
public class EntitiesLimitRecipientsConfig extends NotificationRuleRecipientsConfig {
  ...
  public EntitiesLimitRecipientsConfig targets(@Nonnull List<UUID> targets) {
  ...
  @Override
  public EntitiesLimitRecipientsConfig triggerType(@Nullable NotificationRuleTriggerType triggerType) {
