...
public class WidgetTypeId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.WIDGET_TYPE;
...
static {
  ...
  mappings.put("WidgetTypeId", WidgetTypeId.class);
  JSON.registerDiscriminator(WidgetTypeId.class, "entityType", mappings);
}
}
