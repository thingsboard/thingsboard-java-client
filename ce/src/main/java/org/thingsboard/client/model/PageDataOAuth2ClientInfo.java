 ...
 */
@JsonPropertyOrder({
  PageDataOAuth2ClientInfo.JSON_PROPERTY_DATA,
  PageDataOAuth2ClientInfo.JSON_PROPERTY_TOTAL_PAGES,
  PageDataOAuth2ClientInfo.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataOAuth2ClientInfo.JSON_PROPERTY_HAS_NEXT
})
...
public class PageDataOAuth2ClientInfo {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<OAuth2ClientInfo> data = new ArrayList<>();
  ...
  public PageDataOAuth2ClientInfo() { 
  }
  ...
  public PageDataOAuth2ClientInfo data(@javax.annotation.Nullable List<OAuth2ClientInfo> data) {
    this.data = data;
    return this;
  }

  public PageDataOAuth2ClientInfo addDataItem(OAuth2ClientInfo dataItem) {
    if (this.data == null) {
  ...
  public List<OAuth2ClientInfo> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<OAuth2ClientInfo> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataOAuth2ClientInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataOAuth2ClientInfo pageDataOAuth2ClientInfo = (PageDataOAuth2ClientInfo) o;
    return Objects.equals(this.data, pageDataOAuth2ClientInfo.data) &&
        Objects.equals(this.totalPages, pageDataOAuth2ClientInfo.totalPages) &&
        Objects.equals(this.totalElements, pageDataOAuth2ClientInfo.totalElements) &&
        Objects.equals(this.hasNext, pageDataOAuth2ClientInfo.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataOAuth2ClientInfo {\n");
