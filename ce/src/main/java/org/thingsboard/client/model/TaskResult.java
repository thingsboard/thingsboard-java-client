...
public class TaskResult {
  ...
  public TaskResult success(@javax.annotation.Nullable Boolean success) {
  ...
  public TaskResult discarded(@javax.annotation.Nullable Boolean discarded) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DISCARDED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDiscarded(@javax.annotation.Nullable Boolean discarded) {
    this.discarded = discarded;
  }


  public TaskResult finishTs(@javax.annotation.Nullable Long finishTs) {
  ...
  public TaskResult jobType(@javax.annotation.Nonnull String jobType) {
