...
import org.thingsboard.client.model.DummyTaskFailure;
 ...
 */
@JsonPropertyOrder({
  DummyTaskResult.JSON_PROPERTY_FAILURE
})
...
public class DummyTaskResult extends TaskResult {
  ...
  public DummyTaskResult failure(@javax.annotation.Nullable DummyTaskFailure failure) {
  ...
  public DummyTaskFailure getFailure() {
    return failure;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_FAILURE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFailure(@javax.annotation.Nullable DummyTaskFailure failure) {
    this.failure = failure;
  }


  @Override
  public DummyTaskResult success(@javax.annotation.Nullable Boolean success) {
    this.setSuccess(success);
    return this;
  }

  @Override
  public DummyTaskResult discarded(@javax.annotation.Nullable Boolean discarded) {
    this.setDiscarded(discarded);
    return this;
  }

  @Override
  public DummyTaskResult finishTs(@javax.annotation.Nullable Long finishTs) {
    this.setFinishTs(finishTs);
    return this;
  }

  @Override
  public DummyTaskResult jobType(@javax.annotation.Nonnull String jobType) {
  ...
  public boolean equals(Object o) {
    ...
    DummyTaskResult dummyTaskResult = (DummyTaskResult) o;
    return Objects.equals(this.failure, dummyTaskResult.failure) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class DummyTaskResult {\n");
...
static {
  ...
  JSON.registerDiscriminator(DummyTaskResult.class, "jobType", mappings);
}
}
