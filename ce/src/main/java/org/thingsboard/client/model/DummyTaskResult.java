...
public class DummyTaskResult extends TaskResult {
  ...
  public DummyTaskResult failure(@Nullable DummyTaskFailure failure) {
  ...
  @JsonProperty(value = JSON_PROPERTY_FAILURE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFailure(@Nullable DummyTaskFailure failure) {
    this.failure = failure;
  }


  @Override
  public DummyTaskResult success(@Nullable Boolean success) {
    this.setSuccess(success);
    return this;
  }

  @Override
  public DummyTaskResult discarded(@Nullable Boolean discarded) {
    this.setDiscarded(discarded);
    return this;
  }

  @Override
  public DummyTaskResult finishTs(@Nullable Long finishTs) {
    this.setFinishTs(finishTs);
    return this;
  }

  @Override
  public DummyTaskResult jobType(@Nonnull String jobType) {
