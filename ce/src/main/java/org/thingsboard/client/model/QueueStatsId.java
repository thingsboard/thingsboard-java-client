...
public class QueueStatsId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.QUEUE_STATS;
...
static {
  ...
  mappings.put("QueueStatsId", QueueStatsId.class);
  JSON.registerDiscriminator(QueueStatsId.class, "entityType", mappings);
}
}
