 ...
 */
@JsonPropertyOrder({
  PageDataAssetProfile.JSON_PROPERTY_DATA,
  PageDataAssetProfile.JSON_PROPERTY_TOTAL_PAGES,
  PageDataAssetProfile.JSON_PROPERTY_TOTAL_ELEMENTS,
  PageDataAssetProfile.JSON_PROPERTY_HAS_NEXT
})
...
public class PageDataAssetProfile {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<AssetProfile> data = new ArrayList<>();
  ...
  public PageDataAssetProfile data(@javax.annotation.Nullable List<AssetProfile> data) {
    this.data = data;
    return this;
  }

  public PageDataAssetProfile addDataItem(AssetProfile dataItem) {
    if (this.data == null) {
  ...
  public List<AssetProfile> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<AssetProfile> data) {
    this.data = data;
  }
  ...
  /**
   * Return true if this PageDataAssetProfile object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PageDataAssetProfile pageDataAssetProfile = (PageDataAssetProfile) o;
    return Objects.equals(this.data, pageDataAssetProfile.data) &&
        Objects.equals(this.totalPages, pageDataAssetProfile.totalPages) &&
        Objects.equals(this.totalElements, pageDataAssetProfile.totalElements) &&
        Objects.equals(this.hasNext, pageDataAssetProfile.hasNext);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageDataAssetProfile {\n");
