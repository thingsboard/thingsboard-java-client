...
public class AiModelId extends EntityId {
  ...
  @javax.annotation.Nonnull
  private EntityType entityType = EntityType.AI_MODEL;
...
static {
  ...
  mappings.put("AiModelId", AiModelId.class);
  JSON.registerDiscriminator(AiModelId.class, "entityType", mappings);
}
}
