 ...
 */
@JsonPropertyOrder({
  AiModelId.JSON_PROPERTY_ID,
  AiModelId.JSON_PROPERTY_ENTITY_TYPE
})
...
public class AiModelId {
  ...
  public AiModelId id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public AiModelId entityType(@javax.annotation.Nonnull EntityType entityType) {
    this.entityType = entityType;
    return this;
  }

  /**
   * Entity type of the AI model
   * @return entityType
   */
  @javax.annotation.Nonnull
  ...
  /**
   * Return true if this AiModelId object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, aiModelId.id) &&
        Objects.equals(this.entityType, aiModelId.entityType);
  }
