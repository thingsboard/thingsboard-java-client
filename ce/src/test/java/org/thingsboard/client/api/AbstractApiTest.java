...
public class AbstractApiTest {
    ...
    void setUp() throws Exception {
        ...
        tenantAdmin = tbApi.saveUser(tenantAdmin, "false");
        activateUserAndAuthorize(tenantAdmin);

        Customer customer = new Customer();
        customer.setTitle("Java client test customer");
        customer.setTenantId(savedTenant.getId());
        savedCustomer = tbApi.saveCustomer(customer, null, null, null, null);
        ...
        savedCustomerUser = tbApi.saveUser(customerUser, "false");
