...
public class Oauth2ApiTest extends AbstractApiTest {
    ...
    void testOAuth2ClientLifecycle() throws ApiException {
        ...
        PageDataOAuth2ClientInfo clientInfos = tbApi.findTenantOAuth2ClientInfos(100, 0,
        ...
        PageDataOAuth2ClientInfo clientsAfterDelete = tbApi.findTenantOAuth2ClientInfos(100, 0,
                TEST_PREFIX + "OAuth2_" + timestamp, null, null);
