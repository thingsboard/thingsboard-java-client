...
public class DeviceConnectivityApiTest extends AbstractApiTest {

    @Test
    void testGetDevicePublishTelemetryCommands() throws Exception {
        Device device = new Device();
        device.setName(TEST_PREFIX + System.currentTimeMillis());
        device.setType("default");

        Device savedDevice = tbApi.saveDevice(device, null, null, null, null);
